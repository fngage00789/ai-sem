...
public class SEMREL004ReportParameter extends ReportParameter{
	...
	public Map getReportParameter() {
		...
		parameters.put("PARAM_BY_TYPE", p_byType);
		return parameters;
	}
	...
	public String getP_byType() {
		return p_byType;
	}

	public void setP_byType(String pByType) {
		p_byType = pByType;
	}
