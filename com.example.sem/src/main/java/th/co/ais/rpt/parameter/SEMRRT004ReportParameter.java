...
public class SEMRRT004ReportParameter extends ReportParameter{
	...
	private String p_transfer_flag;
	
	public String getP_transfer_flag() {
		return p_transfer_flag;
	}

	public void setP_transfer_flag(String pTransferFlag) {
		p_transfer_flag = pTransferFlag;
	}
	...
	public Map getReportParameter() {
		...
		parameters.put("PARAM_TRANSFER_FLAG", p_transfer_flag);
		return parameters;
	}
