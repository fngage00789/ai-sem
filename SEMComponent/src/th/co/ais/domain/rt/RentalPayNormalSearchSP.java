...
public class RentalPayNormalSearchSP extends AbstractDomain{
	...
	// added by...NEW 2015/05/06
	private int totalRec;
	private int extraRec;
	private int pendingRec;
	private int networkRec;
...
//	@PCell(cellType = String.class ,no = 15)
	...
	public int getExtraRec() {
		return extraRec;
	}
	public void setExtraRec(int extraRec) {
		this.extraRec = extraRec;
	}
	public int getPendingRec() {
		return pendingRec;
	}
	public void setPendingRec(int pendingRec) {
		this.pendingRec = pendingRec;
	}
	public int getNetworkRec() {
		return networkRec;
	}
	public void setNetworkRec(int networkRec) {
		this.networkRec = networkRec;
	}
