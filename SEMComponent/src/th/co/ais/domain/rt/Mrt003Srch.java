...
public class Mrt003Srch extends AbstractDomain{
	...
	@PCell(cellType = Double.class, no = 16)
	...
	@PCell(cellType = Double.class, no = 4)
	...
	@PCell(cellType = Double.class, no = 5)
	...
	@PCell(cellType = Double.class, no = 6)
	...
	@PCell(cellType = Double.class, no = 7)
	...
	@PCell(cellType = Double.class, no = 8)
	...
	@PCell(cellType = Double.class, no = 9)
	...
	@PCell(cellType = Double.class, no = 10)
	...
	@PCell(cellType = Double.class, no = 11)
	...
	@PCell(cellType = Double.class, no = 12)
	...
	@PCell(cellType = Double.class, no = 14)
	...
	@PCell(cellType = Double.class, no = 15)
	...
	@PCell(cellType = Date.class, no = 19)
	...
	@PCell(cellType = Double.class, no = 17)
