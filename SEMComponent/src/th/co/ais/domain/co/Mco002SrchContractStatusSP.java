...
public class Mco002SrchContractStatusSP extends AbstractDomain{
	...
	public String getYear() {
		...
		if(d1 != null){
			try{
				...
				//month = d1Arr[1];
				 year = d1Arr[2];
				 yearInt = Integer.parseInt(year)+543;
	...
	public String getEffDateStr() {
		...
		if(effDate != null){
			try{
				effDateStr = SEMDataUtility.toStringThaiDateSimpleFormat(effDate);
			}catch(Exception e){				
			}
		}else{
			effDateStr = "";
	...
	public String getExpDateStr() {
		...
		if(expDate != null){
			try{
				expDateStr = SEMDataUtility.toStringThaiDateSimpleFormat(expDate);
			}catch(Exception e){				
			}
		}else{
			expDateStr = "";
	...
	public String getStringD1() {
		...
		if(d1 != null){
			try{
				d1Str = SEMDataUtility.toStringThaiDateSimpleFormat(d1);
			}catch(Exception e){				
			}
		}else{
			d1Str = "";
	...
	public String getD9Str() {
		return d9Str;
	}

	public void setD9Str(String d9Str) {
		this.d9Str = d9Str;
	}
