...
public class UploadMeterPermistionWarrant extends AbstractDomain{
	
	private static final long serialVersionUID = -8472212945170311361L;
	...
	private String fee;
	private String transformerDtStr;
	private String onMeterDtStr;
	private String user;
	private String fileName;
	private String result;
	private String logId;
	private String subSentDetailDtStr;
	private Date subSentDetailDt;
	...
	public String getTransformerDtStr() {
		return transformerDtStr;
	}
	public void setTransformerDtStr(String transformerDtStr) {
		this.transformerDtStr = transformerDtStr;
	}
	public String getOnMeterDtStr() {
		return onMeterDtStr;
	}
	public void setOnMeterDtStr(String onMeterDtStr) {
		this.onMeterDtStr = onMeterDtStr;
	}
	...
	public String getSubSentDetailDtStr() {
		return subSentDetailDtStr;
	}
	public void setSubSentDetailDtStr(String subSentDetailDtStr) {
		this.subSentDetailDtStr = subSentDetailDtStr;
	}
	public Date getSubSentDetailDt() {
		return subSentDetailDt;
	}
	public void setSubSentDetailDt(Date subSentDetailDt) {
