...
import th.co.ais.domain.util.CustomDateSerializer;
import th.co.ais.util.SEMDataUtility;
import th.co.ais.util.WrapperBeanObject;

public class SiteAppSP extends AbstractDomain {
	...
	private static final String TH_TIME_ZONE="Asia/Bangkok";
	
	protected String rowId;
	protected String siteAppId;
	
	protected String bgBank;
	...
	protected String contractEditFlag = "N";
	...
	@JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "dd-MM-yyyy" , timezone = TH_TIME_ZONE)
	...
	//added by NEW 20181008
	private String locationSiteType;
	private String locationSiteCode;
	private String locationSiteGroup;
	private String locationSystem;
	private String locationStationType;
	...
	protected String promiseRenewRemark;
	...
	protected String rentEditFlag = "N";
	protected String rentDepositEditFlag = "N";
	...
	protected String elEditFlag = "N";
	protected String elDepositEditFlag = "N";
	protected String siteAppElectricCondId;
	protected BigDecimal electricAmt;
	protected BigDecimal electricOldAmt;
	protected BigDecimal electricAddAmt;
	protected String electricTypeName;
	...
	protected String mailEditFlag = "N";
	...
	@JsonFormat(shape = JsonFormat.Shape.STRING, timezone = "UTC+7", pattern = "dd-MM-yyyy")
	protected Date batchDt;
	protected String batchDtStr;
	protected String batchSum;
	
	protected String propertyTaxEditFlag = "N";
	protected String insuranceEditFlag = "N";
    ...
    protected String elUseTypeList;
    protected BigDecimal elBGDeposit;
    protected String elBGDepositVatType;
	...
	private BigDecimal otherPaymentAmt;
	...
	private String rentalEditFlag = "N";
    ...
    private Integer ownerPayPeriod;
 	...
 	protected String mainLocalSiteType; 
 	
 	private String contractStatusName;
 	
	private String terminateOfcontractFlag;
	
	private String chkContDocEditFlag;
	
	@JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "dd-MM-yyyy" , timezone = TH_TIME_ZONE)
	private Date changeEffectiveDt;
	private String electricType;
	private String electricCondType;
	private String electricCondTypeName;
	...
	public String ownerSubCategory;
	
	private String useNewMeter;
	private String useOldMeter;

	public String pNextContract;
	private String legalDocHaveOrNot;
	
	private String newStatusName;
	protected String pRemark;

	
	private String pSaElectricType;
	private String canEdit;
	private String canAdd;
	
	//added by NEW 2018/11/01
	public String otherWaitingFlag;
	public String returnDepositFlag;
	public String noReturnDepositFlag;
	public String cancelMeterFlag;
	public String terminateElFlag;
	public String otherTerminateFlag;
	
	@JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "dd-MM-yyyy" , timezone = TH_TIME_ZONE)
	public Date terminateRantDt;
	public BigDecimal returnDepositAmt;
	@JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "dd-MM-yyyy" , timezone = TH_TIME_ZONE)
	public Date returnDepositDt;
	public String otherTerminateNote;
	public String pElectricType;
	
	private String contRentAdj;
	private String contRentAdjPerType;
	
	private String emerContactTitleName;
	private String emerContactIdCard;
	private String emerContactTaxId;
	@JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "dd-MM-yyyy" , timezone = TH_TIME_ZONE)
	private Date emerContactBirthday;
	
	private String emerContactHouseNo;
	private String emerContactHouseNoBG;
	private String emerContactBuilding;
	private String emerContactBuildingBG;
	private String emerContactFloor;
	private String emerContactFloorBG;
	private String emerContactRoomNo;
	private String emerContactRoomNoBG;
	private String emerContactStreet;
	private String emerContactStreetBG;
	private String emerContactTambon;
	private String emerContactTambonBG;
	private String emerContactAmphurId;
	private String emerContactProvinceId;
	private String emerContactPostCode;
	private String emerContactPostCodeBG;
	private String emerContactTaxIdBG;
	
	protected String emerContactName;
	protected String emerContactNameBG;
	protected String emerContactTel;
	protected String emerContactTelBG;
	protected String emerContactMobile;
	protected String emerContactMobileBG;
	protected String emerContactFax;
	protected String emerContactFaxBG;
	protected String emerContactEmail;
	protected String emerContactEmailBG;
	
	private String renewRentAddFlag;
	private String whtTypeName;
	
	@JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "dd-MM-yyyy" , timezone = TH_TIME_ZONE)
	private Date termProcessDt;
	private String termProcessDtStr;
	private String termProcessRemark;
	...
	public String getDocDtStr() throws Exception {
		docDtStr = getDocDt() == null ? "" : SEMDataUtility.toStringThaiDateTimeSimpleFormat(getDocDt());
		return docDtStr;
	}
	...
	public String getUpdateDTStr() throws Exception {
		updateDTStr = getUpdateDT() == null ? "" : SEMDataUtility.toStringThaiDateTimeSimpleFormat(getUpdateDT());
		return updateDTStr;
	}
	...
	public String getMainLocalSiteType() {
		return mainLocalSiteType;
	}

	public void setMainLocalSiteType(String mainLocalSiteType) {
		this.mainLocalSiteType = mainLocalSiteType;
	}

	public String getLocationSiteType() {
		return locationSiteType;
	}

	public void setLocationSiteType(String locationSiteType) {
		this.locationSiteType = locationSiteType;
	}
	...
	public void setLocationSiteCode(String locationSiteCode) {
		this.locationSiteCode = locationSiteCode;
	}

	public String getLocationSiteGroup() {
		return locationSiteGroup;
	}

	public void setLocationSiteGroup(String locationSiteGroup) {
		this.locationSiteGroup = locationSiteGroup;
	}
	...
	public String getLocationStationType() {
		return locationStationType;
	}

	public void setLocationStationType(String locationStationType) {
		this.locationStationType = locationStationType;
	}

	public String getChkContDocEditFlag() {
		return chkContDocEditFlag;
	}

	public void setChkContDocEditFlag(String chkContDocEditFlag) {
		this.chkContDocEditFlag = chkContDocEditFlag;
	}
	...
	public String getElUseTypeList() {
		return elUseTypeList;
	}

	public void setElUseTypeList(String elUseTypeList) {
		this.elUseTypeList = elUseTypeList;
	}

	public String getpNextContract() {
		return pNextContract;
	}

	public void setpNextContract(String pNextContract) {
		this.pNextContract = pNextContract;
	}

	public String getLegalDocHaveOrNot() {
		return legalDocHaveOrNot;
	}

	public void setLegalDocHaveOrNot(String legalDocHaveOrNot) {
		this.legalDocHaveOrNot = legalDocHaveOrNot;
	}
	...
	public String toString() {
		return "SiteAppSP [UserLogin=" + UserLogin + ", address=" + address
				+ ", ageDay=" + ageDay + ", ageMonth=" + ageMonth
				+ ", ageYear=" + ageYear + ", amphurName=" + amphurName
				+ ", amphurNameBG=" + amphurNameBG + ", approveBy=" + approveBy
				+ ", approveDT=" + approveDT + ", approveDt=" + approveDt
				...
				+ batchNo + ", batchSum=" + batchSum + ", bgDepositDesc="
				+ bgDepositDesc + ", bgDepositDescBG=" + bgDepositDescBG
				+ ", bgDepositVatDesc=" + bgDepositVatDesc
				+ ", bgDepositVatDescBG=" + bgDepositVatDescBG
				+ ", buildingArea=" + buildingArea + ", buildingAreaBG="
				+ buildingAreaBG + ", cashDepositDesc=" + cashDepositDesc
				+ ", cashDepositDescBG=" + cashDepositDescBG
				+ ", cashDepositVatDesc=" + cashDepositVatDesc
				+ ", cashDepositVatDescBG=" + cashDepositVatDescBG
				+ ", cashDepositvatDesc=" + cashDepositvatDesc
				+ ", cashDepositvatDescBG=" + cashDepositvatDescBG
				+ ", checkDt=" + checkDt + ", coCompany=" + coCompany
				+ ", coCompanyContractNo=" + coCompanyContractNo
				+ ", coContractNo=" + coContractNo + ", coContractNoBG="
				+ coContractNoBG + ", coLocateCompany=" + coLocateCompany
				+ ", coLocateCompanyBG=" + coLocateCompanyBG + ", company="
				...
				+ contractId + ", contractNeverExpire=" + contractNeverExpire
				+ ", contractNo=" + contractNo + ", contractNoOld="
				+ contractNoOld + ", contractTime=" + contractTime
				+ ", contractTimeSeq=" + contractTimeSeq + ", contractWanted="
				+ contractWanted + ", contractWantedRemark="
				+ contractWantedRemark + ", costPerYear=" + costPerYear
				+ ", createBy=" + createBy + ", createDt=" + createDt
				+ ", createDtStr=" + createDtStr + ", deckArea=" + deckArea
				+ ", deckAreaBG=" + deckAreaBG + ", deckAreaType="
				+ deckAreaType + ", depositFlagDesc=" + depositFlagDesc
				+ ", depositFlagDescBG=" + depositFlagDescBG + ", doc1=" + doc1
				+ ", doc10=" + doc10 + ", doc2=" + doc2 + ", doc3=" + doc3
				+ ", doc4=" + doc4 + ", doc5=" + doc5 + ", doc6=" + doc6
				+ ", doc7=" + doc7 + ", doc8=" + doc8 + ", doc9=" + doc9
				+ ", docDt=" + docDt + ", docDtStr=" + docDtStr + ", docId="
				+ docId + ", docNo=" + docNo + ", docOther=" + docOther
				+ ", docOtherRemark=" + docOtherRemark + ", docStatus="
				...
				+ elBGDepositVatType + ", elBgDeposit=" + elBgDeposit
				+ ", elBgDepositVatType=" + elBgDepositVatType
				+ ", elCashDeposit=" + elCashDeposit
				+ ", elCashDepositVatType=" + elCashDepositVatType
				+ ", elDepositEditFlag=" + elDepositEditFlag
				+ ", elDepositFlag=" + elDepositFlag + ", elDepositRemark="
				+ elDepositRemark + ", elDepositRemarkBG=" + elDepositRemarkBG
				+ ", elEditFlag=" + elEditFlag + ", elOwnerType=" + elOwnerType
				+ ", elPackageDesc=" + elPackageDesc + ", elPackageDescBG="
				+ elPackageDescBG + ", elPackagePeriodType="
				...
				+ elRemarkBG + ", elUnitPrice=" + elUnitPrice + ", elUseDesc="
				+ elUseDesc + ", elUseDescBG=" + elUseDescBG
				+ ", elUseMultiResourse=" + elUseMultiResourse
				+ ", elUseNewMeter=" + elUseNewMeter + ", elUseOldMeter="
				+ elUseOldMeter + ", elUseOthSite=" + elUseOthSite
				+ ", elUseOthSiteContractNo=" + elUseOthSiteContractNo
				+ ", elUseOwner=" + elUseOwner + ", elUseType=" + elUseType
				+ ", elVatType=" + elVatType + ", expireDetail=" + expireDetail
				+ ", expireDt=" + expireDt + ", expireDtFrom=" + expireDtFrom
				...
				+ ", isCoLocate=" + isCoLocate + ", isMacroType=" + isMacroType
				+ ", isMicroType=" + isMicroType + ", isOtherType="
				+ isOtherType + ", isOtherTypeDetail=" + isOtherTypeDetail
				+ ", isPicoType=" + isPicoType + ", isRepeaterType="
				+ isRepeaterType + ", isSmallcellType=" + isSmallcellType
				+ ", isTowerType=" + isTowerType + ", isWifiType=" + isWifiType
				+ ", landArea=" + landArea + ", landAreaBG=" + landAreaBG
				+ ", landAreaType=" + landAreaType + ", landAreaTypeBG="
				+ landAreaTypeBG + ", latestFlag=" + latestFlag
				+ ", leaderApproveBy=" + leaderApproveBy + ", leaderApproveDt="
				+ leaderApproveDt + ", leaderApproveDtStr="
				+ leaderApproveDtStr + ", leaderApproveRemark="
				+ leaderApproveRemark + ", leaderApproveStatus="
				+ leaderApproveStatus + ", legalApproveBy=" + legalApproveBy
				+ ", legalApproveDt=" + legalApproveDt + ", legalApproveDtStr="
				+ legalApproveDtStr + ", legalApproveRemark="
				+ legalApproveRemark + ", legalApproveStatus="
				+ legalApproveStatus + ", lessorAmphurId=" + lessorAmphurId
				+ ", lessorBuilding=" + lessorBuilding + ", lessorBuildingBG="
				+ lessorBuildingBG + ", lessorFloor=" + lessorFloor
				+ ", lessorFloorBG=" + lessorFloorBG + ", lessorHouseNo="
				+ lessorHouseNo + ", lessorHouseNoBG=" + lessorHouseNoBG
				+ ", lessorName=" + lessorName + ", lessorNameBG="
				+ lessorNameBG + ", lessorPostCode=" + lessorPostCode
				+ ", lessorPostCodeBG=" + lessorPostCodeBG
				+ ", lessorProvinceId=" + lessorProvinceId + ", lessorRoomNo="
				+ lessorRoomNo + ", lessorRoomNoBG=" + lessorRoomNoBG
				+ ", lessorStreet=" + lessorStreet + ", lessorStreetBG="
				+ lessorStreetBG + ", lessorTambon=" + lessorTambon
				+ ", lessorTambonBG=" + lessorTambonBG + ", lessorTaxId="
				+ lessorTaxId + ", lessorTaxIdBG=" + lessorTaxIdBG
				+ ", locationAddressNo=" + locationAddressNo
				+ ", locationAddressNoBG=" + locationAddressNoBG
				+ ", locationAmphurId=" + locationAmphurId
				+ ", locationAmphurIdBG=" + locationAmphurIdBG
				+ ", locationBuilding=" + locationBuilding
				+ ", locationBuildingBG=" + locationBuildingBG
				+ ", locationCode=" + locationCode + ", locationEditFlag="
				+ locationEditFlag + ", locationFloor=" + locationFloor
				+ ", locationFloorBG=" + locationFloorBG + ", locationId="
				+ locationId + ", locationName=" + locationName
				+ ", locationNameBG=" + locationNameBG + ", locationNameTh="
				+ locationNameTh + ", locationPhase=" + locationPhase
				+ ", locationPostCode=" + locationPostCode
				+ ", locationPostCodeBG=" + locationPostCodeBG
				+ ", locationProvinceId=" + locationProvinceId
				+ ", locationProvinceIdBG=" + locationProvinceIdBG
				+ ", locationRoomNo=" + locationRoomNo + ", locationRoomNoBG="
				+ locationRoomNoBG + ", locationStreet=" + locationStreet
				+ ", locationStreetBG=" + locationStreetBG
				+ ", locationTambon=" + locationTambon + ", locationTambonBG="
				+ locationTambonBG + ", locationType=" + locationType
				+ ", locationTypeBG=" + locationTypeBG + ", locationTypeText="
				...
				+ ", menuGroup=" + menuGroup + ", message=" + message
				+ ", mode=" + mode + ", modifiedDetail=" + modifiedDetail
				+ ", nearSiteCost=" + nearSiteCost + ", needAvpApprove="
				+ needAvpApprove + ", needConstruction=" + needConstruction
				+ ", needLegalApprove=" + needLegalApprove + ", networkStatus="
				+ networkStatus + ", no=" + no + ", outDt=" + outDt
				+ ", partiesType=" + partiesType + ", partiesTypeRemark="
				+ partiesTypeRemark + ", payBy=" + payBy + ", payByBG="
				+ payByBG + ", payDesc=" + payDesc + ", payDescBG=" + payDescBG
				+ ", payOnUsedDesc=" + payOnUsedDesc + ", payOnUsedDescBG="
				+ payOnUsedDescBG + ", phase=" + phase + ", phaseBG=" + phaseBG
				+ ", placeType=" + placeType + ", placeTypeRemark="
				+ placeTypeRemark + ", promiseRenewPeriod="
				+ promiseRenewPeriod + ", promiseRenewPeriodType="
				+ promiseRenewPeriodType + ", promiseRenewTime="
				+ promiseRenewTime + ", propertyTaxEditFlag="
				+ propertyTaxEditFlag + ", provinceName=" + provinceName
				+ ", provinceNameBG=" + provinceNameBG + ", ptRemark="
				+ ptRemark + ", ptRemarkBG=" + ptRemarkBG + ", ptTaxPayType="
				+ ptTaxPayType + ", receiveDt=" + receiveDt + ", recordStatus="
				+ recordStatus + ", region=" + region + ", remark=" + remark
				+ ", remarkAfterApprove=" + remarkAfterApprove + ", remarkAqm="
				+ remarkAqm + ", remarkContract=" + remarkContract
				+ ", remarkDocuments=" + remarkDocuments + ", remarkLegal="
				+ remarkLegal + ", remarkOther=" + remarkOther
				+ ", remarkRisk=" + remarkRisk + ", remarkSpecial="
				+ remarkSpecial + ", rentAmt=" + rentAmt + ", rentAmtAdd="
				+ rentAmtAdd + ", rentAmtAddPerc=" + rentAmtAddPerc
				+ ", rentAmtBG=" + rentAmtBG + ", rentAmtOld=" + rentAmtOld
				+ ", rentAmtPerYear=" + rentAmtPerYear + ", rentAreaAmtMemo="
				+ rentAreaAmtMemo + ", rentAreaAmtMemoBG=" + rentAreaAmtMemoBG
				+ ", rentAreaMemoVatType=" + rentAreaMemoVatType
				+ ", rentAreaMemoWhtRate=" + rentAreaMemoWhtRate
				+ ", rentAreaMemoWhtType=" + rentAreaMemoWhtType
				+ ", rentDepositBgAmt=" + rentDepositBgAmt
				+ ", rentDepositBgAmtAdd=" + rentDepositBgAmtAdd
				+ ", rentDepositBgAmtOld=" + rentDepositBgAmtOld
				+ ", rentDepositBgVat=" + rentDepositBgVat
				+ ", rentDepositCashAmt=" + rentDepositCashAmt
				+ ", rentDepositCashAmtAdd=" + rentDepositCashAmtAdd
				+ ", rentDepositCashAmtOld=" + rentDepositCashAmtOld
				...
				+ rentOtherAmtMemoBG + ", rentOtherMemoVatType="
				+ rentOtherMemoVatType + ", rentOtherMemoWhtRate="
				+ rentOtherMemoWhtRate + ", rentOtherMemoWhtType="
				+ rentOtherMemoWhtType + ", rentPaymentPeriod="
				...
				+ ", rentPeriodTypeOld=" + rentPeriodTypeOld + ", rentRemark="
				+ rentRemark + ", rentServAmtAdd=" + rentServAmtAdd
				+ ", rentServAmtAddPerc=" + rentServAmtAddPerc
				+ ", rentServAmtOld=" + rentServAmtOld
				+ ", rentServMemoVatType=" + rentServMemoVatType
				+ ", rentServMemoWhtRate=" + rentServMemoWhtRate
				+ ", rentServMemoWhtType=" + rentServMemoWhtType
				+ ", rentServPeriodTypeOld=" + rentServPeriodTypeOld
				+ ", rentServiceAmt=" + rentServiceAmt + ", rentServiceAmtBG="
				+ rentServiceAmtBG + ", rentServiceAmtMemo="
				+ rentServiceAmtMemo + ", rentServiceAmtMemoBG="
				+ rentServiceAmtMemoBG + ", rentServiceDetail="
				+ rentServiceDetail + ", rentServiceDetailBG="
				+ rentServiceDetailBG + ", rentServicePeriodType="
				+ rentServicePeriodType + ", rentServiceVatRate="
				+ rentServiceVatRate + ", rentServiceVatType="
				+ rentServiceVatType + ", rentServiceVatTypeBG="
				+ rentServiceVatTypeBG + ", rentServiceWht=" + rentServiceWht
				+ ", rentServiceWhtBG=" + rentServiceWhtBG
				+ ", rentServiceWhtRate=" + rentServiceWhtRate
				+ ", rentServiceWhtRateMod=" + rentServiceWhtRateMod
				+ ", rentServiceWhtType=" + rentServiceWhtType
				+ ", rentSetupAmtMemo=" + rentSetupAmtMemo
				+ ", rentSetupAmtMemoBG=" + rentSetupAmtMemoBG
				+ ", rentSetupMemoVatType=" + rentSetupMemoVatType
				+ ", rentSetupMemoWhtRate=" + rentSetupMemoWhtRate
				+ ", rentSetupMemoWhtType=" + rentSetupMemoWhtType
				+ ", rentSpecialAmtMemo=" + rentSpecialAmtMemo
				+ ", rentSpecialAmtMemoBG=" + rentSpecialAmtMemoBG
				+ ", rentType=" + rentType + ", rentTypeOtherRemark="
				+ rentTypeOtherRemark + ", rentVatRate=" + rentVatRate
				+ ", rentVatType=" + rentVatType + ", rentWhtDetail="
				+ rentWhtDetail + ", rentWhtDetailBG=" + rentWhtDetailBG
				+ ", rentWhtRate=" + rentWhtRate + ", rentWhtRateMod="
				+ rentWhtRateMod + ", rentWhtType=" + rentWhtType
				+ ", reqDocType=" + reqDocType + ", reqOfficer=" + reqOfficer
				+ ", reqOfficerManual=" + reqOfficerManual + ", reqType="
				+ reqType + ", requestType=" + requestType + ", result="
				+ result + ", retResult=" + retResult + ", retResultMsg="
				+ retResultMsg + ", revenue=" + revenue + ", riskType1="
				+ riskType1 + ", riskType1Remark=" + riskType1Remark
				+ ", riskType2=" + riskType2 + ", riskType2Remark="
				+ riskType2Remark + ", riskType3=" + riskType3
				+ ", riskType3Remark=" + riskType3Remark + ", riskTypeOther="
				+ riskTypeOther + ", riskTypeOtherRemark="
				+ riskTypeOtherRemark + ", roomArea=" + roomArea
				+ ", roomAreaBG=" + roomAreaBG + ", rowId=" + rowId
				+ ", seqNo=" + seqNo + ", showContractNoOldFlag="
				+ showContractNoOldFlag + ", siteAppId=" + siteAppId
				+ ", siteAppSiteList=" + siteAppSiteList + ", siteApproveId="
				+ siteApproveId + ", siteCode=" + siteCode + ", siteDetail="
				+ siteDetail + ", siteGroup=" + siteGroup + ", siteId="
				+ siteId + ", siteNameTh=" + siteNameTh + ", siteType="
				+ siteType + ", siteZone=" + siteZone + ", stationName="
				+ stationName + ", stationType=" + stationType
				+ ", stationTypeBG=" + stationTypeBG + ", status=" + status
				+ ", statusDT=" + statusDT + ", statusDt=" + statusDt
				+ ", statusDtStr=" + statusDtStr + ", strDataList="
				+ strDataList + ", strParam=" + strParam + ", sumEditSite="
				+ sumEditSite + ", sumNewSite=" + sumNewSite
				+ ", sumReNewSite=" + sumReNewSite + ", sumTotal=" + sumTotal
				+ ", sumWaitTerminate=" + sumWaitTerminate + ", sumterminate="
				+ sumterminate + ", system=" + system + ", targetDt="
				+ targetDt + ", teamName=" + teamName
				+ ", terminateCancelContractDt=" + terminateCancelContractDt
				+ ", terminateCancelRelateData=" + terminateCancelRelateData
				+ ", terminateNote=" + terminateNote + ", terminateReason="
				+ terminateReason + ", terminateRemoveDt=" + terminateRemoveDt
				...
				+ ", totalRentServiceBG=" + totalRentServiceBG
				+ ", towerHeight=" + towerHeight + ", towerLocation="
				+ towerLocation + ", towerType=" + towerType + ", updateBy="
				+ updateBy + ", updateDT=" + updateDT + ", updateDTStr="
				+ updateDTStr + ", user=" + user + ", userId=" + userId
				+ ", userLogin=" + userLogin + ", userName=" + userName
	...
	public String getElectricCondType() {
		return electricCondType;
	}

	public void setElectricCondType(String electricCondType) {
		this.electricCondType = electricCondType;
	}

	public String getElectricCondTypeName() {
		return electricCondTypeName;
	}

	public void setElectricCondTypeName(String electricCondTypeName) {
		this.electricCondTypeName = electricCondTypeName;
	}
	...
	public String getUseNewMeter() {
		return useNewMeter;
	}

	public void setUseNewMeter(String useNewMeter) {
		this.useNewMeter = useNewMeter;
	}

	public String getUseOldMeter() {
		return useOldMeter;
	}

	public void setUseOldMeter(String useOldMeter) {
		this.useOldMeter = useOldMeter;
	}
	...
	public String getpSaElectricType() {
		return pSaElectricType;
	}

	public void setpSaElectricType(String pSaElectricType) {
		this.pSaElectricType = pSaElectricType;
	}
	...
	public void setReturnDepositFlag(String returnDepositFlag) {
		this.returnDepositFlag = returnDepositFlag;
	}

	public String getNoReturnDepositFlag() {
		return noReturnDepositFlag;
	}

	public void setNoReturnDepositFlag(String noReturnDepositFlag) {
		this.noReturnDepositFlag = noReturnDepositFlag;
	}

	public String getCancelMeterFlag() {
		return cancelMeterFlag;
	}

	public void setCancelMeterFlag(String cancelMeterFlag) {
		this.cancelMeterFlag = cancelMeterFlag;
	}

	public String getTerminateElFlag() {
		return terminateElFlag;
	}

	public void setTerminateElFlag(String terminateElFlag) {
		this.terminateElFlag = terminateElFlag;
	}

	public String getOtherTerminateFlag() {
		return otherTerminateFlag;
	}

	public void setOtherTerminateFlag(String otherTerminateFlag) {
		this.otherTerminateFlag = otherTerminateFlag;
	}

	public Date getTerminateRantDt() {
		return terminateRantDt;
	}

	public void setTerminateRantDt(Date terminateRantDt) {
		this.terminateRantDt = terminateRantDt;
	}
	...
	public Date getReturnDepositDt() {
		return returnDepositDt;
	}

	public void setReturnDepositDt(Date returnDepositDt) {
		this.returnDepositDt = returnDepositDt;
	}

	public String getOtherTerminateNote() {
		return otherTerminateNote;
	}

	public void setOtherTerminateNote(String otherTerminateNote) {
		this.otherTerminateNote = otherTerminateNote;
	}

	public String getOtherWaitingFlag() {
		return otherWaitingFlag;
	}

	public void setOtherWaitingFlag(String otherWaitingFlag) {
		this.otherWaitingFlag = otherWaitingFlag;
	}

	public BigDecimal getDonateAmt() {
		return donateAmt;
	}

	public void setDonateAmt(BigDecimal donateAmt) {
	...
	public BigDecimal getOtherPaymentAmt() {
		return otherPaymentAmt;
	}

	public void setOtherPaymentAmt(BigDecimal otherPaymentAmt) {
		this.otherPaymentAmt = otherPaymentAmt;
	}

	public String getpElectricType() {
		return pElectricType;
	}

	public void setpElectricType(String pElectricType) {
		this.pElectricType = pElectricType;
	}
	...
	public String getContRentAdj() {
		return contRentAdj;
	}

	public void setContRentAdj(String contRentAdj) {
		this.contRentAdj = contRentAdj;
	}

	public String getContRentAdjPerType() {
		return contRentAdjPerType;
	}

	public void setContRentAdjPerType(String contRentAdjPerType) {
		this.contRentAdjPerType = contRentAdjPerType;
	}
	...
	public String getEmerContactTitleName() {
		return emerContactTitleName;
	}

	public void setEmerContactTitleName(String emerContactTitleName) {
		this.emerContactTitleName = emerContactTitleName;
	}

	public String getEmerContactIdCard() {
		return emerContactIdCard;
	}

	public void setEmerContactIdCard(String emerContactIdCard) {
		this.emerContactIdCard = emerContactIdCard;
	}

	public String getEmerContactTaxId() {
		return emerContactTaxId;
	}

	public void setEmerContactTaxId(String emerContactTaxId) {
		this.emerContactTaxId = emerContactTaxId;
	}

	public Date getEmerContactBirthday() {
		return emerContactBirthday;
	}

	public void setEmerContactBirthday(Date emerContactBirthday) {
		this.emerContactBirthday = emerContactBirthday;
	}

	public String getEmerContactHouseNo() {
		return emerContactHouseNo;
	}

	public void setEmerContactHouseNo(String emerContactHouseNo) {
		this.emerContactHouseNo = emerContactHouseNo;
	}

	public String getEmerContactHouseNoBG() {
		return emerContactHouseNoBG;
	}

	public void setEmerContactHouseNoBG(String emerContactHouseNoBG) {
		this.emerContactHouseNoBG = emerContactHouseNoBG;
	}

	public String getEmerContactBuilding() {
		return emerContactBuilding;
	}

	public void setEmerContactBuilding(String emerContactBuilding) {
		this.emerContactBuilding = emerContactBuilding;
	}

	public String getEmerContactBuildingBG() {
		return emerContactBuildingBG;
	}

	public void setEmerContactBuildingBG(String emerContactBuildingBG) {
		this.emerContactBuildingBG = emerContactBuildingBG;
	}

	public String getEmerContactFloor() {
		return emerContactFloor;
	}

	public void setEmerContactFloor(String emerContactFloor) {
		this.emerContactFloor = emerContactFloor;
	}

	public String getEmerContactFloorBG() {
		return emerContactFloorBG;
	}

	public void setEmerContactFloorBG(String emerContactFloorBG) {
		this.emerContactFloorBG = emerContactFloorBG;
	}

	public String getEmerContactRoomNo() {
		return emerContactRoomNo;
	}

	public void setEmerContactRoomNo(String emerContactRoomNo) {
		this.emerContactRoomNo = emerContactRoomNo;
	}

	public String getEmerContactRoomNoBG() {
		return emerContactRoomNoBG;
	}

	public void setEmerContactRoomNoBG(String emerContactRoomNoBG) {
		this.emerContactRoomNoBG = emerContactRoomNoBG;
	}

	public String getEmerContactStreet() {
		return emerContactStreet;
	}

	public void setEmerContactStreet(String emerContactStreet) {
		this.emerContactStreet = emerContactStreet;
	}

	public String getEmerContactStreetBG() {
		return emerContactStreetBG;
	}

	public void setEmerContactStreetBG(String emerContactStreetBG) {
		this.emerContactStreetBG = emerContactStreetBG;
	}

	public String getEmerContactTambon() {
		return emerContactTambon;
	}

	public void setEmerContactTambon(String emerContactTambon) {
		this.emerContactTambon = emerContactTambon;
	}

	public String getEmerContactTambonBG() {
		return emerContactTambonBG;
	}

	public void setEmerContactTambonBG(String emerContactTambonBG) {
		this.emerContactTambonBG = emerContactTambonBG;
	}

	public String getEmerContactAmphurId() {
		return emerContactAmphurId;
	}

	public void setEmerContactAmphurId(String emerContactAmphurId) {
		this.emerContactAmphurId = emerContactAmphurId;
	}

	public String getEmerContactProvinceId() {
		return emerContactProvinceId;
	}

	public void setEmerContactProvinceId(String emerContactProvinceId) {
		this.emerContactProvinceId = emerContactProvinceId;
	}
	...
	public void setEmerContactPostCode(String emerContactPostCode) {
		this.emerContactPostCode = emerContactPostCode;
	}

	public String getEmerContactPostCodeBG() {
		return emerContactPostCodeBG;
	}

	public void setEmerContactPostCodeBG(String emerContactPostCodeBG) {
		this.emerContactPostCodeBG = emerContactPostCodeBG;
	}

	public String getEmerContactTaxIdBG() {
		return emerContactTaxIdBG;
	}

	public void setEmerContactTaxIdBG(String emerContactTaxIdBG) {
		this.emerContactTaxIdBG = emerContactTaxIdBG;
	}
	...
	public String getEmerContactNameBG() {
		return emerContactNameBG;
	}

	public void setEmerContactNameBG(String emerContactNameBG) {
		this.emerContactNameBG = emerContactNameBG;
	}
	...
	public String getEmerContactTelBG() {
		return emerContactTelBG;
	}

	public void setEmerContactTelBG(String emerContactTelBG) {
		this.emerContactTelBG = emerContactTelBG;
	}
	...
	public String getEmerContactMobileBG() {
		return emerContactMobileBG;
	}

	public void setEmerContactMobileBG(String emerContactMobileBG) {
		this.emerContactMobileBG = emerContactMobileBG;
	}

	public String getEmerContactFax() {
		return emerContactFax;
	}

	public void setEmerContactFax(String emerContactFax) {
		this.emerContactFax = emerContactFax;
	}

	public String getEmerContactFaxBG() {
		return emerContactFaxBG;
	}

	public void setEmerContactFaxBG(String emerContactFaxBG) {
		this.emerContactFaxBG = emerContactFaxBG;
	}
	...
	public void setEmerContactEmail(String emerContactEmail) {
		this.emerContactEmail = emerContactEmail;
	}

	public String getEmerContactEmailBG() {
		return emerContactEmailBG;
	}

	public void setEmerContactEmailBG(String emerContactEmailBG) {
		this.emerContactEmailBG = emerContactEmailBG;
	}

	public String getRenewRentAddFlag() {
		return renewRentAddFlag;
	}

	public void setRenewRentAddFlag(String renewRentAddFlag) {
		this.renewRentAddFlag = renewRentAddFlag;
	}
	...
	public void setTermProcessDt(Date termProcessDt) {
		this.termProcessDt = termProcessDt;
	}

	public String getTermProcessDtStr() {
		return termProcessDtStr;
	}

	public void setTermProcessDtStr(String termProcessDtStr) {
		this.termProcessDtStr = termProcessDtStr;
	}

	public String getTermProcessRemark() {
		return termProcessRemark;
	}

	public void setTermProcessRemark(String termProcessRemark) {
		this.termProcessRemark = termProcessRemark;
	}
