...
public class SiteAppRegHistSrch extends AbstractDomain  {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6743265003578403582L;
	...
	public Date getExprieDt() {
		return expireDt;
	}

	public void setExprieDt(Date expireDt) {
