...
public class ItemParamsSP {
	...
	public String toString() {
		return "ItemParamsSP [param1=" + param1 + ", param10=" + param10
				+ ", param11=" + param11 + ", param12=" + param12
				+ ", param13=" + param13 + ", param2=" + param2 + ", param3="
				+ param3 + ", param4=" + param4 + ", param5=" + param5
				+ ", param6=" + param6 + ", param7=" + param7 + ", param8="
				+ param8 + ", param9=" + param9 + "]";
	}	
