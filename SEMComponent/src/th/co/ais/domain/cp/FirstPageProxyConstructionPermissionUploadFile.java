...
public class FirstPageProxyConstructionPermissionUploadFile extends AbstractDomain{

	private static final long serialVersionUID = -5676439395015531357L;
	...
	private String importFileDtStr;
	...
	public Date getImportFileDt() {
		return importFileDt;
	}

	public void setImportFileDt(Date importFileDt) {
		this.importFileDt = importFileDt;
	}
	...
	public String getImportFileDtStr() {
		return importFileDtStr;
	}

	public void setImportFileDtStr(String importFileDtStr) {
		this.importFileDtStr = importFileDtStr;
	}
