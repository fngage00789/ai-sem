...
@Entity
@Table(name = "MP110325_SAPCT", schema="SEM")
public class MpSapct implements Serializable {
	...
	@Id
	@GeneratedValue(strategy=GenerationType.AUTO, generator = "MP_SAPCT_SEQ")
	@SequenceGenerator(name="MP_SAPCT_SEQ", sequenceName = "MP_SAPCT_SEQ")
