 ...
 */
@Entity
@Table(name = "MP110325_SAPMO", schema="SEM")
public class MpSapmo implements Serializable {
	...
	@Id
	@GeneratedValue(strategy=GenerationType.AUTO, generator = "MP_SAPMO_SEQ")
	@SequenceGenerator(name="MP_SAPMO_SEQ", sequenceName = "MP_SAPMO_SEQ")
