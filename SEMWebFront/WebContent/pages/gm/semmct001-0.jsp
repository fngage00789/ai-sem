	       ...
	       <rich:panel id="pnlSearchCriteria">
                        ...
                        <h:panelGrid width="95%"  border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                    ...
                                    <td width="15%" valign="bottom">
                                        <h:selectOneMenu id="ddlCompany" value="#{semmct001Bean.treeUtilBean.company}">
                                    ...
                                    <td width="15%" valign="bottom">
                                    <h:selectOneMenu id="ddlRegion" value="#{semmct001Bean.treeUtilBean.region}"> 
                                        <f:selectItems value="#{semmct001Bean.regionList}"/>
                                    </h:selectOneMenu>
                                    </td>
                                    ...
                                    <td width="10%" valign="bottom">
                                        <h:selectOneMenu id="ddlType" value="#{semmct001Bean.treeUtilBean.menuSubGroup}"> 
                                            <f:selectItem itemValue="" itemLabel="-- Select --"/>
	                                        <f:selectItem itemValue="M" itemLabel="MACRO"/>
                                    ...
                                    <td width="30%" align="center">
			                            ...
			                            action="#{navAction.navi}" reRender="frmError,pnlSearchCriteria,pnlSearchResult,frmSearchResult,dtbSiteInfo,frmTree" >
				                            ...
				                            <a4j:actionparam name="navProgram" value="semmct001-0" />
			...
			<rich:panel style="border:1 e0e0e0 solid; height:100%; vertical-align:top;">
				...
				<div style="width:280px;">
					...
					<h:form id="frmTree">
						<!-- >> Macro -->
						<rich:simpleTogglePanel id="semmct001_pnlSubMacro"  switchType="client" label="#{semmct001Bean.headerTreeMacro}" 
					        opened="true" style="width:100%;margin:0 auto; padding:0px;"
					        rendered="#{semmct001Bean.treeMacroFlag}">
								<h:dataTable id="semmct001_macro" border="0"
									var="obj" value="#{semmct001Bean.menuTreeMacroList}" 
										...
										<div align="left" onmouseover="this.style.backgroundColor='#FFE4E1'" onmouseout="this.style.backgroundColor='transparent'">									
											<span style="width:195px; white-space:nowrap;">  
										          ...
										          reRender="oppContent,panelWrapper_tree,panelWrapper_content" >
			                                        ...
			                                        <a4j:actionparam name="methodWithNavi" value="doInitialForSearchVendorMaster" />
							...
							<!-- Pico -->
							<rich:simpleTogglePanel id="semmct001_pnlSubPico"  switchType="client" label="#{semmct001Bean.headerTreePico}" 
					        opened="true" style="width:100%;margin:0 auto; padding:0px;"
					        rendered="#{semmct001Bean.treePicoFlag}">
								<h:dataTable id="semmct001_pico" border="0"
									var="obj" value="#{semmct001Bean.menuTreePicoList}" 
