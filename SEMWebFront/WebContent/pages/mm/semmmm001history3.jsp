	...
	<f:facet name="header"><h:outputText value="#{jspMsg['header.history.bookbank.info']}"/></f:facet>	
		...
		<a4j:form id="frmContractInfo" >
			...
			<h:panelGrid id="vendorInfoHist" width="98%" style="border:solid 1px gray;">
							...
							<table width="100%">
								<tr>
									<td style="width:20%; text-align:right;" class="ms7">
										...
										<h:outputText value="#{jspMsg['label.account.type']}" styleClass="ms7"/>
									</td>
									<td colspan="3">
										
		                				<h:outputText id="bankInfoAccountType" value="#{semmmm001Bean.bookbankInfoHist.accountTypeTxt}" styleClass="ms7"/>
									</td>
								</tr>
								<tr>
									<td style="width:20%; text-align:right;" class="ms7">
										<h:outputText value="* " style="font-style:bold; color:red;" />
										<h:outputText value="#{jspMsg['label.bank.code']}" styleClass="ms7"/>
									</td>
									<td style="width:30%;">
										
										<h:outputText id="bankInfoBankCode" value="#{semmmm001Bean.bookbankInfoHist.bankCode}" styleClass="ms7"/>
									...
									<td style="width:30%;">
										<%--
										<h:selectOneMenu id="bankInfoBankName" value="#{semmmm001Bean.bookbankInfoHist.bankId}" 
		                				...
		                				--%>
		                				<h:outputText id="bankInfoBankName" value="#{semmmm001Bean.bookbankInfoHist.bankName}" styleClass="ms7" />
									</td>
								</tr>
								<tr>
									<td style="width:20%; text-align:right;" class="ms7">
										<h:outputText value="#{jspMsg['label.bank.branch']}" styleClass="ms7"/>
									</td>
									<td style="width:30%;">
										<h:outputText id="bankInfoBankBranch" value="#{semmmm001Bean.bookbankInfoHist.bankBranch}" styleClass="ms7" />
									</td>
									<td style="width:20%; text-align:right;" class="ms7">
										<h:outputText value="#{jspMsg['label.th_province']}" styleClass="ms7"/>
									</td>
									<td style="width:30%;">
										<h:outputText id="bankInfoProvince" value="#{semmmm001Bean.bookbankInfoHist.provinceTxt}" styleClass="ms7"/>
									</td>
								</tr>
								<tr>
									<td style="width:20%; text-align:right;" class="ms7">
									...
									<td style="width:30%;">
										<h:outputText id="bankInfoAccountNo" value="#{semmmm001Bean.bookbankInfoHist.accountNo}" styleClass="ms7"/>
										
										
									</td>
									<td style="width:20%; text-align:right;" class="ms7">
										<h:outputText value="* " style="font-style:bold; color:red;" />
										<h:outputText value="#{jspMsg['label.account.name']}" styleClass="ms7"/>
									</td>
									<td style="width:30%;">
										<h:outputText id="bankInfoAccountName" value="#{semmmm001Bean.bookbankInfoHist.accountName}" styleClass="ms7" />
								...
								<tr>
									...
									<td style="width:30%;">
										<h:outputText id="bankInfoRemark" value="#{semmmm001Bean.bookbankInfoHist.remark}" styleClass="ms7"/>
									</td>
									<td style="width:20%; text-align:right;" class="ms7">
										<h:outputText value="#{jspMsg['label.bookbank.status']}" styleClass="ms7"/>
									</td>
									<td style="width:30%;">
										
		                				<h:outputText id="bankInfoBookbankStatus" value="#{semmmm001Bean.bookbankInfoHist.activeStatusTxt}" styleClass="ms7"/>
									</td>
								</tr>
								<tr>
									...
									<td style="width:20%; text-align:right;" class="ms7">
										<h:outputText value="#{jspMsg['label.bookbank.flow.status']}" styleClass="ms7"/>
									</td>
									<td style="width:30%;">
										
		                				<h:outputText id="bankInfoBookbankFlowStatus" 
										value="#{semmmm001Bean.bookbankInfoHist.bookbankFlowStatusTxt}" styleClass="ms7"/>
									</td>
								</tr>
							</table>
						</h:panelGroup>
				...
				<!-- panel vendor info -->
				<rich:panel >
						<f:facet name="header"><h:outputText value="#{jspMsg['header.bookbank.info.history']}" style="text-align:left;"/></f:facet>
						<div id="tabHistoryList" style="width:1250px; overflow-x:scroll; overflow-y:none; border:1px solid #e0e0e0;"> 
