	...
	<f:facet name="header"><h:outputText value="#{jspMsg['header.history.bookbank.payee.info']}"/></f:facet>	
		...
		<a4j:form id="frmVendorBookbankInfo">
					...
					<h:panelGroup>
						<table width="100%">
							<tr>
								...
								<td colspan="3">
									<h:outputText id="bookbankPayeeInfoHistAccountType" value="#{semmmm001Bean.bookbankPayeeInfoHist.accountTypeTxt}" styleClass="ms7"></h:outputText>
							...
							<tr>
								...
								<td style="width:30%;">
									<h:outputText id="bookbankPayeeInfoHistBankCode" 
									value="#{semmmm001Bean.bookbankPayeeInfoHist.bankCode}" styleClass="ms7"/>
								</td>
								<td style="width:20%; text-align:right;" class="ms7">
									<h:outputText value="#{jspMsg['label.bank']}" styleClass="ms7"/>
								</td>
								<td style="width:30%;">
									<h:outputText id="bookbankPayeeInfoHistBank" 
									value="#{semmmm001Bean.bookbankPayeeInfoHist.bankName}" styleClass="ms7"/>
								</td>
							</tr>
							<tr>
								<td style="width:20%; text-align:right;" class="ms7">
								...
								<td style="width:30%;">
									<h:outputText id="bookbankPayeeInfoHistBankBranch" value="#{semmmm001Bean.bookbankPayeeInfoHist.bankBranch}" styleClass="ms7"/>
								...
								<td style="width:30%;">
									<h:outputText id="bookbankPayeeInfoHistProvince" value="#{semmmm001Bean.bookbankPayeeInfoHist.provinceTxt}" styleClass="ms7"/>
							...
							<tr>
								...
								<td style="width:30%;">
									<h:outputText id="bookbankPayeeInfoHistAccountNo" value="#{semmmm001Bean.bookbankPayeeInfoHist.accountNo}" styleClass="ms7"/>
								...
								<td style="width:30%;">
									<h:outputText id="bookbankPayeeInfoHistAccountName" 
									value="#{semmmm001Bean.bookbankPayeeInfoHist.accountName}" styleClass="ms7"/>
								</td>
							</tr>
							<tr>
								<td style="width:20%; text-align:right;" class="ms7">
								...
								<td colspan="3">
									<h:outputText id="bookbankPayeeInfoHistRemark" value="#{semmmm001Bean.bookbankPayeeInfoHist.remark}" styleClass="ms7"/>
								</td>
							</tr>
						</table>
					</h:panelGroup>
			...
			<rich:panel>
				...
				<div id="tabBookbankPayeeHistoryChange" style="width:1250px; overflow-x:scroll; overflow-y:none; border:1px solid #e0e0e0;"> 
