		...
		<a4j:form id="frmContractInfo" >
			...
			<h:panelGrid id="vendorInfoHist" width="98%" style="border:solid 1px gray;">
							...
							<table width="80%" align="center" >
								...
								<tr class="ms7">
									...
									<td style="width:80%;" colspan="5">
										...
										value="#{semmmm001Bean.vendorAddrHistObj.chkLocalDepartment}"
										disabled="#{semmmm001Bean.disableContent and semmmm001Bean.disableEditVendorContent}"
				...
				<rich:panel>
					...
					<div id="tabVendorHistory" style="width:1250px; overflow-x:scroll; overflow-y:none; border:1px solid #e0e0e0;"> 
						...
						rowClasses="cur" styleClass="contentform" rowKeyVar="row">
							...
							<rich:column title="#{historyObj.dataObj.contractNo}" sortBy="#{historyObj.dataObj.contractNo}">
								...
								<div align="center">
									<a4j:commandLink id="hlkViewPopupSiteInfo" value="#{historyObj.dataObj.contractNo}" 
										...
										<a4j:actionparam name="actionWithNavi" value="PopupViewSiteInfo"/>
										<a4j:actionparam name="methodWithNavi" value="initPopup" />
										<a4j:actionparam name="rowId" value="#{historyObj.dataObj.siteInfoId}" />
									</a4j:commandLink>
								</div>
							</rich:column>
							...
							<rich:column title="#{historyObj.dataObj.oldContractNo}" sortBy="#{historyObj.dataObj.oldContractNo}">
								<f:facet name="header">
									<h:outputText value="#{jspMsg['column.oldContractNo']}" styleClass="contentform"/>
								</f:facet>
							...
							<rich:column title="#{historyObj.dataObj.vendorCode}" sortBy="#{historyObj.dataObj.vendorCode}">
								...
								<div align="center">
									...
									oncomplete="onTopPage();">
										...
										<a4j:actionparam name="moduleWithNavi" value="mm" />
										<a4j:actionparam name="actionWithNavi" value="SEMMMM001"/>
										<a4j:actionparam name="methodWithNavi" value="doViewVendorHistDetail" />
							...
							<rich:column title="#{historyObj.dataObj.vendorIdCard}" sortBy="#{historyObj.dataObj.idCard}">
								<f:facet name="header">
									<h:outputText value="#{jspMsg['column.header.citizen.id']}" styleClass="contentform"/>
								</f:facet>
								
								<div align="center">
									<h:outputText value="#{historyObj.dataObj.vendorIdCard}" styleClass="contentform"  />
								</div>
							</rich:column>
							
							<rich:column title="#{historyObj.dataObj.vendorTaxId}" sortBy="#{historyObj.dataObj.taxId}">
								<f:facet name="header">
									<h:outputText value="#{jspMsg['column.header.personal.tax.id']}" styleClass="contentform"/>
								</f:facet>
								
								<div align="center">
									<h:outputText value="#{historyObj.dataObj.vendorTaxId}" styleClass="contentform"  />
								</div>
							</rich:column>
							...
							<rich:column title="#{historyObj.dataObj.vendorAccountNo}" sortBy="#{historyObj.dataObj.vendorAccountNo}">
								...
								<div align="center">
									...
									<a4j:commandLink id="hlkBookbank" value="#{historyObj.dataObj.vendorAccountNo}" 
											action="#{navAction.navi}" reRender="txtNavProgram, oppContent" 
											oncomplete="onTopPage();">
												<a4j:actionparam name="navModule" value="mm" />
												<a4j:actionparam name="navProgram" value="SEMMMM001HISTORY3DETAIL" />
												<a4j:actionparam name="moduleWithNavi" value="mm" />
												<a4j:actionparam name="actionWithNavi" value="SEMMMM001"/>
												<a4j:actionparam name="methodWithNavi" value="doViewBookbankHistDetail" />
												<a4j:actionparam name="contractNoParam" value="#{historyObj.dataObj.contractNo}" />
												<a4j:actionparam name="vendorIdParam" value="#{historyObj.dataObj.vendorId}" />
												<a4j:actionparam name="vendorBookbankIdParam" value="#{historyObj.dataObj.vendorBookbankId}" />
											</a4j:commandLink>
								</div>
							</rich:column>
							...
							<rich:column title="#{historyObj.dataObj.payeeCode}" sortBy="#{historyObj.dataObj.payeeCode}">
								...
								<div align="left" style="width:120px;">
											...
											<a4j:commandLink id="hlkPayeeHistDetail" value="#{historyObj.dataObj.payeeCode}" 
												action="#{navAction.navi}" reRender="txtNavProgram, oppContent" 
												oncomplete="onTopPage();">
													<a4j:actionparam name="navModule" value="mm" />
													...
													<a4j:actionparam name="moduleWithNavi" value="mm" />
													<a4j:actionparam name="actionWithNavi" value="SEMMMM001"/>
													<a4j:actionparam name="methodWithNavi" value="doViewPayeeHistDetail" />
													<a4j:actionparam name="contractNoParam" value="#{historyObj.dataObj.contractNo}" />
													<a4j:actionparam name="vendorIdParam" value="#{historyObj.dataObj.vendorId}" />
													<a4j:actionparam name="payeeIdParam" value="#{historyObj.dataObj.payeeId}" />
							...
							<rich:column title="#{historyObj.dataObj.payeeAccountNo}" sortBy="#{historyObj.dataObj.payeeAccountNo}">
								<f:facet name="header">
									...
									<div align="left" style="width:120px;">
										...
										<a4j:commandLink id="hlkPayeeAccountNo" value="#{historyObj.dataObj.payeeAccountNo}" 
												action="#{navAction.navi}" reRender="txtNavProgram, oppContent" 
												oncomplete="onTopPage();">
													<a4j:actionparam name="navModule" value="mm" />
													<a4j:actionparam name="navProgram" value="SEMMMM001HISTORY5DETAIL" />
													<a4j:actionparam name="moduleWithNavi" value="mm" />
													<a4j:actionparam name="actionWithNavi" value="SEMMMM001"/>
													<a4j:actionparam name="methodWithNavi" value="doViewBBPayeeHistDetail" />
													<a4j:actionparam name="contractNoParam" value="#{historyObj.dataObj.contractNo}" />
													<a4j:actionparam name="vendorIdParam" value="#{historyObj.dataObj.vendorId}" />
													<a4j:actionparam name="payeeIdParam" value="#{historyObj.dataObj.payeeId}" />
													<a4j:actionparam name="bookbankPayeeIdParam" value="#{historyObj.dataObj.payeeBookbankId}" />
												</a4j:commandLink>
								</div>
							</rich:column>
								...
								<rich:columnGroup>
									...
									<rich:column colspan="2">
										<h:outputFormat value="#{msg['message.totalRecords']}">
											<f:param value="#{fn:length(semmmm001Bean.vendorInfoHistSummaryList)}"></f:param>
										</h:outputFormat>
									</rich:column>
									<!-- > 2 -->
				...
				<rich:panel rendered="false">
					...
					<div id="tabVendorHistoryChange" style="width:1250px; overflow-x:scroll; overflow-y:none; border:1px solid #e0e0e0;"> 
			...
			<!-- group[3] >> -->
			<rich:panel style="width:1250px; overflow-x:scroll; overflow-y:none; border:1px solid #e0e0e0;" styleClass="sem_autoScrollbar" rendered="false">
				<f:facet name="header"><h:outputText value="#{jspMsg['header.bank.info']}"/></f:facet>
			...
			<rich:panel style="width:1100px; overflow:auto; text-align:center;" styleClass="sem_autoScrollbar" rendered="false">
				<f:facet name="header"><h:outputText value="#{jspMsg['header.list.of.payee.and.bookbankpayee']}"/></f:facet>
