	...
	<f:facet name="controls">
		...
		<h:panelGrid>
			<a4j:form id="popupFrmError">
				<rich:messages layout="list" errorClass="ms7red" warnClass="ms7blue" infoClass="ms7green" rendered="#{semmco002Bean.renderedMsgFormSearchPopup}">
				 		<f:facet name="header">
				...
				<rich:panel id="pnlAddContractStatus">
						...
						<h:panelGrid width="90%"  border="0" cellpadding="0" cellspacing="1">
							...
							<tr>
									...
									<h:selectOneMenu id="ddlContractStatus" value="#{semmco002Bean.contractStatus.contractStatus}"
								...
								<td align="right" width="25%">
			                	 ...
			                	 <tr>
		                			...
		                			<td width="75%" colspan="3">
		                			<h:inputTextarea id="txtRemark" value="#{semmco002Bean.contractStatus.remark}" 
		                			cols="70" rows="3"/>
				                	</td>
			                	 </tr>
			                	 <h:panelGroup id="pnlGp0022Recipient" rendered="#{semmco002Bean.contractStatus.contractStatus eq '01'}">
			                	 <tr>
									<td align="right" width="25%" valign="top">
			                	 ...
			                	 <h:panelGroup id="pnlGp0022Organizer" rendered="#{semmco002Bean.contractStatus.contractStatus eq '01'}">
			                	 <tr>
									<td align="right" width="25%" valign="top">
						...
						rendered="#{semmco002Bean.renderedAddHistory}"
						oncomplete="if(#{semmco002Bean.popupClose == 'true'})#{rich:component('popupAddContractStatus')}.hide();">
						...
						<a4j:commandButton value="#{jspMsg['btn.cancel']}" styleClass="rich-button" immediate="true" rendered="#{semmco002Bean.renderedAddHistory}">
