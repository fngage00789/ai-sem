	...
	<h:panelGrid columnClasses="gridContent" width="100%">
		 <h:panelGrid id="pnlTab1" width="95%">
				<!-- panel search location criteria -->
		          <rich:panel id="pnlContractTab1" >
						...
						<h:panelGrid width="90%" border="0" cellpadding="0" cellspacing="1">
							...
							<table width="100%">
			                	 <tr>
		                			...
		                			<td width="30%">
		                			<h:inputText id="txtContractNoDisplay" value="#{semmco005Bean.contractNoParam}" 
		                			...
		                			<td width="30%">
		                			<h:inputText id="txtSiteNameDisplay" value="#{semmco005Bean.siteNameParam}" 
		                			readonly="true" disabled="true" size="30" maxlength="50"/>
									</td>
			                	 </tr>
			                	 ...
			                	 <tr>
		                			...
		                			<td width="30%">
		                			<h:inputText id="txtEffDate" value="#{semmco005Bean.effDateParamStr}" readonly="true" disabled="true" size="13" >
		                			</h:inputText>
				                	</td>
				                	<td align="right" width="20%">
		                			...
		                			<td width="30%">
		                			  <h:inputText id="txtExpDate" value="#{semmco005Bean.expDateParamStr}" readonly="true" disabled="true" size="13" >
		                			  </h:inputText>
				                	</td>
			                	 </tr>
							</table>
						...
						<rich:dataTable width="97%" id="dtbContractStatusHistory" cellpadding="1" cellspacing="0" border="0"
							var="contractStatusHistorySP" value="#{semmco005tab1Bean.contractStatusHistoryList}" reRender="dtbContractStatusHistory" 
							rows="10" rowClasses="cur"	 styleClass="dataTable">
							<a4j:support event="onRowClick"   action="#{semmco005tab1Action.getRowIdOnClick}" reRender="dtbContractStatusHistory">
								<a4j:actionparam name="rowId" value="#{contractStatusHistorySP.rowId}" />
							</a4j:support>
							<rich:column styleClass="#{(semmco005tab1Bean.tmpRowId==contractStatusHistorySP.rowId)?'onClick':'unClick'}">
								<f:facet name="header" >
								...
								<div align="center">
	            					...
	            					rendered="#{contractStatusHistorySP.lastRecord and semmco005tab1Bean.renderedUpdateHistory}">
										<a4j:actionparam name="navModule" value="co" />
		            					<a4j:actionparam name="navProgram" value="SEMMCO005TAB1" />	
										<a4j:actionparam name="moduleWithNavi" value="co" />
										<a4j:actionparam name="actionWithNavi" value="SEMMCO005Tab1" />
							...
							<rich:column styleClass="#{(semmco005tab1Bean.tmpRowId==contractStatusHistorySP.rowId)?'onClick':'unClick'}">
								...
								<div align="center">
	            					<a4j:commandButton id="btnDeleteHistory" oncomplete="#{rich:component('mdpConfirmDelDialogContractStatusHistory')}.show(); return false" 
     								...
     								rendered="#{contractStatusHistorySP.lastRecord and semmco005tab1Bean.renderedDeleteHistory}">
										<a4j:actionparam name="navModule" value="co" />
		            					<a4j:actionparam name="navProgram" value="SEMMCO005TAB1" />	
										<a4j:actionparam name="moduleWithNavi" value="co" />
										<a4j:actionparam name="actionWithNavi" value="SEMMCO005Tab1" />
							...
							<rich:column  sortBy="#{contractStatusHistorySP.changeStatusDate}" styleClass="#{(semmco005tab1Bean.tmpRowId==contractStatusHistorySP.rowId)?'onClick':'unClick'}">
								<f:facet name="header">
							...
							<rich:column  sortBy="#{contractStatusHistorySP.contractStatusName}" styleClass="#{(semmco005tab1Bean.tmpRowId==contractStatusHistorySP.rowId)?'onClick':'unClick'}">
								<f:facet name="header">
							...
							<rich:column  sortBy="#{contractStatusHistorySP.remark}" styleClass="#{(semmco005tab1Bean.tmpRowId==contractStatusHistorySP.rowId)?'onClick':'unClick'}">
								<f:facet name="header">
							...
							<rich:column  sortBy="#{contractStatusHistorySP.updateBy}" styleClass="#{(semmco005tab1Bean.tmpRowId==contractStatusHistorySP.rowId)?'onClick':'unClick'}">
								<f:facet name="header">
								...
								<rich:columnGroup>
									<rich:column colspan="2">
										<h:outputFormat value="#{msg['message.totalRecords']}">
											<f:param value="#{fn:length(semmco005tab1Bean.contractStatusHistoryList)}"></f:param>
										</h:outputFormat>
									</rich:column>
									<rich:column colspan="4">
										<rich:datascroller immediate="true" rendered="true" align="left" for="dtbContractStatusHistory"
											maxPages="#{semmco005tab1Bean.rowPerPage}"  selectedStyleClass="selectScroll"
											stepControls="hide" fastControls="auto" boundaryControls="auto" 
											id="dstContractStatusHistory" 
											style="background-color: #cccccc;"
											page="#{semmco005tab1Bean.scrollerPage}" 
										/>
									</rich:column>
								</rich:columnGroup>
							</f:facet>
				...
				<rich:panel id="pnlEditContractStatus">
						...
						<div align="left">
							<rich:messages layout="list" errorClass="ms7red" warnClass="ms7blue" infoClass="ms7green" rendered="#{semmco005tab1Bean.renderedMsgFormMiddle}"/>
						</div>
						<h:panelGrid width="90%"  border="0" cellpadding="0" cellspacing="1">
							<h:panelGroup>
							<table width="100%">
							...
							value="#{semmco005tab1Bean.contractStatus.changeStatusDt}" 
							showWeeksBar="false" 
							inputSize="13"
                			...
                			<td width="60%">
                			<h:selectOneMenu id="ddlContractStatusTab1" value="#{semmco005tab1Bean.contractStatus.contractStatus}" 
                				rendered="#{!semmco005Bean.chkContractLost}">
								<f:selectItems value="#{semmco005Bean.contractStatusTab1List}"/>
							</h:selectOneMenu>
							<h:selectOneMenu id="ddlContractLostStatusTab1" value="#{semmco005tab1Bean.contractStatus.contractStatus}" 
								rendered="#{semmco005Bean.chkContractLost}">
								<f:selectItems value="#{semmco005Bean.contractLostStatusList}"/>
							</h:selectOneMenu>
							<rich:spacer width="5"/>
		                	</td>
	                		</tr>
                			...
                			<h:inputTextarea id="txtRemark2" value="#{semmco005tab1Bean.contractStatus.remark}" 
                			cols="100" rows="3"/>
		                	</td>
	                	 </tr>
							</table>
						...
						<h:panelGroup rendered="#{semmco005tab1Bean.renderedAddHistory}">
								<a4j:commandButton id="btnAddContractStatusHistory" value="#{jspMsg['btn.add']}" styleClass="rich-button" 
				           		...
				           		disabled="#{semmco005tab1Bean.disabledBtnAddContractStatusHistory}">
				           		<a4j:actionparam name="navModule" value="co" />
								<a4j:actionparam name="navProgram" value="SEMMCO005TAB1" />
								<a4j:actionparam name="moduleWithNavi" value="co" />
								<a4j:actionparam name="actionWithNavi" value="SEMMCO005Tab1" />
								<a4j:actionparam name="methodWithNavi" value="doAddContractStatusHistory" />
				           		...
				           		disabled="#{semmco005tab1Bean.disabledBtnUpdateContractStatusHistory}">
				           		<a4j:actionparam name="navModule" value="co" />
								<a4j:actionparam name="navProgram" value="SEMMCO005TAB1" />
								<a4j:actionparam name="moduleWithNavi" value="co" />
								<a4j:actionparam name="actionWithNavi" value="SEMMCO005Tab1" />
				...
				<rich:spacer height="10"></rich:spacer>
				<rich:panel id="pnlBorrowOfficer" rendered="#{semmco005Bean.renderedDataTab1}">
						...
						<h:panelGrid width="90%"  border="0" cellpadding="0" cellspacing="1">
							...
							<tr>
	                			...
	                			<td>
	                			<h:selectOneMenu id="ddlRecipient" value="#{semmco005tab1Bean.contract.receivePersonCode}">
									<f:selectItems value="#{semmco005tab1Bean.borrowOfficerList}"/>
								</h:selectOneMenu>
			                	</td>
	                			...
	                			<td>
	                			<h:selectOneMenu id="ddlOrganizer" value="#{semmco005tab1Bean.contract.createPersonCode}">
									<f:selectItems value="#{semmco005tab1Bean.borrowOfficerList}"/>
								</h:selectOneMenu>
			                	</td>
		                	 </tr>
				...
				<rich:spacer height="10"></rich:spacer>
				<rich:panel id="pnlAddressContract" rendered="false">
						<f:facet name="header">
						...
						<h:panelGroup>
                			...
                			<td width="30%" colspan="3">
                			 <h:inputTextarea id="txtRightHouseNo" value="#{semmco005tab1Bean.siteInfo.rightHouseNo}" 
                			 rows="3" cols="100" />
		                	</td>
	                		</tr>
                			...
                			<td width="30%">
                			 <h:inputText id="txtRightBuilding" value="#{semmco005tab1Bean.siteInfo.rightBuilding}"  
                			...
                			<td width="30%">
                			<h:inputText id="txtRightStreet" value="#{semmco005tab1Bean.siteInfo.rightStreet}" 
                			size="30" maxlength="100"/>
		                	</td>
	                		</tr>
                			...
                			<td width="30%">
                			 <h:inputText id="txtRightFloor" value="#{semmco005tab1Bean.siteInfo.rightFloor}"  />
		                	</td>
		                	<td align="right" width="20%">
							<h:outputText value="#{jspMsg['label.rightTambon']}" styleClass="ms7"/>
                			</td>
                			<td width="30%">
                			<h:inputText id="txtRightTambon" value="#{semmco005tab1Bean.siteInfo.rightTambon}" 
                			...
                			<td width="30%">
                			 <h:inputText id="txtRightRoomNo" value="#{semmco005tab1Bean.siteInfo.rightRoomNo}"  
                			...
                			<td width="30%">
							 <h:inputText id="txtRightAmphur" value="#{semmco005tab1Bean.siteInfo.rightAmphur}" size="30"/>
		                	</td>
	                		</tr>
                			...
                			<td width="30%">
                			<h:inputText id="txtRightProvince" value="#{semmco005tab1Bean.siteInfo.rightProvince}" 
							  size="30"/>
		                	</td>
	                		</tr>
                			...
                			<td width="30%">
                			<h:inputText id="txtRightPostcode" value="#{semmco005tab1Bean.siteInfo.rightPostcode}"  
                			size="8" maxlength="5"/>
		                	</td>
	                		</tr>
							</table>
				...
				<!-- panel duty -->
				<rich:spacer height="10"></rich:spacer>
				<rich:panel id="pnlDuty" rendered="false">
						<f:facet name="header">
						...
						<h:panelGroup>
							...
							<h:graphicImage value="images/icon_required.gif" id="dutyRq" style="#{semmco005tab1Bean.contract.dutyPayStatus eq '00' ? 'display:none;':''}"/>
							<rich:spacer width="5"></rich:spacer>
							<h:outputText value="#{jspMsg['label.dutyAmt']}" styleClass="ms7"/>
                			</td>
                			<td width="20%">
                			 <h:inputText id="txtDutyAmt" value="#{semmco005tab1Bean.contract.dutyAmt}" 
       						 ...
       						 disabled="#{not semmco005tab1Bean.renderedEditDuty}"
       						 maxlength="16" 
                			...
                			<td width="20%">
	                			...
	                			<tr>
	                			<td>
	                			<h:inputText id="txtCopyDutyFlag" value="#{semmco005tab1Bean.contract.copyDuty}"  size="5" 
	                			disabled="#{not semmco005tab1Bean.renderedEditDuty}"/>
	                			</td>
	                			<td>
	                			...
	                			<td>
	                			<h:inputText id="txtCoppyDutyAmt" value="#{semmco005tab1Bean.contract.copyDutyAmt}" 
	       						 onkeypress="return numberformat.keyPressDecimalOnly(this, event);"
	       						 onblur="return numberformat.moneyFormat(this);"
	       						 onfocus="return numberformat.setCursorPosToEnd(this);"
	       						 disabled="#{not semmco005tab1Bean.renderedEditDuty}"
	                		...
	                		<tr>
							<td align="right" width="25%">
							<h:graphicImage value="images/icon_required.gif" id="dateRq" style="#{semmco005tab1Bean.contract.dutyPayStatus eq '00' ? 'display:none;':''}"/>
							<rich:spacer width="5"></rich:spacer>
							...
							datePattern="dd/MM/yyyy" 
							value="#{semmco005tab1Bean.contract.dutyPayDt}" 
							showWeeksBar="false" 
							inputSize="13"
							disabled="#{not semmco005tab1Bean.renderedEditDuty}"
							oninputkeypress="return numberformat.keyPressFormatDateOnly(this, event);"
                			...
                			<td width="20%"> 
                			<h:inputText id="txtOtherDutyAmt" value="#{semmco005tab1Bean.contract.otherDutyAmt}" 
       						 onkeypress="return numberformat.keyPressDecimalOnly(this, event);"
       						 onblur="return numberformat.moneyFormat(this);"
       						 onfocus="return numberformat.setCursorPosToEnd(this);"
       						 maxlength="16" 
                			...
                			<h:selectOneRadio id="rbtDutyPayStatus" value="#{semmco005tab1Bean.contract.dutyPayStatus}" disabled="#{not semmco005tab1Bean.renderedEditDuty}" styleClass="ms7" rendered="true" onclick="changeDutyPay(this.value);">
				...
				<!-- panel property tax -->
				<rich:spacer height="10"></rich:spacer>
				<rich:panel id="pnlContractLocation" rendered="false">
						<f:facet name="header">
						...
						<h:panelGroup>
							...
							<td width="30%">
							<h:inputText id="txtContractRoom" value="#{semmco005tab1Bean.contract.contractRoom}" size="23" maxlength="20"/>
		                	</td>
		                	<td width="20%" align="right">
							 <h:outputText value="#{jspMsg['label.contractShelf']}" styleClass="ms7"/>
		                	</td>
		                	<td width="30%">
							<h:inputText id="txtContractShelf" value="#{semmco005tab1Bean.contract.contractShelf}" size="23" maxlength="20"/>
		                	</td>
	                		</tr>
							</table>
						</h:panelGroup>
