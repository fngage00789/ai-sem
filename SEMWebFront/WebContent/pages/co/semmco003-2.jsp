			...
			<a4j:form id="popupFrmError">
				...
				<rich:panel id="pnlAddContractStatus">
							...
							<table width="100%">
								<tr>
			                		...
			                		<td valign="bottom" colspan="3">
			                			<h:selectOneMenu id="ddlCompany" value="#{semmco003Bean.borrowRequest.company}" 
			                				onchange="GetCompanyJSPopup();" 
			                				disabled="#{semmco003Bean.mode == 'VIEW' or semmco003Bean.mode == 'EDIT'}">
										...
										<h:outputText id="companyDisplayPopup" value="#{semmco003Bean.borrowRequest.company}" styleClass="ms28"/>
					                </td>
			                	 </tr>
								<tr>
									<td align="right" width="20%" valign="baseline">
			                		...
			                		<td width="30%" valign="bottom">
			                			<h:inputText label="#{jspMsg['label.docNo']}" id="txtContractNo"
			                				disabled="true" 
			                				value="#{semmco003Bean.borrowRequest.docNo}" />
					                </td>
			                		...
			                		<td width="30%">
		                				<rich:calendar id="cldReceiveDt" locale="th" enableManualInput="true"  
											...
											value="#{semmco003Bean.borrowRequest.receiveDt}" 
											showWeeksBar="false" 
											inputSize="13"
			                	 ...
			                	 <tr>
			                		...
			                		<td>
		                				<rich:calendar id="cldSamSendDt" locale="th" enableManualInput="true"  
											datePattern="dd/MM/yyyy" 
											value="#{semmco003Bean.borrowRequest.samSendDt}" 
											showWeeksBar="false" 
											inputSize="13"
											oninputkeypress="return numberformat.keyPressFormatDateOnly(this, event);"
											oninputkeyup="this.value = this.value.substring(0, 10);"
			                		...
			                		<td>
		                				<rich:calendar id="cldSamAssignSendDt" locale="th" enableManualInput="true"  
											datePattern="dd/MM/yyyy" 
											value="#{semmco003Bean.borrowRequest.samAssignSendDt}" 
											showWeeksBar="false" 
											inputSize="13"
											oninputkeypress="return numberformat.keyPressFormatDateOnly(this, event);"
											oninputkeyup="this.value = this.value.substring(0, 10);"
			                	 ...
			                	 <td align="right" width="20%">
			                		...
			                		<td colspan="3" valign="bottom">
			                			<h:inputText label="#{jspMsg['label.siteNum']}" id="txtSiteNum" 
			                				value="#{semmco003Bean.borrowRequest.siteNum}" 
			                				maxlength="6"
			                	 ...
			                	 <tr>
			                		...
			                		<td colspan="3">
		                				<h:inputTextarea id="txtContractNoAdd" cols="40" rows="3"
			                				value="#{semmco003Bean.contractAdd}" readonly="true"/>
			                			<rich:spacer width="3"></rich:spacer>
			                			<a4j:commandButton id="btnAdd" value="#{jspMsg['btn.add']}" styleClass="rich-button"
			                				disabled="#{semmco003Bean.borrowRequest.company == null or semmco003Bean.borrowRequest.company == '' or semmco003Bean.mode == 'VIEW'}"
			                	 ...
			                	 <tr>
		                			...
		                			<td colspan="3">
		                				<h:inputTextarea id="txtRemark" value="#{semmco003Bean.borrowRequest.remark}" 
		                					cols="40" rows="3" 
			                				disabled="#{semmco003Bean.mode == 'VIEW'}"/>
				                	</td>
			                	 </tr>
						...
						<a4j:commandButton id="btnSave" value="#{jspMsg['btn.save']}" styleClass="rich-button"
							...
							rendered="#{semmco003Bean.mode eq 'ADD'}"
							oncomplete="if(#{semmco003Bean.popupClose == 'true'})#{rich:component('popupAddBorrowContract')}.hide();">
							<a4j:actionparam name="navModule" value="co" />
							<a4j:actionparam name="navProgram" value="SEMMCO003-1" />
							<a4j:actionparam name="moduleWithNavi" value="co" />
							<a4j:actionparam name="actionWithNavi" value="SEMMCO003" />
						...
						<a4j:commandButton id="btnEdit" value="#{jspMsg['btn.save']}" styleClass="rich-button"
							action="#{navAction.navi}" reRender="dtbBorrowRequest,frmError,popupFrmError,pnlBorrowRequest"
							rendered="#{semmco003Bean.mode eq 'EDIT'}"
							oncomplete="if(#{semmco003Bean.popupClose == 'true'})#{rich:component('popupAddBorrowContract')}.hide();">
							<a4j:actionparam name="navModule" value="co" />
							<a4j:actionparam name="navProgram" value="SEMMCO003-1" />
							<a4j:actionparam name="moduleWithNavi" value="co" />
