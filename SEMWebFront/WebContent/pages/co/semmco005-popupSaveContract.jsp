	...
	<f:facet name="controls">
		...
		<h:panelGrid>
			<a4j:form id="popupFrmError">
				<rich:messages layout="list" errorClass="ms7red" warnClass="ms7blue" infoClass="ms7green" rendered="#{semmco005Bean.renderedMsgFormSearchPopup}">
				 		<f:facet name="header">
				...
				<rich:panel id="pnlAddContractStatus">
						...
						<h:panelGrid width="90%"  border="0" cellpadding="0" cellspacing="1">
							...
							<tr>
									...
									<h:selectOneMenu id="ddlContractStatus" value="#{semmco005Bean.contractStatus.contractStatus}"
									                 onchange="RenderDDLBorrowOfficer();">
										<f:selectItems value="#{semmco005Bean.contractStatusPopupList}"/>
									</h:selectOneMenu>
								...
								<td align="right" width="25%">
									...
									value="#{semmco005Bean.contractStatus.changeStatusDt}" 
									showWeeksBar="false" 
									inputSize="13"
			                	 ...
			                	 <tr>
		                			...
		                			<td width="75%" colspan="3">
		                			<h:inputTextarea id="txtRemark" value="#{semmco005Bean.contractStatus.remark}" 
		                			cols="70" rows="3"/>
				                	</td>
			                	 </tr>
			                	 <h:panelGroup id="pnlGp0022Recipient" rendered="#{semmco005Bean.contractStatus.contractStatus eq '01'}">
			                	 <tr>
									<td align="right" width="25%" valign="top">
									<h:outputText value="ผู้รับ :" styleClass="ms7"/>
		                			</td>
		                			<td width="75%" colspan="3">
		                			<h:selectOneMenu id="ddlRecipient" value="#{semmco005Bean.contract.receivePersonCode}">
										<f:selectItems value="#{semmco005Bean.borrowOfficerList}"/>
									</h:selectOneMenu>
				                	</td>
			                	 </tr>
			                	 </h:panelGroup>
			                	 <h:panelGroup id="pnlGp0022Organizer" rendered="#{semmco005Bean.contractStatus.contractStatus eq '01'}">
			                	 <tr>
									<td align="right" width="25%" valign="top">
									<h:outputText value="ผู้จัดทำ :" styleClass="ms7"/>
		                			</td>
		                			<td width="75%" colspan="3">
		                			<h:selectOneMenu id="ddlOrganizer" value="#{semmco005Bean.contract.createPersonCode}">
										<f:selectItems value="#{semmco005Bean.borrowOfficerList}"/>
									</h:selectOneMenu>
				                	</td>
			                	 </tr>
						...
						rendered="#{semmco005Bean.renderedAddHistory}"
						oncomplete="if(#{semmco005Bean.popupClose == 'true'})#{rich:component('popupAddContractStatus')}.hide();">
						...
						<a4j:commandButton value="Cancel" styleClass="rich-button" immediate="true" rendered="#{semmco005Bean.renderedAddHistory}">
