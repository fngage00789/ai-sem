		...
		<a4j:form id="popupFrmEditContractStatus"> 
				<rich:panel id="pnlContractStatusHistory">
						...
						<rich:dataTable width="97%" id="dtbContractStatusHistory" cellpadding="1" cellspacing="0" border="0"
							var="contractStatusHistorySP" value="#{semmco006Bean.contractStatusHistoryList}" reRender="dtbContractStatusHistory" 
							rows="10" rowClasses="cur"	 styleClass="dataTable">
							<a4j:support event="onRowClick"   action="#{semmco006Action.getRowIdOnClick}" reRender="dtbContractStatusHistory">
								<a4j:actionparam name="rowId" value="#{contractStatusHistorySP.rowId}" />
							</a4j:support>
							<rich:column styleClass="#{(semmco006Bean.tmpRowId==contractStatusHistorySP.rowId)?'onClick':'unClick'}">
								<f:facet name="header" >
								...
								<div align="center">
	            					...
	            					rendered="#{contractStatusHistorySP.lastRecord and semmco006Bean.renderedUpdateHistory}">
							...
							<rich:column styleClass="#{(semmco006Bean.tmpRowId==contractStatusHistorySP.rowId)?'onClick':'unClick'}">
								...
								<div align="center">
	            					<a4j:commandButton id="btnDeleteHistory" oncomplete="#{rich:component('mdpConfirmDelDialogContractStatusHistory')}.show(); return false" 
     									   ...
     									   rendered="#{contractStatusHistorySP.lastRecord and semmco006Bean.renderedDeleteHistory}">
										<a4j:actionparam name="navModule" value="co" />
		            					<a4j:actionparam name="navProgram" value="SEMMCO006-3" />	
										<a4j:actionparam name="moduleWithNavi" value="co" />
										<a4j:actionparam name="actionWithNavi" value="SEMMCO006" />
							...
							<rich:column  sortBy="#{contractStatusHistorySP.contractStatusName}" styleClass="#{(semmco006Bean.tmpRowId==contractStatusHistorySP.rowId)?'onClick':'unClick'}">
								<f:facet name="header">
							...
							<rich:column width="5%" sortBy="#{contractStatusHistorySP.changeStatusDate}" styleClass="#{(semmco006Bean.tmpRowId==contractStatusHistorySP.rowId)?'onClick':'unClick'}">
								<f:facet name="header">
							...
							<rich:column  sortBy="#{contractStatusHistorySP.remark}" styleClass="#{(semmco006Bean.tmpRowId==contractStatusHistorySP.rowId)?'onClick':'unClick'}">
								<f:facet name="header">
							...
							<rich:column  sortBy="#{contractStatusHistorySP.updateBy}" styleClass="#{(semmco006Bean.tmpRowId==contractStatusHistorySP.rowId)?'onClick':'unClick'}">
								<f:facet name="header">
								...
								<rich:columnGroup>
									<rich:column colspan="2">
										<h:outputFormat value="#{msg['message.totalRecords']}">
											<f:param value="#{fn:length(semmco006Bean.contractStatusHistoryList)}"></f:param>
										</h:outputFormat>
									</rich:column>
				...
				<rich:panel id="pnlEditContractStatus">
						...
						<div align="left">
							<rich:messages layout="list" errorClass="ms7red" warnClass="ms7blue" infoClass="ms7green" rendered="#{semmco006Bean.renderedMsgFormMiddle}"/>
						</div>
						<h:panelGrid width="90%"  border="0" cellpadding="0" cellspacing="1">
							...
							<h:selectOneMenu id="ddlContractStatus2" value="#{semmco006Bean.contractStatus.contractStatus}"
							...
							<a4j:jsFunction name="RenderDDLBorrowOfficer" reRender="pnlEditContractStatus"/>
								...
								<td align="right" width="25%">
			                	 ...
			                	 <tr>
		                			...
		                			<td width="75%" colspan="3">
		                			<h:inputTextarea id="txtRemark2" value="#{semmco006Bean.contractStatus.remark}" 
		                			cols="100" rows="3"/>
				                	</td>
			                	 </tr>
			                	 
			                	  <h:panelGroup id="pnlGp0023Recipient" rendered="#{semmco006Bean.contractStatus.contractStatus eq '01'}">
			                	 <tr>
									<td align="right" width="25%" valign="top">
			                	 ...
			                	 <h:panelGroup id="pnlGp0023Organizer" rendered="#{semmco006Bean.contractStatus.contractStatus eq '01'}">
			                	 <tr>
									<td align="right" width="25%" valign="top">
						...
						<h:panelGroup rendered="#{semmco006Bean.renderedAddHistory}">
								<a4j:commandButton id="btnAddContractStatusHistory" value="#{jspMsg['btn.add']}" styleClass="rich-button" 
				           		...
				           		disabled="#{semmco006Bean.disabledBtnAddContractStatusHistory}">
				           		<a4j:actionparam name="navModule" value="co" />
								<a4j:actionparam name="navProgram" value="SEMMCO006-3" />
								<a4j:actionparam name="moduleWithNavi" value="co" />
								<a4j:actionparam name="actionWithNavi" value="SEMMCO006" />
								<a4j:actionparam name="methodWithNavi" value="doAddContractStatusHistory" />
				           		...
				           		action="#{navAction.navi}" reRender="pnlContractStatusHistory,pnlEditContractStatus,pnlEditContractStatus,pnlSearchResult,dtbContractStatus" 
				           		disabled="#{semmco006Bean.disabledBtnUpdateContractStatusHistory}">
				           		<a4j:actionparam name="navModule" value="co" />
								<a4j:actionparam name="navProgram" value="SEMMCO006-3" />
								<a4j:actionparam name="moduleWithNavi" value="co" />
								<a4j:actionparam name="actionWithNavi" value="SEMMCO006" />
