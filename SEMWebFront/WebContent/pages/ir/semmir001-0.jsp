		...
		<rich:panel id="panelWrapper_tree" style="height:100%; border:1 ececec solid; top:0px; vertical-align:top;">
           ...
           <rich:panel id="pnlSearchCriteria">
                        ...
                        <h:panelGrid width="95%"  border="0" cellpadding="0" cellspacing="1">
                            ...
                            <tr>
                                    ...
                                    <td width="15%" valign="bottom">
                                        <h:selectOneMenu id="ddlCompany" value="#{semmir001Bean.treeUtilBean.company}">
                                    ...
                                    <td width="15%" valign="bottom">
                                    <h:selectOneMenu id="ddlRegion" value="#{semmir001Bean.treeUtilBean.region}"> 
                                        <f:selectItems value="#{semmir001Bean.regionList}"/>
                                    </h:selectOneMenu>
                                    </td>
                                    ...
                                    <td width="10%" valign="bottom">
                                        <h:selectOneMenu id="ddlType" value="#{semmir001Bean.treeUtilBean.menuSubGroup}"> 
			...
			<rich:panel style="border:1 e0e0e0 solid; height:100%; vertical-align:top;">
				<!-- >> header left content -->
					<f:facet name="header">
							<h:outputText value="Insurance [TO DO LIST]" />
					</f:facet>
				<!-- << header left content -->
				<div style="width:280px;">
					...
					<!-- >> Macro -->
						<rich:simpleTogglePanel id="semmir001_pnlSubMacro"  switchType="client" label="#{semmir001Bean.headerTreeMacro}" 
					        opened="true" style="width:100%;margin:0 auto; padding:0px;"
					        rendered="#{semmir001Bean.treeMacroFlag}">
								<h:dataTable id="semmir001_macro" border="0"
									var="obj" value="#{semmir001Bean.menuTreeMacroList}" 
										...
										<div align="left" onmouseover="this.style.backgroundColor='#FFE4E1'" onmouseout="this.style.backgroundColor='transparent'">									
											<span style="width:195px; white-space:nowrap;">  
										          ...
										          reRender="oppContent,txtNavProgram,panelWrapper_tree,panelWrapper_content" >
			                                        ...
			                                        <a4j:actionparam name="methodWithNavi" value="doInitialForSearchInsurance" />
							...
							<!-- Pico -->
							<rich:simpleTogglePanel id="semmir001_pnlSubPico"  switchType="client" label="#{semmir001Bean.headerTreePico}" 
					        opened="true" style="width:100%;margin:0 auto; padding:0px;"
					        rendered="#{semmir001Bean.treePicoFlag}">
								<h:dataTable id="semmir001_pico" border="0"
									var="obj" value="#{semmir001Bean.menuTreePicoList}" 
