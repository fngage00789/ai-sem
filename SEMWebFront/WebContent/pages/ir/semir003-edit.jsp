		...
		<rich:panel>
			 	<table width="100%" border="0" cellspacing="0" cellpadding="0" >
				  	<h:panelGrid columns="2">
						    ...
						    <h:inputText id="txtCompany" value="#{semir003Bean.editReplacement.company}" readonly="true" />
						    <h:panelGroup>
				  				<div align="right">
									<h:outputText value="ประเภท :" styleClass="ms7"/>		
								</div>
							</h:panelGroup>	
							<h:inputText id="txtType" value="#{semir003Bean.editReplacement.networkType}" readonly="true"/>
							<h:panelGroup>
				  				<div align="right">
									<h:outputText value="Transfer Type :" styleClass="ms7"/>	
								</div>
							</h:panelGroup>			
							<h:inputText id="txtTfType" value="#{semir003Bean.editReplacement.transferType}" readonly="true"/>
							<h:panelGroup>
				  				<div align="right">
									<h:outputText value="%Replacement :" styleClass="ms7"/>
								</div>
							</h:panelGroup>
							<h:inputText id="txtREPL_VAL" value="#{semir003Bean.editReplacement.replRate}"/>
							<h:panelGroup>
				  				<div align="right">
									<h:outputText value="Effective Date :" styleClass="ms7"/>
								</div>
							</h:panelGroup>	
							<rich:calendar id="date"  datePattern="dd/MM/yyyy" value="#{semir003Bean.editReplacement.effDt}"/> 
					</h:panelGrid>	
