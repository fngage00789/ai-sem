        ...
        <rich:panel id="panelWrapper_tree" style="height:100%; border:1 ececec solid; top:0px; vertical-align:top;">
           ...
           <rich:panel id="pnlSearchCriteria">
                        ...
                        <h:panelGrid width="95%"  border="0" cellpadding="0" cellspacing="1">
                            ...
                            <tr>
                                    ...
                                    <td width="15%" valign="bottom">
                                        <h:selectOneMenu id="ddlCompany" value="#{semmrt007Bean.treeUtilBean.company}">
                                    ...
                                    <td width="15%" valign="bottom">
                                    <h:selectOneMenu id="ddlRegion" value="#{semmrt007Bean.treeUtilBean.region}"> 
                                    ...
                                    <td width="10%" valign="bottom">
                                        <h:selectOneMenu id="ddlType" value="#{semmrt007Bean.treeUtilBean.menuSubGroup}"> 
            ...
            <rich:panel style="border:1 e0e0e0 solid; height:100%; vertical-align:top;">
                <!-- >> header left content -->
                    <f:facet name="header">
                            <h:outputText value="Clear Receipt [TO DO LIST]" />
                    </f:facet>
                <!-- << header left content -->
                <div style="width:280px;">
                    ...
                    <!-- >> Macro -->
						<rich:simpleTogglePanel id="semmrt007_pnlSubMacro"  switchType="client" label="#{semmrt007Bean.headerTreeMacro}" 
					        opened="true" style="width:100%;margin:0 auto; padding:0px;"
					        rendered="#{semmrt007Bean.treeMacroFlag}">
								<h:dataTable id="semmrt007_macro" border="0"
									var="obj" value="#{semmrt007Bean.menuTreeMacroList}" 
							...
							<!-- Pico -->
							<rich:simpleTogglePanel id="semmrt007_pnlSubPico"  switchType="client" label="#{semmrt007Bean.headerTreePico}" 
					        opened="true" style="width:100%;margin:0 auto; padding:0px;"
					        rendered="#{semmrt007Bean.treePicoFlag}">
								<h:dataTable id="semmrt007_pico" border="0"
									var="obj" value="#{semmrt007Bean.menuTreePicoList}" 
