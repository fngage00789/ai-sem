        ...
        <rich:panel id="panelWrapper_tree" style="height:100%; border:1 ececec solid; top:0px; vertical-align:top;">
           ...
           <rich:panel id="pnlSearchCriteria">
                        ...
                        <h:panelGrid width="95%"  border="0" cellpadding="0" cellspacing="1">
                            ...
                            <tr>
                                    ...
                                    <td width="15%" valign="bottom">
                                        <h:selectOneMenu id="ddlCompany" value="#{semmrt006Bean.treeUtilBean.company}">
                                    ...
                                    <td width="15%" valign="bottom">
                                    <h:selectOneMenu id="ddlRegion" value="#{semmrt006Bean.treeUtilBean.region}"> 
                                    ...
                                    <td width="10%" valign="bottom">
                                        <h:selectOneMenu id="ddlType" value="#{semmrt006Bean.treeUtilBean.menuSubGroup}"> 
            ...
            <rich:panel style="border:1 e0e0e0 solid; height:100%; vertical-align:top;">
                <!-- >> header left content -->
                    <f:facet name="header">
                            <h:outputText value="Return Deposit [TO DO LIST]" />
                    </f:facet>
                <!-- << header left content -->
                <div style="width:280px;">
                    ...
                    <!-- >> Macro -->
						<rich:simpleTogglePanel id="semmrt006_pnlSubMacro"  switchType="client" label="#{semmrt006Bean.headerTreeMacro}" 
					        opened="true" style="width:100%;margin:0 auto; padding:0px;"
					        rendered="#{semmrt006Bean.treeMacroFlag}">
								<h:dataTable id="semmrt006_macro" border="0"
									var="obj" value="#{semmrt006Bean.menuTreeMacroList}" 
							...
							<!-- Pico -->
							<rich:simpleTogglePanel id="semmrt006_pnlSubPico"  switchType="client" label="#{semmrt006Bean.headerTreePico}" 
					        opened="true" style="width:100%;margin:0 auto; padding:0px;"
					        rendered="#{semmrt006Bean.treePicoFlag}">
								<h:dataTable id="semmrt006_pico" border="0"
									var="obj" value="#{semmrt006Bean.menuTreePicoList}" 
