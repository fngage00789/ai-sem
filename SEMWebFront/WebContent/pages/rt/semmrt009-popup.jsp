            ...
            <h:panelGrid width="90%" columns="5" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                    ...
                                    <td width="25%">
                                        ...
                                        </h:selectOneMenu><h:outputText value="#{semmrt003Bean.rentalPayNormalSearchDSP.expenseType}"></h:outputText>
                                        <a4j:jsFunction name="onChangeExpenseType" action="#{semmrt009Action.onChangeExpenseType}" reRender="pnlEditRentalPayNormal"/>
                                    </td>
                                 </tr>
                                 ...
                                 <tr>
                                    ...
                                    <h:selectOneMenu id="ddlDayPerYear" value="#{semmrt003Bean.rentalPayNormalSearchDSP.calYear}" >
                                            <a4j:support event="onchange" reRender="txtDueAmt,txtExcAmt,txtVatAmt,txtIncAmt,txtWhtAmt,txtTotalAmtEdit,ddlDayPerMonth" action="#{semmrt009Action.onrenderAmountVat}">
                                    ...
                                    <h:selectOneMenu id="ddlDayPerMonth" value="#{semmrt003Bean.rentalPayNormalSearchDSP.calMonth}" >
                                            <a4j:support event="onchange" reRender="txtDueAmt,txtExcAmt,txtVatAmt,txtIncAmt,txtWhtAmt,txtTotalAmtEdit,ddlDayPerYear" action="#{semmrt009Action.onrenderAmountVat}">
                                 ...
                                 <tr>
                                    ...
                                    <a4j:jsFunction name="onChangeVat" action="#{semmrt009Action.onChangeVatType}" reRender="pnlEditRentalPayNormal">
                                    </a4j:jsFunction>
                                    </td>
                                 </tr>
                                 <tr>
                                    ...
                                    <td width="25%">
                                        ...
                                        <a4j:jsFunction name="onChangeWht" action="#{semmrt009Action.changeWhtType}" reRender="pnlEditRentalPayNormal">
                                        </a4j:jsFunction>
                                        </td>
                                 </tr>
                                 <tr>
                                    ...
                                    <h:selectBooleanCheckbox id="discountCheckBox" value="#{semmrt003Bean.rentalPayNormalSearchDSP.discountFlg}" >
                                            <a4j:support event="onclick" action="#{semmrt009Action.renderDiscountCheckBox}" reRender="ddlVatBefore,ddlWhtBefore,txtDiscountRate,txtDiscountAmt"/>
                                 ...
                                 <tr>
                                            ...
                                            <tr>
                                                <td width="100">
                                                    <h:inputText id="txtDiscountRate" value="#{semmrt003Bean.rentalPayNormalSearchDSP.discountRate}"
                                                     ...
                                                     disabled="#{!semmrt003Bean.rentalPayNormalSearchDSP.discountFlg}">
                                                        <a4j:support event="onchange" reRender="txtDueAmt,txtExcAmt,txtVatAmt,txtIncAmt,txtWhtAmt,txtTotalAmtEdit,txtDiscountAmt" action="#{semmrt009Action.calDiscountPercent}"/>
                                                    </h:inputText>
                                                ...
                                                <td align="left">
                                                    <h:inputText id="txtDiscountAmt" value="#{semmrt003Bean.rentalPayNormalSearchDSP.discountAmt}"
                                                     ...
                                                     size="10"
                                                     disabled="#{!semmrt003Bean.rentalPayNormalSearchDSP.discountFlg}">
                                                        <a4j:support event="onchange" reRender="txtDueAmt,txtExcAmt,txtVatAmt,txtIncAmt,txtWhtAmt,txtTotalAmtEdit,txtDiscountAmt,txtDiscountRate" action="#{semmrt009Action.calDiscountAmt}"/>
                                                        <f:convertNumber integerOnly="false" maxFractionDigits="2" 
                                                        pattern="#,##0.00"/>
                                                    </h:inputText>
                                    ...
                                    <td>
                                        <h:selectBooleanCheckbox id="fineCheckBox" value="#{semmrt003Bean.rentalPayNormalSearchDSP.fineFlg}" disabled="true" >
                                            <a4j:support event="onclick" action="#{semmrt009Action.onCheckFineExtraFlag}" reRender="txtLimitLost,txtWhtRate,btnPopupEdtDelete,extraCheckBox,pnlEditRentalPayNormal">
                                        ...
                                        <h:selectBooleanCheckbox id="extraCheckBox" value="#{semmrt003Bean.rentalPayNormalSearchDSP.extraFlg}" disabled="true" >
                                            <a4j:support event="onclick" action="#{semmrt009Action.onCheckFineExtraFlag}" reRender="btnPopupEdtDelete,pnlEditRentalPayNormal,fineCheckBox">
                                 ...
                                 <tr>
                                    ...
                                    <h:inputText id="txtExcAmt" value="#{semmrt003Bean.rentalPayNormalSearchDSP.excAmt}"
                                     ...
                                     styleClass="inputRight"
                                     >
                                        <a4j:support event="onchange" action="#{semmrt009Action.onRenderIncludeAmt}" reRender="txtIncAmt,txtExcAmt,txtTotalAmtEdit,txtVatAmt,txtWhtAmt">
                                    ...
                                    <td width="25%">
                                        <h:inputText id="txtVatAmt" value="#{semmrt003Bean.rentalPayNormalSearchDSP.vatAmt}" size="18"
                                         ...
                                         styleClass="inputRight"
                                         disabled="#{semmrt003Bean.hasCheckExtraFine}">
                                            <a4j:support event="onchange" action="#{semmrt009Action.onRenderIncludeAmt}" reRender="txtIncAmt,txtExcAmt,txtTotalAmtEdit"></a4j:support>
                                            <f:convertNumber integerOnly="false" maxFractionDigits="2" 
                                            pattern="#,##0.00"/>
                                        </h:inputText>
                                 ...
                                 <tr>
                                    ...
                                    <td align="right" width="25%">
                                        ...
                                        <h:inputText id="txtWhtRate" value="#{semmrt003Bean.rentalPayNormalSearchDSP.whtRate}" size="3" 
                                         ...
                                         maxlength="4" 
                                         >
                                            <a4j:support event="onchange" action="#{semmrt009Action.onRenderWhtAmt}" reRender="txtTotalAmtEdit,txtWhtAmt,txtWhtRate"></a4j:support>
                                            <f:convertNumber integerOnly="false" maxFractionDigits="2" 
                                            pattern="#,##0.00"/>
                                        </h:inputText>
                                        <h:outputText value="#{jspMsg['label.vatRate2']}" styleClass="ms7"/>
                                    ...
                                    <td width="25%">
                                        ...
                                        <h:inputText id="txtWhtAmt" value="#{semmrt003Bean.rentalPayNormalSearchDSP.whtAmt}" size="18"
                                         ...
                                         maxlength="16" 
                                         styleClass="inputRight">
                                            <a4j:support event="onchange" action="#{semmrt009Action.onRenderTotalAmt}" reRender="txtTotalAmtEdit,txtWhtAmt"></a4j:support>
                                            <f:convertNumber integerOnly="false" maxFractionDigits="2" 
                                                pattern="#,##0.00"/>
                                        </h:inputText>
                                    </td>
                            ...
                            <table width="100%" border="0">
                                    ...
                                    <td width="25%" valign="top">
                                        <h:selectOneRadio id="rbtCtWhtType" styleClass="ms7" layout="pageDirection" 
                                            ...
                                            <a4j:jsFunction name="changeCtDefaultWht" 
                                                            ...
                                                            action="#{semmrt009Action.setChangeWht}">
                                            </a4j:jsFunction>
                                    ...
                                    <table width="100%">
                                        ...
                                        <h:selectOneRadio id="rbtCtVatType" styleClass="ms7" 
                                            ...
                                            <a4j:jsFunction name="changeDefaultVat" 
                                                            ...
                                                            action="#{semmrt009Action.setChangeVat}">
                                            </a4j:jsFunction>
                                    ...
                                    <td width="75%" colspan="3">
                                        ...
                                        <h:panelGroup >
                                            <a4j:commandButton id="btnCtCalculate" value="Calculate" styleClass="rich-button"
                                                action="#{semmrt009Action.doCalculateCreate}" 
                                ...
                                <tr>
                                    ...
                                    <h:inputText id="txtCtExcAmt" value="#{semmrt003Bean.rentalPayNormalSearchDSP.excAmt}" size="18"
                                         ...
                                         maxlength="16" 
                                         styleClass="inputRight" >
                                        <a4j:support event="onchange" action="#{semmrt009Action.onRenderIncludeAmtCreate}" reRender="txtCtIncAmt,txtCtExcAmt,txtCtTotalAmt,txtCtVatAmt,txtCtWhtAmt">
                                            <f:param name="excAmtFlag" value="Y"></f:param>
                                        </a4j:support>
                                        <f:convertNumber integerOnly="false"  maxFractionDigits="2" 
                                            pattern="#,##0.00"/>
                                    ...
                                    <td width="25%">
                                        <h:inputText id="txtCtVatAmt" value="#{semmrt003Bean.rentalPayNormalSearchDSP.vatAmt}" size="18"
                                         ...
                                         styleClass="inputRight"
                                         disabled="false">
                                            <a4j:support event="onchange" action="#{semmrt009Action.onRenderIncludeAmtCreate}" reRender="txtCtIncAmt,txtCtExcAmt,txtCtTotalAmt"></a4j:support>
                                            <f:convertNumber integerOnly="false" maxFractionDigits="2" 
                                            pattern="#,##0.00"/>
                                        </h:inputText>
                                    </td>
                                 ...
                                 <tr>
                                    ...
                                    <h:inputText id="txtCtIncAmt" value="#{semmrt003Bean.rentalPayNormalSearchDSP.incAmt}" size="18"
                                     ...
                                     styleClass="inputRight"
                                     disabled="false">
                                     <a4j:support event="onchange" action="#{semmrt009Action.onRenderWhtInclude}" reRender="txtCtExcAmt,txtCtIncAmt,txtCtTotalAmt,txtCtWhtAmt"></a4j:support>
                                        <f:convertNumber integerOnly="false" maxFractionDigits="2" 
                                            pattern="#,##0.00"/>
                                    </h:inputText>
                                    ...
                                    <td width="25%">
                                        <h:inputText id="txtCtWhtAmt" value="#{semmrt003Bean.rentalPayNormalSearchDSP.whtAmt}" size="18"
                                         ...
                                         >
                                            <a4j:support event="onchange" action="#{semmrt009Action.onRenderTotalAmtCreate}" reRender="txtCtTotalAmt,txtCtWhtAmt"></a4j:support>
                                            <f:convertNumber integerOnly="false" maxFractionDigits="2" 
                                                pattern="#,##0.00"/>
                                        </h:inputText>
                                    </td>
                            ...
                            <tr>
                                 ...
                                 <tr>
                                    ...
                                    <a4j:commandButton value="Cancel" styleClass="rich-button" immediate="true" action="#{navAction.navi}"
                                     reRender="frmErrorPopupApproveSave,dtbRentalPayNormalSrch,frmError,mrt009_btnApprove,mrt009_btnReject">
                                        <a4j:actionparam name="navModule" value="rt" />
                                        <a4j:actionparam name="navProgram" value="SEMMRT009-1" />
                                        <a4j:actionparam name="moduleWithNavi" value="rt" />
                                        <a4j:actionparam name="actionWithNavi" value="SEMMRT009" />
