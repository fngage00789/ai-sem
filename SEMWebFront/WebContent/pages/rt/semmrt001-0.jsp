		...
		<rich:panel id="panelWrapper_tree" style="height:100%; border:1 ececec solid; top:0px; vertical-align:top;">
           ...
           <rich:panel id="pnlSearchCriteria">
                        ...
                        <h:panelGrid width="95%"  border="0" cellpadding="0" cellspacing="1">
                            ...
                            <tr>
                                    ...
                                    <td width="15%" valign="bottom">
                                        <h:selectOneMenu id="ddlCompany" value="#{semmrt001Bean.treeUtilBean.company}">
                                    ...
                                    <td width="15%" valign="bottom">
                                    <h:selectOneMenu id="ddlRegion" value="#{semmrt001Bean.treeUtilBean.region}"> 
                                        <f:selectItems value="#{semmrt001Bean.regionList}"/>
                                    </h:selectOneMenu>
                                    </td>
                                    ...
                                    <td width="10%" valign="bottom">
                                        <h:selectOneMenu id="ddlType" value="#{semmrt001Bean.treeUtilBean.menuSubGroup}"> 
			...
			<rich:panel style="border:1 e0e0e0 solid; height:100%; vertical-align:top;">
				<!-- >> header left content -->
					<f:facet name="header">
							<h:outputText value="Rental [TO DO LIST]" />
					</f:facet>
				<!-- << header left content -->
				<div style="width:280px;">
					...
					<!-- >> Macro -->
						<rich:simpleTogglePanel id="semmrt001_pnlSubMacro"  switchType="client" label="#{semmrt001Bean.headerTreeMacro}" 
					        opened="true" style="width:100%;margin:0 auto; padding:0px;"
					        rendered="#{semmrt001Bean.treeMacroFlag}">
								<h:dataTable id="semmrt001_macro" border="0"
									var="obj" value="#{semmrt001Bean.menuTreeMacroList}" 
										...
										<div align="left" onmouseover="this.style.backgroundColor='#FFE4E1'" onmouseout="this.style.backgroundColor='transparent'">									
											<span style="width:195px; white-space:nowrap;">  
										          ...
										          reRender="oppContent,txtNavProgram,panelWrapper_tree,panelWrapper_content" >
			                                        ...
			                                        <a4j:actionparam name="methodWithNavi" value="doInitialForSearchRental" />
							...
							<!-- Pico -->
							<rich:simpleTogglePanel id="semmrt001_pnlSubPico"  switchType="client" label="#{semmrt001Bean.headerTreePico}" 
					        opened="true" style="width:100%;margin:0 auto; padding:0px;"
					        rendered="#{semmrt001Bean.treePicoFlag}">
								<h:dataTable id="semmrt001_pico" border="0"
									var="obj" value="#{semmrt001Bean.menuTreePicoList}" 
							...
							<!-- Exchange -->
							<rich:simpleTogglePanel id="semmrt001_pnlSubExc"  switchType="client" label="#{semmrt001Bean.headerTreeExc}" 
					        opened="true" style="width:100%;margin:0 auto; padding:0px;"
					        rendered="#{semmrt001Bean.treeExcFlag}">
								<h:dataTable id="semmrt001_Exc" border="0"
									var="obj" value="#{semmrt001Bean.menuTreeExcList}" 
