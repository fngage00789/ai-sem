...
<%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
	...
	<!-- >> wrapper panel -->
		...
		<rich:panel id="panelWrapper001-5" style="border:1 e0e0e0 solid; height:100%;" rendered="#{semmsa001Bean.panelDisplay == 'semmsa07'}">
				<!-- >> header content 2 -->
					<f:facet name="header">
						<h:outputText value="#{jspMsg['label.th_waitingForLegalApprove']} [semmsa001-5]"/>
					</f:facet>
				<!-- << header content 2 -->
				...
				<rich:panel id="tabResult_001-2" styleClass="sem_autoScrollbarInTodoSA">
					<a4j:form id="frmSearchResult_001-5">
					<a4j:region>
						<rich:dataTable style="width:100%;" id="dataTabLeadAssign_001-5" cellpadding="1" cellspacing="0" border="0" 
						var="waitingApprLst"  value="#{semmsa001Bean.siteAppList}" reRender="dataTabLeadAssign_001-5, dataScrllLeadAssign_001-5" 
						rows="#{semmsa001Bean.rowPerPage}" rowClasses="cur" styleClass="dataTable">
		                    ...
		                    <rich:column style="text-align:center;" rendered="true">
		                    	<f:facet name="header">
			                    	<h:selectBooleanCheckbox value="#{semmsa001Bean.chkSelAll}" style="width:20px;" rendered="false">
										...
										reRender="dataTabLeadAssign_001-5">
											<a4j:actionparam name="paramPage" value="msa001-5" />
	                        	...
	                        	<h:selectBooleanCheckbox id="chkSelect" value="#{waitingApprLst.checkBox}">
									...
									reRender="dataTabLeadAssign_001-5,msa001-5_btnExportExcel">
										<a4j:actionparam name="paramObjectType" value="siteAppr" />
									</a4j:support>
								</h:selectBooleanCheckbox>
		                    </rich:column>
		                    ...
		                    filterBy="#{waitingApprLst.dataObj.docStatus}"  rendered="false">
		                    	<f:facet name="header">
		                    ...
		                    filterBy="#{waitingApprLst.dataObj.nearSiteCost}" filterEvent="onkeyup">
		                        ...
		                        <a4j:commandLink id="msa001-5_popNearestSite" action="#{semmsa001Action.doShowPopupNearestSite}" value="#{waitingApprLst.dataObj.nearSiteCost}" 
		                    ...
		                    <rich:column id="msa001-5_remarkRisk" style="text-align:center;" sortBy="#{mngApprDtLst.dataObj.remarkRisk}" headerClass="headerFilterWidth"
							...
							<f:facet name="footer">
								<rich:columnGroup>
									...
									<rich:column colspan="21">
										<rich:datascroller immediate="true" rendered="true" align="left" for="dataTabLeadAssign_001-5"
											maxPages="#{semmsa001Bean.rowPerPage}"  selectedStyleClass="selectScroll"
											stepControls="hide" fastControls="auto" boundaryControls="auto" 
											id="dataScrllLeadAssign_001-5" style="background-color: #cccccc;"
											page="#{semmsa001Bean.scrollerPage}">
										<a4j:support event="onclick"  reRender="frmSearchResult_001-5"></a4j:support>
										</rich:datascroller>
									</rich:column>
								</rich:columnGroup>
							</f:facet>
				...
				<!-- << button export -->
					...
					<a4j:form id="msa001-4tab0_frmButton">
						<table style="width:98%; text-align:left;">
							<tr>
								<td>
									<h:commandButton id="msa001-5_btnExportExcel" value="#{jspMsg['label.exportExcel']}" 
									styleClass="rich-button" action="#{semmsa001Action.doLegalExportExcel}"
