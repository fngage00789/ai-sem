...
<!-- =================================================================================== -->
	...
	<!-- >> [POPUP_01] -->
	<!-- popupModalRetStatus -->
	<rich:modalPanel id="tab6_panel_popupModalRetStatus" width="1000" autosized="true">	
		<f:facet name="header">
			<h:panelGroup>
				<h:outputText value="#{jspMsg['label.th_edit_history']}#{jspMsg['label.th_info']} (#{jspMsg['label.th_propTax']})"></h:outputText>
			</h:panelGroup>
		</f:facet>
		<f:facet name="controls">
			<h:panelGroup>
				<div align="left">
				    <h:graphicImage value="images/ico_close.png" id="hide-tab6_panel_popupModalRetStatus" style="cursor:pointer" />
					<rich:componentControl for="tab6_panel_popupModalRetStatus" attachTo="hide-tab6_panel_popupModalRetStatus" operation="hide" event="onclick"  />
				</div>
			</h:panelGroup>
		</f:facet>
		
		<!-- h:form id="tab6_frmTest" -->
		<h:panelGrid width="100%" id="popupDisplay6">
        <h:panelGroup >
        ...
        <!-- h:form id="tab2_frmTest" -->
							...
							<table style="width:100%; background-color:cada30; border:2px solid e0e0e0;">
								<tr>
									<td style="width:25%; text-align:center;">
									   <h:selectBooleanCheckbox id="siteInfoPropertyTax" value="#{item_.checkBox}" 
                                        rendered="#{semmsa002Bean.chkCopySiteInfo}">
                                            <a4j:support event="onclick" action="#{semmsi004Action.onSelected}" 
                                            reRender="popupDisplay6,siteInfoPropertyTax, siteInfoHistorySelected, btnCopy">
							...
							<table style="width:100%; border:0px solid e0e0e0;">
								<tr>
									<td valign="bottom" style="width:20%; text-align:right;">
										<h:outputText value="#{jspMsg['label.th_payment_owner']}#{jspMsg['label.th_tax']}#{jspMsg['label.th_property']} : " style="" styleClass="ms7" />
									</td>
									<td valign="top" style="width:80%; text-align:left;">
										<h:outputText value="#{item_.dataObj.payBy}" style="" styleClass="#{item_.dataObj.payByBG}" />
									</td>
								</tr>
								<tr>
									<td valign="bottom" style="width:20%; text-align:right;">
									...
									<td valign="top" style="width:80%; text-align:left;">
										<h:outputText value="#{item_.dataObj.ptRemark}" style="" styleClass="#{item_.dataObj.ptRemarkBG}" />
									</td>
								</tr>
							</table>
							<!-- detail << -->
			...
			<rich:panel style="float:right;background-color:none;border-style:none;">
                <a4j:commandButton value="Ok" styleClass="rich-button" immediate="true" rendered="#{semmsa002Bean.chkCopySiteInfo == false}">
                    <rich:componentControl for="tab6_panel_popupModalRetStatus" operation="hide" event="onclick" />
                </a4j:commandButton>
                ...
                disabled="#{semmsa002Bean.disabledBtnCopySiteInfo}">
                    ...
                    <a4j:actionparam name="methodWithNavi" value="doCopyPropertyTax" />
