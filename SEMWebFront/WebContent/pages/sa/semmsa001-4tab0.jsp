	...
	<!-- >> wrapper panel -->
		...
		<rich:panel id="panelWrapper001-4" style="border:1 e0e0e0 solid; height:100%;" rendered="#{semmsa001Bean.panelDisplay == 'semmsa06'}">
				...
				<rich:panel  styleClass="sem_autoScrollbarInTodoSASub">
					<!-- >> table hd -->
				<h:panelGroup id="msa001-4_tabHd" rendered="#{semmsa001Bean.renderDisplay01}"> 
					<a4j:form id="frmMsa001-4_tabHd">
					<a4j:region>
						<rich:dataTable style="width:100%;" id="dataTab_msa001-4_tabHd" cellpadding="1" cellspacing="0" border="0" 
						var="mngApprHdLst" value="#{semmsa001Bean.managerApprHdList}" reRender="dataTab_msa001-4_tabHd, dataScrll_msa001-4_tabHd" 
						rows="#{semmsa001Bean.rowPerPage}" rowClasses="cur" styleClass="dataTable">
							...
							<rich:column style="text-align:center;">
								<f:facet name="header">
		                    		<h:selectBooleanCheckbox value="#{semmsa001Bean.chkSelAll}" style="width:20px;" rendered="false">
										...
										reRender="dataTab_msa001-4_tabHd, msa001-4_sendApprHd" >
											<a4j:actionparam name="paramManagerType" value="HD" />
											<a4j:actionparam name="paramObjectType" value="mngApprHD" />
										</a4j:support>
									</h:selectBooleanCheckbox>
		                    	</f:facet>
								<h:selectBooleanCheckbox id="chkSelect" value="#{mngApprHdLst.checkBox}">
		                    ...
		                    <rich:column style="text-align:center;" sortBy="#{mngApprHdLst.dataObj.batchNo}" headerClass="headerFilterWidth_120"
		                    filterBy="#{mngApprHdLst.dataObj.batchNo}" filterEvent="onkeyup">
								<f:facet name="header">
		                    		<h:outputText value="Batch" style="white-space:nowrap" />
		                    	</f:facet>
		                        <a4j:commandLink value="#{mngApprHdLst.dataObj.batchNo}" 
								action="#{semmsa001Action.doGetManagerDt}" 
								reRender="panelWrapper_tree, panelWrapper_content, msa001-4_tabHd, msa001-4_tabDt, dataTab_msa001-4_tabHd, dataTab_msa001-4_tabDt">
										<a4j:actionparam name="rowId" value="#{mngApprHdLst.dataObj.rowId}" />
										<a4j:actionparam name="paramBatchNo" value="#{mngApprHdLst.dataObj.rowId}" />
		                    ...
		                    <rich:column style="text-align:center;" sortBy="#{mngApprHdLst.dataObj.assignToTeam}" headerClass="headerFilterWidth_120"
		                    filterBy="#{mngApprHdLst.dataObj.assignToTeam}" filterEvent="onkeyup">
								<f:facet name="header">
		                    		<h:outputText value="#{jspMsg['column.header.th_team']}" style="white-space:nowrap" />
		                    	</f:facet>
		                        <h:outputText value="#{mngApprHdLst.dataObj.assignToTeam}" />
		                    </rich:column>
							
		                    <rich:column style="text-align:center;" sortBy="#{mngApprHdLst.dataObj.assignToUser}" headerClass="headerFilterWidth_120"
		                    filterBy="#{mngApprHdLst.dataObj.assignToUser}" filterEvent="onkeyup">
		                        <f:facet name="header">
		                    		<h:outputText value="Staff" style="white-space:nowrap" />
		                    	</f:facet>
								<h:outputText value="#{mngApprHdLst.dataObj.assignToUser}" />
		                    </rich:column>
							
		                    <rich:column style="text-align:right;" sortBy="#{mngApprHdLst.dataObj.batchSum}" headerClass="headerFilterWidth"
		                    filterBy="#{mngApprHdLst.dataObj.batchSum}" filterEvent="onkeyup">
		                        <f:facet name="header">
		                    		<h:outputText value="#{jspMsg['column.header.th_sum_apprDoc']}" style="white-space:nowrap" />
		                    	</f:facet>
								<h:outputText value="#{mngApprHdLst.dataObj.batchSum}" />
		                    </rich:column>
							
		                    <rich:column style="text-align:right;" sortBy="#{mngApprHdLst.dataObj.growingCost}" headerClass="headerFilterWidth"
		                    filterBy="#{mngApprHdLst.dataObj.growingCost}" filterEvent="onkeyup">
		                        <f:facet name="header">
		                    		<h:outputText value="#{jspMsg['column.header.th_rent_costOver']}" style="white-space:nowrap" />
		                    	</f:facet>
								<h:outputText value="#{mngApprHdLst.dataObj.growingCost}" />
		                    </rich:column>
							
		                    <rich:column style="text-align:right;" sortBy="#{mngApprHdLst.dataObj.nearSiteCost}" headerClass="headerFilterWidth"
		                    filterBy="#{mngApprHdLst.dataObj.nearSiteCost}" filterEvent="onkeyup">
		                        <f:facet name="header">
		                    		<h:outputText value="#{jspMsg['column.header.th_rent_expence_moreThan_CloseUpSite']}" style="white-space:nowrap" />
		                    	</f:facet>
								<h:outputText value="#{mngApprHdLst.dataObj.nearSiteCost}" />
		                    </rich:column>
		                    <!-- detail -->
								...
								<rich:columnGroup>
									...
									<rich:column colspan="4">
										<h:outputFormat value="#{msg['message.totalRecords']}">
											<f:param value="#{fn:length(semmsa001Bean.managerApprHdList)}"></f:param>
										</h:outputFormat>
									</rich:column>
									<!-- > 2 -->
									<rich:column colspan="4">
										<a4j:region>
											<rich:datascroller immediate="true" rendered="true" align="left" for="dataTab_msa001-4_tabHd"
												maxPages="#{semmsa001Bean.rowPerPage}"  selectedStyleClass="selectScroll"
												stepControls="hide" fastControls="auto" boundaryControls="auto" 
												id="dataScrll_msa001-4_tabHd" style="background-color: #cccccc;"
												page="#{semmsa001Bean.scrollerPage}">
											<a4j:support event="onclick"  reRender="frmMsa001-4_tabHd"></a4j:support>
											</rich:datascroller>
										</a4j:region>
									</rich:column>
								</rich:columnGroup>
				...
				<!-- >> table dt -->
				<h:panelGroup id="msa001-4_tabDt" rendered="#{semmsa001Bean.renderDisplay02}"> 
					<a4j:form id="frmMsa001-4_tabDt">
					<a4j:region>
						<rich:dataTable style="width:100%;" id="dataTab_msa001-4_tabDt" 
						cellpadding="1" cellspacing="0" border="0" 
						var="mngApprDtLst"  value="#{semmsa001Bean.managerApprDtList}" reRender="dataTab_msa001-4_tabDt, dataScrll_msa001-4_tabDt" 
						rows="#{semmsa001Bean.rowPerPage}" rowClasses="cur" styleClass="dataTable">
		                    ...
		                    <rich:column style="text-align:center;">
		                    	<f:facet name="header">
			                    	<h:selectBooleanCheckbox value="#{semmsa001Bean.chkSelAll}" style="width:20px;" rendered="false">
										<a4j:support event="onclick" action="#{semmsa001Action.selectManagerAllRow}" 
										reRender="dataTab_msa001-4_tabDt, msa001-4_sendApprDt,msa001-4tab0_btnExportExcel">
		                    ...
		                    <rich:column id="msa001-4tab0_remarkRisk" style="text-align:center;" sortBy="#{mngApprDtLst.dataObj.remarkRisk}" headerClass="headerFilterWidth"
		                    ...
		                    filterBy="#{mngApprDtLst.dataObj.statusDt}"  rendered="false">
		                    	<f:facet name="header">
							...
							<f:facet name="footer">
								<rich:columnGroup>
									...
									<rich:column colspan="22">
										<a4j:region>
											<rich:datascroller immediate="true" rendered="true" align="left" for="dataTab_msa001-4_tabDt"
												maxPages="#{semmsa001Bean.rowPerPage}"  selectedStyleClass="selectScroll"
												stepControls="hide" fastControls="auto" boundaryControls="auto" 
												id="dataScrll_msa001-4_tabDt" style="background-color: #cccccc;"
												page="#{semmsa001Bean.scrollerPage}">
											<a4j:support event="onclick"  reRender="frmMsa001-4_tabDt"></a4j:support>
											</rich:datascroller>
										</a4j:region>
									</rich:column>
								</rich:columnGroup>
				...
				<!-- << button export -->
					...
					<a4j:form id="msa001-4tab0_frmButton">
						<table style="width:98%; text-align:left;">
							<tr>
								<td>
									<h:commandButton id="msa001-4tab0_btnExportExcel" value="#{jspMsg['label.exportExcel']}" 
									styleClass="rich-button" action="#{semmsa001Action.doManagerExportExcel}" rendered="#{semmsa001Bean.renderDisplay02}"
						...
						<h:panelGroup style="width:100%;">
							...
							<table style="width:100%; border:solid 1px;">
								<tr>
									...
									<td style="width:70%;">
										<h:selectOneMenu id="msa001-4_apprResult" value="#{semmsa001Bean.siteAppObjParam.managerApproveStatus}" styleClass="ms7">
								...
								<tr>
									...
									<td style="width:70%;">
										<h:inputTextarea id="msa001-4_apprRemark" value="#{semmsa001Bean.siteAppObjParam.managerApproveRemark}" rows="4" cols="30" style="width:70%;" styleClass="ms7">
										</h:inputTextarea>
									</td>
								</tr>
								<tr>
									<td style="text-align:center;" colspan="2">
										<a4j:commandButton style="margin-top:20px;" styleClass="rich-button" id="msa001-4_sendApprHd" value="#{jspMsg['label.th_ok']}"
										rendered="#{semmsa001Bean.renderDisplay01}" action="#{semmsa001Action.doManagerApprove}" disabled="#{semmsa001Bean.disabledChecked}" 
										reRender="panelWrapper_tree, panelWrapper_content, dataTab_msa001-4_tabHd, frmMsa001-4_tabHd, msa001-4_apprResult, msa001-4_apprRemark"
										oncomplete="#{rich:component('popUpMsa001-4_retStatus')}.show();">
											<a4j:actionparam name="paramManagerType" value="HD" />
										</a4j:commandButton>
										
										<a4j:commandButton style="margin-top:20px;" styleClass="rich-button" id="msa001-4_sendApprDt" value="#{jspMsg['label.th_ok']}"
										rendered="#{semmsa001Bean.renderDisplay02}" action="#{semmsa001Action.doManagerApprove}" disabled="#{semmsa001Bean.disabledChecked}"
										reRender="panelWrapper_tree, panelWrapper_content, dataTab_msa001-4_tabDt, frmMsa001-4_tabDt, msa001-4_apprResult, msa001-4_apprRemark"
										oncomplete="#{rich:component('popUpMsa001-4_retStatus')}.show();">
											<a4j:actionparam name="paramManagerType" value="DT" />
