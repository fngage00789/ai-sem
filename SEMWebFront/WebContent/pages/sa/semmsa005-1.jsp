...
<h:panelGrid width="100%">
	<rich:panel id="pnlBorrowRequest">
		...
		<h:panelGrid>
			<a4j:form id="frmError">
				<rich:messages layout="list" errorClass="ms7red" warnClass="ms7blue" infoClass="ms7green" rendered="#{semmsa005Bean.renderedMsgFormSearch}">
					<f:facet name="header">
		...
		<h:panelGrid columnClasses="gridContent" width="100%">
					...
					<rich:panel id="pnlSearchCriteria">
						...
						<h:panelGrid width="95%"  border="0" cellpadding="0" cellspacing="1">
							...
							<tr>
									...
									<h:selectOneMenu id="ddlCompany" value="#{semmsa005Bean.criteria.company}" onchange="GetCompanyJS();">
										<f:selectItems value="#{semmsa005Bean.companyList}"/>
									</h:selectOneMenu>
									<a4j:jsFunction name="GetCompanyJS" reRender="companyDisplay"/>
									<rich:spacer width="10"></rich:spacer>
									<h:outputText id="companyDisplay" value="#{semmsa005Bean.criteria.company}" styleClass="ms28"/>
				                	</td>
			                	 </tr>
								 <tr>
		                			...
		                			<td width="80%" colspan="3">
		                				<h:inputText label="#{jspMsg['label.docNo']}" id="txtDocNo" value="#{semmsa005Bean.criteria.docNo}" />
	                				</td>
			                	 </tr>
			                	 <tr>
									<td align="right" width="20%">
		                			...
		                			<td width="80%" colspan="3">
		                				<h:inputText label="#{jspMsg['label.contractNo']}" id="txtContractNo" value="#{semmsa005Bean.criteria.contractNo}" />
	                				</td>
			                	 </tr>
			...
			<a4j:form id="frmSearchRS">	
				...
				<td width="40%">
	            	...
	            	style="width:120" rendered="false">
	            		<a4j:actionparam name="navModule" value="sa" />
						<a4j:actionparam name="navProgram" value="SEMMSA005-1" />
						<a4j:actionparam name="moduleWithNavi" value="sa" />
						<a4j:actionparam name="actionWithNavi" value="SEMMSA005" />
					...
					<a4j:commandButton id="btnNewNew" value="#{jspMsg['btn.newDocNo']}" styleClass="rich-button"
	            	action="#{navAction.navi}" reRender="txtNavProgram,oppContent" 
	            	style="width:120" rendered="#{semmsa005Bean.renderer['btnNew']}">
	            		<a4j:actionparam name="navModule" value="sa" />
		            	<a4j:actionparam name="navProgram" value="SEMMSA005-6" />	
						<a4j:actionparam name="moduleWithNavi" value="sa" />
						<a4j:actionparam name="actionWithNavi" value="SEMMSA005" />
						<a4j:actionparam name="methodWithNavi" value="doAutoSaveNewBorrowContract" />
						<a4j:actionparam name="mode" value="EDIT"/>
						<a4j:actionparam name="newBorrowReq" value="Y"/>
					</a4j:commandButton>
				...
				<h:panelGrid  width="95%">
					<rich:panel id="pnlSearchResult" styleClass="sem_autoScrollbar">
						<f:facet name="header" >
							<h:outputText value="#{jspMsg['header.resultTable.name']}" style="width: 1600"/>
						</f:facet>
 						<div align="center">
						 ...
						 <rich:dataTable width="100%" id="dtbBorrowRequest" cellpadding="1" cellspacing="0" border="0"
							var="borrowSP" value="#{semmsa005Bean.borrowRequestSPList}" reRender="dtbBorrowRequest" 
							rows="#{semmsa005Bean.rowPerPage}" rowClasses="cur" styleClass="dataTable">
							<rich:column styleClass="#{(semmsa005Bean.tmpRowId==borrowSP.dataObj.rowId)?'onClick':'unClick'}" 
								rendered="#{semmsa005Bean.renderer['btnEdit']}">
								<f:facet name="header" >
								...
								<div align="center">
						            <a4j:commandButton id="btnEdit"
										...
										<a4j:actionparam name="navModule" value="sa" />
		            					<a4j:actionparam name="navProgram" value="SEMMSA005-2" />	
										<a4j:actionparam name="moduleWithNavi" value="sa" />
										<a4j:actionparam name="actionWithNavi" value="SEMMSA005" />
							...
							<rich:column styleClass="#{(semmsa005Bean.tmpRowId==borrowSP.dataObj.rowId)?'onClick':'unClick'}" 
								rendered="#{semmsa005Bean.renderer['btnDelete']}">
								<f:facet name="header" >
							...
							<rich:column styleClass="#{(semmsa005Bean.tmpRowId==borrowSP.dataObj.rowId)?'onClick':'unClick'}" 
								rendered="#{semmsa005Bean.renderer['btnView']}">
								<f:facet name="header" >
							...
							<rich:column styleClass="#{(semmsa005Bean.tmpRowId==borrowSP.dataObj.rowId)?'onClick':'unClick'}">
								...
								<div align="center">
		            				<a4j:commandButton id="btnSandApproveBorrow" value="#{jspMsg['btn.sendApprove']}" styleClass="rich-button"
						           	action="#{navAction.navi}" reRender="pnlBorrowRequest"
						           	style="width:55px;padding-left:7;">
										<a4j:actionparam name="navModule" value="sa" />
		            					<a4j:actionparam name="navProgram" value="SEMMSA005-1" />	
										<a4j:actionparam name="moduleWithNavi" value="sa" />
										<a4j:actionparam name="actionWithNavi" value="SEMMSA005" />
										<a4j:actionparam name="methodWithNavi" value="doSendApproveBorrow" />
										<a4j:actionparam name="rowId" value="#{borrowSP.dataObj.rowId}"/>
										<a4j:actionparam name="docNo" value="#{borrowSP.dataObj.docNo}"/>
										<a4j:actionparam name="company" value="#{borrowSP.dataObj.company}"/>
										<a4j:actionparam name="mode" value="VIEW" />
							...
							<rich:column  sortBy="#{borrowSP.dataObj.docNo}" styleClass="#{(semmsa005Bean.tmpRowId==borrowSP.dataObj.rowId)?'onClick':'unClick'}">
								<f:facet name="header">
							...
							<rich:column  sortBy="#{borrowSP.dataObj.receiveDtStr}" styleClass="#{(semmsa005Bean.tmpRowId==borrowSP.dataObj.rowId)?'onClick':'unClick'}">
								<f:facet name="header">
							...
							<rich:column  sortBy="#{borrowSP.dataObj.samSendDtStr}" styleClass="#{(semmsa005Bean.tmpRowId==borrowSP.dataObj.rowId)?'onClick':'unClick'}">
								<f:facet name="header">
							...
							<rich:column  sortBy="#{borrowSP.dataObj.samAssignSendDtStr}" styleClass="#{(semmsa005Bean.tmpRowId==borrowSP.dataObj.rowId)?'onClick':'unClick'}">
								<f:facet name="header">
							...
							<rich:column  sortBy="#{borrowSP.dataObj.remark}" styleClass="#{(semmsa005Bean.tmpRowId==borrowSP.dataObj.rowId)?'onClick':'unClick'}">
								<f:facet name="header">
							...
							<rich:column  sortBy="#{borrowSP.dataObj.siteNum}" styleClass="#{(semmsa005Bean.tmpRowId==borrowSP.dataObj.rowId)?'onClick':'unClick'}">
								<f:facet name="header">
							...
							<rich:column  sortBy="#{borrowSP.dataObj.siteBorrowNum}" styleClass="#{(semmsa005Bean.tmpRowId==borrowSP.dataObj.rowId)?'onClick':'unClick'}">
								<f:facet name="header">
							...
							<rich:column  sortBy="#{borrowSP.dataObj.siteRemainNum}" styleClass="#{(semmsa005Bean.tmpRowId==borrowSP.dataObj.rowId)?'onClick':'unClick'}">
								<f:facet name="header">
							...
							<rich:column  sortBy="#{borrowSP.dataObj.siteSendNum}" styleClass="#{(semmsa005Bean.tmpRowId==borrowSP.dataObj.rowId)?'onClick':'unClick'}">
								<f:facet name="header">
									<h:outputText value="#{jspMsg['column.header.siteSendNum']}" styleClass="contentform" />
								</f:facet>
								<div align="center">
									<h:outputText value="#{borrowSP.dataObj.siteSendNum}" styleClass="contentform">
										<f:convertNumber pattern="#,##0"/>
									</h:outputText>
								</div>
							</rich:column>
							<rich:column  sortBy="#{borrowSP.dataObj.siteNotSendNum}" styleClass="#{(semmsa005Bean.tmpRowId==borrowSP.dataObj.rowId)?'onClick':'unClick'}">
								<f:facet name="header">
									<h:outputText value="#{jspMsg['column.header.siteNotSendNum']}" styleClass="contentform" />
								</f:facet>
								<div align="center">
									<h:outputText value="#{borrowSP.dataObj.siteNotSendNum}" styleClass="contentform">
										<f:convertNumber pattern="#,##0"/>
									</h:outputText>
								</div>
							</rich:column>
								...
								<rich:columnGroup>
									<rich:column colspan="4">
										<h:outputFormat value="#{msg['message.totalRecords']}">
											<f:param value="#{fn:length(semmsa005Bean.borrowRequestSPList)}"></f:param>
										</h:outputFormat>
									</rich:column>
	...
	<jsp:include page="../../pages/sa/semmsa005-2.jsp" />
