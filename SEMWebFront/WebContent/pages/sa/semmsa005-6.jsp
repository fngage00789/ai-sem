...
<h:panelGrid width="100%">
				...
				<a4j:form id="frmSearchBorrow">
										...
										<table id="tblMessage">
											<tr><td>
												<rich:messages layout="list" errorClass="ms7red" warnClass="ms7blue" infoClass="ms7green" 
													rendered="#{semmsa005Bean.renderedMsgFormTop}">
												 		<f:facet name="header">
					...
					<rich:panel id="pnlSearchCriteria">
							...
							<table width="100%">
								<tr>
			                		...
			                		<td width="80%" colspan="3" valign="bottom">
											...
											<h:outputText id="docNoDisplay" value="#{semmsa005Bean.criteriaBorrow.docNo}" styleClass="ms7"/>
								...
								<tr>
		                			...
		                			<td width="80%" colspan="3" valign="bottom">
									<h:selectOneMenu id="ddlCompany" value="#{semmsa005Bean.criteriaBorrow.company}" 
										onchange="GetCompanyJS();" disabled="false">
										<f:selectItems value="#{semmsa005Bean.companyList}"/>
									</h:selectOneMenu>
									<a4j:jsFunction name="GetCompanyJS" reRender="companyDisplay,btnAddContract"/>
									<rich:spacer width="10"></rich:spacer>
									<h:outputText id="companyDisplay" value="#{semmsa005Bean.criteriaBorrow.company}" styleClass="ms28"/>
				                	</td>
			                	 </tr>
								<tr>
		                			...
		                			<h:inputTextarea id="txtContractNo" value="#{semmsa005Bean.viewContractNo}" 
		                				cols="50" rows="3" />
	                				</td>
			                	 </tr>
						...
						<h:panelGrid columns="2" id="grdSearchCommand">
							...
							<a4j:actionparam name="navModule" value="sa" />
							<a4j:actionparam name="navProgram" value="SEMMSA005-3" />
							<a4j:actionparam name="moduleWithNavi" value="sa" />
							<a4j:actionparam name="actionWithNavi" value="SEMMSA005" />
					...
					<br/>
					<h:panelGrid  columns="5" id="grdAddCommand">
		            	<h:commandButton id="btnExport" value="#{jspMsg['btn.export.borrow']}" styleClass="rich-button"
							action="#{semmsa005Action.doExportExcel}" disabled="#{semmsa005Bean.disabledBtnExport}" 
							rendered="false">
						</h:commandButton>
						<a4j:commandButton value="#{jspMsg['btn.borrow.request']}"
							oncomplete="if(#{semmsa005Bean.popupBorrowOpen == 'true'})#{rich:component('popupBorrowContract')}.show();if(#{semmsa005Bean.popupAlert == 'true'})#{rich:component('mdpAlertDialog')}.show(); return false"  
						    action="#{navAction.navi}" reRender="popupBorrowContract,frmAlertDialog" 
						    styleClass="rich-button" disabled="#{semmsa005Bean.disabledBtnExport}" 
						...
						<a4j:commandButton value="#{jspMsg['btn.return.request']}"
							oncomplete="if(#{semmsa005Bean.popupBorrowOpen == 'true'})#{rich:component('popupReturnContract')}.show();if(#{semmsa005Bean.popupAlert == 'true'})#{rich:component('mdpAlertDialog')}.show(); return false"  
						    action="#{navAction.navi}" reRender="popupReturnContract,popupFrmAddContractReturn,pnlRentalType,frmAlertDialog" 
						    styleClass="rich-button" disabled="#{semmsa005Bean.disBtnBorrow}" 
						    rendered="false">
							<a4j:actionparam name="navModule" value="sa" />
		            		<a4j:actionparam name="navProgram" value="SEMMSA005-6" />	
							<a4j:actionparam name="moduleWithNavi" value="sa" />
						...
						<a4j:commandButton id="btnAddContract" value="#{jspMsg['btn.add']}" styleClass="rich-button"
			                				disabled="#{semmsa005Bean.mode == 'VIEW' || semmsa005Bean.criteriaBorrow.company == ''
			                				|| semmsa005Bean.criteriaBorrow.company == null}"
					...
					<rich:panel id="pnlSearchResult" styleClass="sem_autoScrollbar">
						<f:facet name="header" >
						 ...
						 <rich:dataTable width="100%" id="dtbBorrowRequest" cellpadding="1" cellspacing="0" border="0"
							var="borrowSP" value="#{semmsa005Bean.borrowSPList}" reRender="dtbBorrowRequest" 
							rows="10" rowClasses="cur" styleClass="dataTable">
							<a4j:support event="onRowClick"   action="#{semmsa005Action.getRowIdOnClick2}" reRender="dtbBorrowRequest">
							...
							<rich:column style="width:18" 
								...
								width="5%" rendered="#{semmsa005Bean.modeReturn != 'VIEW'}">
								<f:facet name="header">
									<h:selectBooleanCheckbox value="#{semmsa005Bean.chkSelAll}">
										<a4j:support event="onclick" action="#{semmsa005Action.selectAllRow}" reRender="dtbBorrowRequest,btnExport,frmButton,grdAddCommand"/>
									</h:selectBooleanCheckbox>
								</f:facet>
								<h:selectBooleanCheckbox id="chkSelect"  value="#{borrowSP.checkBox}">
									<a4j:support event="onclick" action="#{semmsa005Action.onRenderExportButton}" reRender="btnExport,frmButton,dtbBorrowRequest,grdAddCommand">
										<a4j:actionparam name="rowId" value="#{borrowSP.dataObj.borrowContractId}" />
									</a4j:support>
								</h:selectBooleanCheckbox>
							</rich:column>
							...
							<rich:column id="colBorrow" 
								...
								<div align="center">
									<h:panelGroup rendered="#{(borrowSP.dataObj.returnName == null || borrowSP.dataObj.returnName == '') && semmsa005Bean.modeReturn != 'VIEW'}">
									...
									<h:panelGroup rendered="#{(borrowSP.dataObj.borrowName != null && borrowSP.dataObj.borrowName != '') && semmsa005Bean.modeReturn == 'VIEW'}">
							...
							<rich:column  
								styleClass="#{(semmsa005Bean.tmpRowId2==borrowSP.dataObj.borrowContractId)?'onClick':'unClick'}">
								<f:facet name="header" >
									<h:outputText value="Download" styleClass="contentform" style="width: 50"/>
								</f:facet>
								<div align="center">
									<a4j:commandButton id="btnDownloadFile"
										action="#{navAction.navi}"
										reRender="oppContent,popupDownloadContractFile"
										value="#{jspMsg['btn.loadSoft']}" styleClass="rich-button" style="width:60"
										oncomplete="#{rich:component('popupDownloadContractFile')}.show(); return false" 
										rendered="#{borrowSP.dataObj.flagSoftfile == 'Y'}">
										<a4j:actionparam name="navModule" value="sa" />
										<a4j:actionparam name="navProgram" value="SEMMSA005-6" />
										<a4j:actionparam name="moduleWithNavi" value="sa" />
										<a4j:actionparam name="actionWithNavi" value="SEMMSA005" />
										<a4j:actionparam name="methodWithNavi" value="initDownloadContract" />
										
										<a4j:actionparam name="contractNo" value="#{borrowSP.dataObj.contractNo}"/>
									</a4j:commandButton>
								</div>
							</rich:column>
							
							<rich:column id="colReturn" rendered="false"
								styleClass="#{(semmsa005Bean.tmpRowId2==borrowSP.dataObj.borrowContractId)?'onClick':'unClick'}">
								<f:facet name="header" >
									<h:outputText value="" styleClass="contentform" style="width: 50"/>
								</f:facet>
								<div align="center">
	            					...
	            					<a4j:commandLink id="btnReturn" value="#{jspMsg['btn.return.request']}"
						            	...
						            	rendered="#{(borrowSP.dataObj.borrowName != null && borrowSP.dataObj.borrowName != '' &&  borrowSP.dataObj.cantBorrowFlg == 'N') && semmsa005Bean.modeReturn != 'VIEW'}">
										<a4j:actionparam name="navModule" value="sa" />
		            					<a4j:actionparam name="navProgram" value="SEMMSA005-6" />	
										<a4j:actionparam name="moduleWithNavi" value="sa" />
										<a4j:actionparam name="actionWithNavi" value="SEMMSA005" />
	            					...
	            					<a4j:commandLink id="btnReturnView" value="#{jspMsg['btn.return.request']}"
										oncomplete="#{rich:component('popupReturnContract')}.show(); return false"  
						            	action="#{navAction.navi}" reRender="popupReturnContract,popupFrmAddContractReturn,pnlRentalType" 
						            	rendered="#{(borrowSP.dataObj.returnName != null && borrowSP.dataObj.returnName != '') && semmsa005Bean.modeReturn == 'VIEW'}">
										<a4j:actionparam name="navModule" value="sa" />
		            					<a4j:actionparam name="navProgram" value="SEMMSA005-6" />	
										<a4j:actionparam name="moduleWithNavi" value="sa" />
										<a4j:actionparam name="actionWithNavi" value="SEMMSA005" />
							...
							<rich:column  id="colSiteName" sortBy="#{borrowSP.dataObj.siteName}" 
								styleClass="#{(semmsa005Bean.tmpRowId2==borrowSP.dataObj.borrowContractId)?'onClick':'unClick'}">
								<f:facet name="header">
									<h:outputText value="#{jspMsg['column.siteName']}" styleClass="contentform" style="width: 150"/>
								</f:facet>
								<div align="center">
							...
							<rich:column id="colBorrowOfficerName" sortBy="#{borrowSP.dataObj.borrowOfficerName}" 
								styleClass="#{(semmsa005Bean.tmpRowId2==borrowSP.dataObj.borrowContractId)?'onClick':'unClick'}">
								<f:facet name="header">
									<h:outputText value="#{jspMsg['column.borrowOfficerName']}" styleClass="contentform" style="width: 100"/>
								</f:facet>
								<div align="center">
							...
							<rich:column id="colBorrowName" sortBy="#{borrowSP.dataObj.borrowName}" 
								styleClass="#{(semmsa005Bean.tmpRowId2==borrowSP.dataObj.borrowContractId)?'onClick':'unClick'}">
								<f:facet name="header">
									<h:outputText value="#{jspMsg['column.borrowName']}" styleClass="contentform" style="width: 100"/>
								</f:facet>
								<div align="center">
							...
							<rich:column id="colReturnName" sortBy="#{borrowSP.dataObj.returnName}" rendered="false"
								styleClass="#{(semmsa005Bean.tmpRowId2==borrowSP.dataObj.borrowContractId)?'onClick':'unClick'}">
								<f:facet name="header">
							...
							<rich:column id="colReturnDt" sortBy="#{borrowSP.dataObj.returnDt}" rendered="false"
								styleClass="#{(semmsa005Bean.tmpRowId2==borrowSP.dataObj.borrowContractId)?'onClick':'unClick'}">
								<f:facet name="header">
							...
							<rich:column sortBy="#{borrowSP.dataObj.contractType}" 
							styleClass="#{(semmsa005Bean.tmpRowId2==borrowSP.dataObj.borrowContractId)?'onClick':'unClick'}">
								<f:facet name="header">
									<h:outputText value="#{jspMsg['column.contractType']}" styleClass="contentform" style="width: 50"/>
								</f:facet>
								<div align="center">
									<h:outputText value="#{borrowSP.dataObj.contractType}" styleClass="contentform" />
								</div>
							</rich:column>
							
							<rich:column sortBy="#{borrowSP.dataObj.status}" 
							styleClass="#{(semmsa005Bean.tmpRowId2==borrowSP.dataObj.borrowContractId)?'onClick':'unClick'}">
								<f:facet name="header">
									<h:outputText value="#{jspMsg['column.status']}" styleClass="contentform" style="width: 100"/>
								</f:facet>
								<div align="center">
									<h:outputText value="#{borrowSP.dataObj.status}" styleClass="contentform" />
								</div>
							</rich:column>
	...
	<jsp:include page="../../pages/sa/semmsa005-4.jsp" />
	<jsp:include page="../../pages/sa/semmsa005-5.jsp" />
	
</h:panelGrid>

<jsp:include page="../../pages/sa/semmsa005-popup.jsp" />
	...
	<a4j:form id="frmAlertDialog">
		<table width="200px" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td>
					<h:panelGrid columns="1" styleClass="contentlabelform" width="170px">
						<h:outputText value="#{semmsa005Bean.contentAlert}" styleClass="ms7" />
					</h:panelGrid></td></tr><tr><td>
					<h:panelGrid columns="2" styleClass="contentlabelform">
