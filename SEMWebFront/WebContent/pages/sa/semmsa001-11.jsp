...
<%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
	...
	<!-- >> wrapper panel -->
		...
		<rich:panel id="panelWrapper001-11" style="border:1 e0e0e0 solid; height:100%;" rendered="#{semmsa001Bean.panelDisplay == 'semmsa13'}">
				<!-- >> header content 2 -->
					<f:facet name="header">
						<h:outputText value="#{jspMsg['label.th_signedToSM']} [semmsa001-11]"/>
					</f:facet>
				<!-- << header content 2 -->
				...
				<rich:panel id="tabResult_001-11" styleClass="sem_autoScrollbarInTodoSA">
					<a4j:form id="frmSearchResult_001-11">
					<a4j:region>
						<rich:dataTable style="width:100%;" id="dataTabLeadAssign_001-11" cellpadding="1" cellspacing="0" border="0" 
						var="waitingApprLst"  value="#{semmsa001Bean.siteAppList}" reRender="dataTabLeadAssign_001-11, dataScrllLeadAssign_001-11" 
						rows="#{semmsa001Bean.rowPerPage}" rowClasses="cur" styleClass="dataTable">
		                    ...
		                    <rich:column style="text-align:center;">
	                        	...
	                        	<a4j:commandButton id="msa001-11_btnEdit" action="#{navAction.navi}" image="images/edit.png" style="height:15px; width:15px;" 
								oncomplete="" reRender="oppContent, panelWrapper_tree, panelWrapper_content, dataTabLeadAssign_001-11" status="globalAjaxStatus">
									...
									<a4j:actionparam name="paramPage" value="semmsa001-11" />
								</a4j:commandButton>
		                    </rich:column>
		                    ...
		                    filterBy="#{waitingApprLst.dataObj.nearSiteCost}" filterEvent="onkeyup">
		                        ...
		                        <a4j:commandLink action="#{semmsa001Action.doShowPopupNearestSite}" value="#{waitingApprLst.dataObj.nearSiteCost}" 
							...
							<f:facet name="footer">
								<rich:columnGroup>
									...
									<rich:column colspan="20">
										<a4j:region>
											<rich:datascroller immediate="true" rendered="true" align="left" for="dataTabLeadAssign_001-11"
												maxPages="#{semmsa001Bean.rowPerPage}"  selectedStyleClass="selectScroll"
												stepControls="hide" fastControls="auto" boundaryControls="auto" 
												id="dataScrllLeadAssign_001-11" style="background-color: #cccccc;"
												page="#{semmsa001Bean.scrollerPage}">
											<a4j:support event="onclick"  reRender="frmSearchResult_001-11"></a4j:support>
											</rich:datascroller>
										</a4j:region>
									</rich:column>
								</rich:columnGroup>
