        ...
        <rich:panel id="panelWrapper_tree" style="height:100%; border:1 ececec solid; top:0px; vertical-align:top;">
           ...
           <rich:panel id="pnlSearchCriteria">
                        ...
                        <h:panelGrid width="95%"  border="0" cellpadding="0" cellspacing="1">
                            ...
                            <tr>
                                    ...
                                    <td width="15%" valign="bottom">
                                        <h:selectOneMenu id="ddlCompany" value="#{semmpt001Bean.treeUtilBean.company}">
                                    ...
                                    <td width="15%" valign="bottom">
                                    <h:selectOneMenu id="ddlRegion" value="#{semmpt001Bean.treeUtilBean.region}"> 
                                    ...
                                    <td width="10%" valign="bottom">
                                        <h:selectOneMenu id="ddlType" value="#{semmpt001Bean.treeUtilBean.menuSubGroup}"> 
            ...
            <rich:panel style="border:1 e0e0e0 solid; height:100%; vertical-align:top;">
                <!-- >> header left content -->
                    <f:facet name="header">
                            <h:outputText value="Property Tax [TO DO LIST]" />
                    </f:facet>
                <!-- << header left content -->
                <div style="width:280px;">
                    ...
                    <!-- >> Macro -->
						<rich:simpleTogglePanel id="semmpt001_pnlSubMacro"  switchType="client" label="#{semmpt001Bean.headerTreeMacro}" 
					        opened="true" style="width:100%;margin:0 auto; padding:0px;"
					        rendered="#{semmpt001Bean.treeMacroFlag}">
								<h:dataTable id="semmpt001_macro" border="0"
									var="obj" value="#{semmpt001Bean.menuTreeMacroList}" 
										...
										<div align="left" onmouseover="this.style.backgroundColor='#FFE4E1'" onmouseout="this.style.backgroundColor='transparent'">									
											<span style="width:195px; white-space:nowrap;">  
										          ...
										          reRender="oppContent,txtNavProgram,panelWrapper_tree,panelWrapper_content" >
			                                        ...
			                                        <a4j:actionparam name="methodWithNavi" value="doInitialForSearchPropertyTax" />
							...
							<!-- Pico -->
							<rich:simpleTogglePanel id="semmpt001_pnlSubPico"  switchType="client" label="#{semmpt001Bean.headerTreePico}" 
					        opened="true" style="width:100%;margin:0 auto; padding:0px;"
					        rendered="#{semmpt001Bean.treePicoFlag}">
								<h:dataTable id="semmpt001_pico" border="0"
									var="obj" value="#{semmpt001Bean.menuTreePicoList}" 
