		...
		<h:panelGrid columnClasses="gridContent" width="100%">
				...
				<h:panelGrid width="95%">
					<rich:panel id="pnlSumError">
						...
						<h:panelGrid width="95%" border="0" cellpadding="0" cellspacing="1">
							<h:panelGroup>
								<rich:dataTable id="dtbFailedRstList" width="100%" cellpadding="0" cellspacing="0" border="0" 
								var="obj" value="#{semmel005Bean.validateFailList}" reRender="dtbFailedRstList">
								...
								<table width="100%" style="display:none;">	
									...
									<tr>
										...
										<td width="30%" align="center">
											<h:outputText id="txtELPay02SizeNewup" value="#{semmel005Bean.elPay02Size}" styleClass="ms7">
											<f:convertNumber pattern="#,##0"/>
											</h:outputText>
										</td>
							...
							<h:panelGroup rendered="false">
								<table width="100%">	
									...
									<tr>
										<td align="right" width="20%">
											<h:outputText value="#{jspMsg['label.ELPAY12']}" styleClass="ms7"/>
										</td>
										<td width="30%" align="center">
											<h:outputText value="#{semmel005Bean.elPay12Size}" styleClass="ms7">
											<f:convertNumber pattern="#,##0"/>
									...
									<tr>
										<td align="right" width="20%">
											<h:outputText value="#{jspMsg['label.ELPAY01']}" styleClass="ms7"/>
										</td>
										<td width="30%" align="center">
											<h:outputText value="#{semmel005Bean.elPay01Size}"  styleClass="ms7">
											<f:convertNumber pattern="#,##0"/>
									...
									<tr>
										<td align="right" width="20%">
											<h:outputText value="#{jspMsg['label.ELPAY02']}" styleClass="ms7"/>
										</td>
										<td width="30%" align="center">
									...
									<tr>
										<td align="right" width="20%">
											<h:outputText value="#{jspMsg['label.ELPAY03']}" styleClass="ms7"/>
										</td>
										<td width="30%" align="center">
											<h:outputText value="#{semmel005Bean.elPay03Size}" styleClass="ms7">
											<f:convertNumber pattern="#,##0"/>
									...
									<tr>
										<td align="right" width="20%">
											<h:outputText value="#{jspMsg['label.ELPAY04']}" styleClass="ms7"/>
										</td>
										<td width="30%" align="center">
											<h:outputText value="#{semmel005Bean.elPay04Size}" styleClass="ms7">
											<f:convertNumber pattern="#,##0"/>
									...
									<tr>
										<td align="right" width="20%">
											<h:outputText value="#{jspMsg['label.ELPAY11']}" styleClass="ms7"/>
									...
									<tr>
										<td align="right" width="20%">
											<h:outputText value="#{jspMsg['label.ELPAY05']}" styleClass="ms7"/>
										</td>
										<td width="30%" align="center">
											<h:outputText value="#{semmel005Bean.elPay05Size}" styleClass="ms7">
											<f:convertNumber pattern="#,##0"/>
									...
									<tr>
										<td align="right" width="20%">
											<h:outputText value="#{jspMsg['label.ELPAY06']}" styleClass="ms7"/>
										</td>
										<td width="30%" align="center">
											<h:outputText value="#{semmel005Bean.elPay06Size}" styleClass="ms7">
											<f:convertNumber pattern="#,##0"/>
									...
									<tr>
										<td align="right" width="20%">
											<h:outputText value="#{jspMsg['label.ELPAY07']}" styleClass="ms7"/>
										</td>
										<td width="30%" align="center">
											<h:outputText value="#{semmel005Bean.elPay07Size}" styleClass="ms7">
											<f:convertNumber pattern="#,##0"/>
				...
				<h:panelGrid columns="11" id="grdActionCommand">
					...
					<rich:spacer width="5"/>
					<a4j:commandButton id="btnExportMeter" value="#{jspMsg['btn.exportmeter']}" styleClass="rich-button" 
					...
					<rich:spacer width="5"/>
					<a4j:commandButton id="btnExportText" value="#{jspMsg['btn.exporterror']}" styleClass="rich-button" 
				...
				<h:panelGrid id="pnlShowExportMeterExcel" style="height:0px;width:0px;" width="0px" columns="0" >
						<h:panelGroup id="pnlInShowExportMeterExcel" rendered="#{semmel005Bean.displayExportMeter}" style="height:0px;width:0px;" >
							...
							<script>document.getElementById('incContent:frmUploadText:bthShowExportMeterExcel').click();</script>
						</h:panelGroup>							
		</h:panelGrid>	
<h:panelGrid id="pnlShowExportTextExcel" style="height:0px;width:0px;" width="0px" columns="0" >
						<h:panelGroup id="pnlInShowExportTextExcel" rendered="#{semmel005Bean.displayExportUptFormat}" style="height:0px;width:0px;" >
							...
							<script>document.getElementById('incContent:frmUploadText:bthShowExportTextExcel').click();</script>
						</h:panelGroup>							
		</h:panelGrid>	
