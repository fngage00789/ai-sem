		...
		<h:panelGrid columnClasses="gridContent" width="90%">
			<h:panelGroup>
				...
				<td width="50%" align="right" valign="bottom">
					...
					<tr>
					<td>
						<a4j:commandButton id="btnBack" value="Back_1" styleClass="rich-button" 
						...
						<a4j:commandButton id="btnBack_update" value="Back_2" styleClass="rich-button" 
								action="#{navAction.navi}" reRender="oppContent" 
								rendered="#{semmel006Bean.comeFromPage8 && !semmel006Bean.fromAction}"
								>
							<a4j:actionparam name="navModule" value="el" />
						...
						<a4j:commandButton id="btnBack_update2" value="Back_3" styleClass="rich-button" 
								action="#{navAction.navi}" reRender="oppContent" 
						...
						<h:panelGrid width="90%" border="0" cellpadding="0" cellspacing="1">
							...
							<table width="100%">
								...
								<tr>
									...
									<td width="25%">
										<h:selectOneMenu   value="#{semmel006Bean.payment.crBankName}"  
								...
								<tr>
									...
									<tr>
										...
										<td >
											...
											<rich:spacer width="5"/>
											<a4j:commandButton id="btnVendorMaster" 
											value="#{jspMsg['label.vendorMaster']}" 
						            		...
						            		disabled="#{!semmel006Bean.payment.crCreditFlagBoolean || 
												...
												<a4j:actionparam name="contractNo" value="#{semmel006Bean.popupSiteSearch7.contractNo}" />
									...
									<tr>
										...
										<td align="right" >
											<h:outputText value="#{jspMsg['label.refMeterId']}" styleClass="ms7" rendered="flase" />
										</td>
										<td >
											<h:outputText value="#{semmel006Bean.meterInfo.referMeterId}" styleClass="ms7" rendered="flase"/>
										</td>
									...
									<tr>
										<td align="right" ">
											<h:graphicImage value="images/icon_required.gif"/><rich:spacer width="5"/>
											<h:outputText value="#{jspMsg['label.termOfPaymentDt']}" styleClass="ms7"/>
										</td>
										<td >
										...
										<td >
											<h:selectOneMenu id ="meterListId" value="#{semmel006Bean.popupSiteSearch7.meterId}"  
									...
									<tr>
										...
										<td >	
												...
												disabled="#{!semmel006Bean.payment.crCreditFlagBoolean}" onclick="doRecalCulateVATPR();" 
