...
<f:loadBundle basename="resources.el.semmel001-10" var="jspMsg" />
<h:panelGrid width="100%">
	<rich:panel id="pnlPayment010">
		<f:facet name="header">
						...
						<table width="100%">
							<tr>
								...
								<td width="50%" align="right" valign="baseline">
									<table id="tblButton">
										<tr>
											<td><a4j:commandButton id="btnCancel"
							...
							<tr>
								<td colspan="2" align="left">
									<h:outputText value="#{jspMsg['header.panel.depositList']}" styleClass="ms7" />
								</td>
							</tr>
						</table>
					</h:panelGroup>
								...
								<table width="100%">
									<tr>
										<td style="width: 160px" align="right">
											<h:outputText value="#{jspMsg['header.detail']}" styleClass="ms7" />
										</td>
										<td>
											<h:inputTextarea readonly="true" rows="4" cols="80" value="#{semmel001Bean.manageWrapper.privateDeposit.depositDetail }"/>
										</td>
									</tr>
									<tr>
										<td style="width: 160px" align="right">
											<h:outputText value="#{jspMsg['header.vat']}" styleClass="ms7" />
										</td>
										<td>
											<table>
												<tr>
													<td>
														<h:selectOneRadio id="rbtprivateDepositVatType"
															styleClass="ms7" disabled="true"
															value="#{semmel001Bean.manageWrapper.privateDeposit.vatType}"
								...
								<table width="100%">
									<tr>
										...
										<td width="30%"><h:outputText
											value="#{semmel001Bean.manageWrapper.electricPayment.contractNo }"
											styleClass="ms7" /></td>
										<td align="right" width="20%"><h:graphicImage
											value="images/icon_required.gif" /><rich:spacer width="5"/><h:outputText
									...
									<tr>
										...
										<td width="30%"><h:selectOneMenu id="detailRefDocType"
											disabled="#{semmel001Bean.frefDocTypeDisable }"
									...
									<tr>
										...
										<td width="30%"><rich:calendar locale="th/TH"
											...
											disabled="#{semmel001Bean.frefDocDtDisable }"
									...
									<tr>
										...
										<td width="30%"><h:selectOneMenu id="detailPaymentMethod"
											disabled="#{semmel001Bean.fpaymentTypeDisable }"
										...
										<td width="30%"><h:selectOneMenu id="detailPaymentType"
											disabled="#{semmel001Bean.fpaymentMethodDisable}"
									...
									<tr>
										<td align="right" width="20%">
											...
											<h:outputText value="#{jspMsg['label.chequeDate']}" styleClass="ms7" /></td>
										<td width="30%">
											<rich:calendar id="chqPostingDt"
												locale="th/TH"
												disabled="#{semmel001Bean.fchqPostingDtDisable }"
												enableManualInput="true" datePattern="dd/MM/yyyy"
										...
										<td width="30%">
											<rich:calendar locale="th/TH"
												enableManualInput="true" datePattern="dd/MM/yyyy"
												disabled="#{semmel001Bean.fchqReceivedDtDisable }"
									...
									<tr>
										...
										<td width="30%">
											<rich:calendar locale="th/TH"
												disabled="#{semmel001Bean.ftransferDtDisable }"
												enableManualInput="true" datePattern="dd/MM/yyyy"
										...
										<td width="30%" align="left"><h:inputTextarea
											disabled="#{semmel001Bean.fpaymentRemark}"
							...
							<h:panelGroup>
								<table width="100%">
									<tr>
										<td align="right" width="20%"><h:graphicImage
											value="images/icon_required.gif" /><rich:spacer width="5"/><h:outputText
											value="#{jspMsg['label.year']}" styleClass="ms7" /></td>
										<td width="30%"><h:inputText size="18" maxlength="15"
											value="#{semmel001Bean.manageWrapper.paymentDetailPeriodYear}"
											style="width : 160px"
										...
										<td align="right" width="20%">
										<h:graphicImage rendered="flase"
											value="images/icon_required.gif" />
											<rich:spacer width="5"/><h:outputText
											value="#{jspMsg['label.month']}" styleClass="ms7" /></td>
										<td width="30%"><h:selectOneMenu id="monthList"
											value="#{semmel001Bean.manageWrapper.paymentDetailPeriodMonth}"
											style="width : 160px">
											<f:selectItems value="#{semmel001Bean.monthList}" />
										</h:selectOneMenu></td>
									</tr>
									<tr>
										<td align="right" width="20%">
										...
										<table>
											<tr>
												<td><h:selectOneRadio id="rbtVatType" styleClass="ms7"
													...
													layout="lineDirection" disabled="true">
													<f:selectItems value="#{semmel001Bean.vatTypeList}"/>
													<a4j:support event="onclick" action="#{semmel001Action.doChangePayAmt}" reRender="pnlAmount" />
												</h:selectOneRadio></td>
											</tr>
										</table>
										</td>
									...
									<tr>
										...
										<td width="30%">
											<h:inputText size="18" disabled="true" maxlength="18" 
									...
									<tr>
										...
										<td width="30%">
											<h:inputText size="18" maxlength="15" disabled="true" 
												...
												<tr>
													<td>
														<a4j:commandButton id="btnAdd" value="Add"
															...
															disabled="#{!semmel001Bean.btaddVisible}">
															<a4j:actionparam name="navModule" value="el" />
															<a4j:actionparam name="navProgram" value="SEMMEL001-10" />
															<a4j:actionparam name="moduleWithNavi" value="el" />
															<a4j:actionparam name="actionWithNavi" value="SEMMEL001" />
															<a4j:actionparam name="methodWithNavi" value="doAdd10" />
															<a4j:actionparam name="page" value="10" />
														</a4j:commandButton>
													</td>
													<td>
														<a4j:commandButton id="btnUpdate" value="Update"
															...
															disabled="#{!semmel001Bean.btUpdateVisible}">
															<a4j:actionparam name="navModule" value="el" />
															<a4j:actionparam name="navProgram" value="SEMMEL001-10" />
															<a4j:actionparam name="moduleWithNavi" value="el" />
															<a4j:actionparam name="actionWithNavi" value="SEMMEL001" />
															<a4j:actionparam name="methodWithNavi" value="doUpdate10" />
															<a4j:actionparam name="page" value="10" />
														</a4j:commandButton>
													</td>
													<td>
														<a4j:commandButton id="btnClear" value="Clear"
															...
															<a4j:actionparam name="moduleWithNavi" value="el" />
															<a4j:actionparam name="actionWithNavi" value="SEMMEL001" />
															<a4j:actionparam name="methodWithNavi" value="doClear10" />
														</a4j:commandButton>
													</td>
												</tr>
											</table>
							...
							<rich:dataTable id="dtbElecMeterCash" width="100%"
								...
								<rich:column width="5%">
									...
									<div align="center"><a4j:commandButton
										...
										<a4j:actionparam name="moduleWithNavi" value="el" />
										<a4j:actionparam name="actionWithNavi" value="SEMMEL001" />
										<a4j:actionparam name="methodWithNavi" value="doInitEdit10" />
								...
								<rich:column width="5%">
									...
									<div align="center"><a4j:commandButton
										...
										reRender="pnlAmount,dtbElecMeterCash,pnlSumAmount,pnlDetail,mdpConfirmDialog, frmConfirmDelDialog">
										<a4j:actionparam name="navModule" value="el" />
										<a4j:actionparam name="navProgram" value="SEMMEL001-10" />
										<a4j:actionparam name="moduleWithNavi" value="el" />
										<a4j:actionparam name="actionWithNavi" value="SEMMEL001" />
										<a4j:actionparam name="methodWithNavi" value="initDelete10" />
										<a4j:actionparam name="rowIndex" value="#{rowIndex}" />
										<a4j:actionparam name="page" value="10" />
									</a4j:commandButton></div>
								</rich:column>
								...
								<rich:column
									sortBy="#{ElectricPaymentWrapper.electricPaymentDetail.periodYear}">
									<f:facet name="header">
										<h:outputText value="#{jspMsg['header.year']}"
											style="width: 100px">
										</h:outputText>
									</f:facet>
									<div align="center"><h:outputText
										value="#{ElectricPaymentWrapper.electricPaymentDetail.periodYear}" />
									</div>
								</rich:column>
								<rich:column
									sortBy="#{ElectricPaymentWrapper.electricPaymentDetail.periodMonth}">
									<f:facet name="header">
										<h:outputText value="#{jspMsg['header.month']}"
											style="width: 100px">

										</h:outputText>
									</f:facet>
									<div align="center">
										<h:outputText value="#{ElectricPaymentWrapper.electricPaymentDetail.periodMonth}">
			...
			<tr>
				<td><h:panelGrid columns="2" styleClass="contentlabelform">
					<a4j:commandButton value="Yes" styleClass="rich-button"
						...
						reRender="dtbElecMeterCash,pnlSumAmount,pnlBtHead,pnlDetail">
						<a4j:actionparam name="navModule" value="el" />
						<a4j:actionparam name="navProgram" value="SEMMEL001-10" />
						<a4j:actionparam name="moduleWithNavi" value="el" />
						<a4j:actionparam name="actionWithNavi" value="SEMMEL001" />
						<a4j:actionparam name="methodWithNavi" value="doDelete10" />
						<a4j:actionparam name="page" value="10" />
			...
			<tr>
				<td><h:panelGrid columns="2" styleClass="contentlabelform">
					<a4j:commandButton value="Yes" styleClass="rich-button"
						...
						<a4j:actionparam name="moduleWithNavi" value="el" />
						<a4j:actionparam name="actionWithNavi" value="SEMMEL001" />
						<a4j:actionparam name="methodWithNavi" value="doEdit10" />
						<a4j:actionparam name="page" value="10" />
