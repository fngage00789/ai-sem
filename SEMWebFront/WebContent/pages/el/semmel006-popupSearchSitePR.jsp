		...
		<rich:panel>
				<table>	
					...
					<tr>				
	                	...
	                	<td align="right"><h:outputText value="#{jspMsg['label.prepaidFlag']}" styleClass="ms7"/></td>
               			<td><h:selectBooleanCheckbox id="id_prepaidFlag" value="#{semmel006Bean.popupSiteCriteria.prepaidFlag}"/></td>
	           	 	</tr>
	           	 	<tr>				
						<td align="right">
					...
					<h:panelGroup>					
						...
						<a4j:actionparam name="methodWithNavi" value="doSearchSitePRPostpaidByPL" />
						</a4j:commandButton>						
				...
				<h:panelGrid  id="grdPopupSearchResult" width="100%">
					<rich:panel id="pnlPopupSearchPostpaidResult">
						...
						value="#{semmel006Bean.popupSiteList}" rows="3" 
						var="popupSite" 
				...
				<a4j:commandButton  id="btnSiteAddBySelect" styleClass="rich-button" 
									...
									value="Save" 
									reRender="oppContent,contractInfo,frmError,paymentInfo,meterDetail,popupFrmSearch,popupFrmError,paymentPostpaidInfo,prepaidInfo,expenseDetail,btnPercentGrowth,termofPayDt,btnElGroup,btnPercentGrowth" 
									disabled="#{semmel006Bean.savePopupSiteDisable}">
					<a4j:actionparam name="navModule" value="el" />
           			<a4j:actionparam name="navProgram" value="SEMMEL006-6" />	
					<a4j:actionparam name="moduleWithNavi" value="el" />
					<a4j:actionparam name="actionWithNavi" value="SEMMEL006" />
					<a4j:actionparam name="methodWithNavi" value="doAddSitePR" />	
