			...
			<a4j:form id="frmSearch_vmp">             
				<h:panelGrid width="90%" id="hpnSearchResult">
					...
					<rich:panel id="pnlSearchResult">
						...
						<div align="center">
							<h:outputLabel style="color:red;size:20px" value="#{semmel001Bean.msgDataNotFound}" rendered="#{semmel001Bean.renderedMsgDataNotFound}" />
						</div>
						<div align="left">
						...
						<rich:dataTable width="95%" id="dtbVendor" cellpadding="1" cellspacing="0" border="0"
							var="vendor" value="#{semmel001Bean.vendorMapPayeeList}" reRender="dstVendor" 
							...
							<rich:column>
								...
								<div align="center">
	            					<a4j:commandButton action="#{navAction.navi}" image="images/edit.png" 
										...
										<a4j:actionparam name="contractNoParam" value="#{semmel001Bean.wrapper.electricManage.contractNo}" />
										<a4j:actionparam name="expenseTypeIdParam" value="06" />
										<a4j:actionparam name="isPageFrom" value="true" />
															
										<a4j:actionparam name="navModuleBack" value="el" />
										<a4j:actionparam name="navProgramBack" value="SEMMEL001-VMP" />
										<a4j:actionparam name="actionWithNaviBack" value="SEMMEL001"/>
							...
							<rich:column>
								...
								<div align="center">
									<h:outputText value="#{semmel001Bean.wrapper.electricManage.siteName}" styleClass="contentform"  />
								</div>
							</rich:column>
							<rich:column>
								<f:facet name="header">
								...
								<rich:columnGroup>
									<rich:column colspan="13">
										<h:outputFormat value="#{msg['message.totalRecords']}">
											<f:param value="#{fn:length(semmel001Bean.vendorMapPayeeList)}"></f:param>
										</h:outputFormat>
									</rich:column>
				...
				<h:panelGrid columns="4">
					...
					<a4j:commandButton id="btnSearchSiteCancel" styleClass="rich-button" value="#{jspMsg['btn.cancel']}" reRender="oppContent" action="#{navAction.navi}">
						...
						<a4j:actionparam name="moduleWithNavi" value="#{semmel001Bean.navModuleFrom}" />
						<a4j:actionparam name="actionWithNavi" value="SEMMEL001" />
						<a4j:actionparam name="methodWithNavi" value="doBackTo14" />		
					</a4j:commandButton>					
