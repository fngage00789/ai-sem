    ...
    <rich:modalPanel id="popupTransferDummyContract" width="500"  height="600" autosized="true" minWidth="220" moveable="false"> 
        ...
        <table width="100%">
           <tr>
                ...
                <td colspan="3">
                    <h:inputText id="txtDummyContractIdShow" value="#{semmsi004Bean.siteInfoData.contractNo}" disabled="true"/>
                </td>
            </tr>
        </table>
        <h:form id="popupFrmSearch"> 
                <h:panelGrid width="800" id="grdPopupSearchCriteria">
                    <rich:panel id="pnlPopupSearchCriteria">
                        <f:facet name="header">
                            <h:outputText value="#{jspMsg['header.criteria.name2']}"/>
                        </f:facet>
                        ...
                        <h:panelGrid width="90%" columns="5" border="0" cellpadding="0" cellspacing="1">
                            ...
                            <table width="100%">
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <h:inputHidden id="txtDummyContractId" value="#{semmsi004Bean.siteInfoData.contractNo}"/>
                                        <h:inputHidden id="txtDummySiteInfoId" value="#{semmsi004Bean.siteInfoData.rowId}"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" width="20%">
                                ...
                                <h:panelGroup>
                                    ...
                                    <rich:spacer width="10"></rich:spacer>
                                    <a4j:commandButton styleClass="rich-button" id="btnTransferPopup" value="#{jspMsg['btn.transfer']}"
                                    disabled="#{semmsi004Bean.disabledTransfer}"
				                     action="#{navAction.navi}" reRender="oppContent,frmAddSiteInfo,frmSiteInfoError,txtOldContractNo,popupTransferDummyContract">
   ...
   <f:facet name="controls">
         ...
         <table width="100%">
           <tr>
                ...
                <td colspan="3">
                    <h:inputText id="txtDummyContractIdShowRollBack"  value="#{semmsi004Bean.siteInfoData.contractNo}" disabled="true"/>
                </td>
            </tr>
        </table>       
       <h:form id="popupFrmSearchRollBack"> 
                ...
                <a4j:commandButton value="#{jspMsg['btn.rollBack']}" styleClass="rich-button"  immediate="true" 
