...
<h:panelGrid width="100%">
	<rich:panel>	
		<f:facet name="header">
			<h:outputText value="#{jspMsg['header.ELPostpaid']}"/> 
		</f:facet>
		<h:panelGrid>
		...
		<a4j:form id="frmAddPaymentELPostpaid">	
			...
			<h:panelGroup>
				...
				<td width="50%" align="right" valign="bottom">
					...
					<td>
						...
						styleClass="rich-button" action="#{navAction.navi}" reRender="oppContent" >
						...
						<a4j:commandButton id="btnCancel3"
							value="Back" styleClass="rich-button"
							action="#{navAction.navi}" reRender="oppContent"
							...
							<a4j:actionparam name="methodWithNavi" value="#{semmel006Bean.methodWithNaviFrom}" />
						</a4j:commandButton>
	           		...
	           		<td>
						...
						<a4j:actionparam name="moduleWithNavi" value="el" />
						<a4j:actionparam name="actionWithNavi" value="SEMMEL006"/>
						<a4j:actionparam name="methodWithNavi" value="doSaveELPostpaid" />
						</a4j:commandButton>						
	           		</td>	           		
	           		<td>
						...
						<h:panelGrid width="90%" border="0" cellpadding="0" cellspacing="1">
							...
							<table width="100%">							
									<tr>
										...
										<td width="25%">											
				                		<a4j:commandButton id="btnPopupSearchSite"  oncomplete="#{rich:component('popupSearchSite')}.show(); return false"
										value="#{jspMsg['btn.searchSite']}"  disabled="#{semmel006Bean.viewMode || semmel006Bean.disableSearchSite}" 
										styleClass="rich-button"  reRender="oppContent,popupSearchSite,popupFrmSearch,pnlPopupSearchResult"
					            		action="#{navAction.navi}" style="width:150px;">
					            		<a4j:actionparam name="navModule" value="el" />
										<a4j:actionparam name="navProgram" value="SEMMEL006" />
										<a4j:actionparam name="moduleWithNavi" value="el" />	
										<a4j:actionparam name="actionWithNavi" value="SEMMEL006"/>									
										<a4j:actionparam name="methodWithNavi" value="initPopupSearchSiteELPostpaid" />
			            				</a4j:commandButton>	
										</td>	
										<td align="right" width="25%">											
									...
									<tr>
										...
										<td width="25%">
											<h:outputText value="#{semmel006Bean.popupSiteCriteria.eMeterType}" styleClass="ms7"/>
										</td>	
										<td align="right" width="25%">											
											<h:outputText value="#{jspMsg['label.eMeterRate']}" styleClass="ms7"/>
										</td>
										<td width="25%">
											<h:outputText value="#{semmel006Bean.popupSiteCriteria.eMeterRate}" styleClass="ms7"/>
										</td>																				
									</tr>
									<tr>
										<td align="right" width="25%">											
							...
							<table width="100%">
									<tr>
										...
										<td width="25%">											
											...
											<a4j:actionparam name="fromPage" value="SEMMEL006-3"/>	
				            				</a4j:commandButton>												
									...
									<tr>
										...
										<td width="25%">
											<h:selectOneMenu id="expenseTypeId"  value="#{semmel006Bean.payment.expenseType}"  disabled="#{semmel006Bean.expenseTypeDisable||semmel006Bean.disableMoreThanOneDetail||semmel006Bean.viewMode}" onchange="changeExpenseTypeELPostpaid3();" style="width:120px;">
												<f:selectItems value="#{semmel006Bean.elExpenseTypeList}"/>
											</h:selectOneMenu>	
											<a4j:jsFunction name="changeExpenseTypeELPostpaid3" reRender="payment,paymentPostpaidInfo" action="#{semmel006Action.changeExpenseTypeELPostpaid3}"/>																						
										...
										<td width="25%">
											<h:selectOneMenu id="docTypeId"  value="#{semmel006Bean.payment.docType}" disabled="#{semmel006Bean.docTypeDisable||semmel006Bean.disableMoreThanOneDetail||semmel006Bean.viewMode}" style="width:120px;">
									...
									<tr>
										...
										<td width="25%">
											<h:inputText  value="#{semmel006Bean.payment.docNo}" disabled="#{semmel006Bean.docNoDisable||semmel006Bean.disableMoreThanOneDetail||semmel006Bean.viewMode}" style="width:120px;"></h:inputText>
										</td>
										<td align="right" width="25%">
										<h:graphicImage value="images/icon_required.gif"/><rich:spacer width="5"/>
										...
										<td width="25%">
											<rich:calendar showWeeksBar="false" locale="th/TH" enableManualInput="true" datePattern="dd/MM/yyyy" disabled="#{semmel006Bean.docDtDisable||semmel006Bean.disableMoreThanOneDetail||semmel006Bean.viewMode}"
									...
									<tr>
										<td align="right" width="25%"><h:graphicImage value="images/icon_required.gif" 
										rendered="#{semmel006Bean.paymentTypeMandatory}"/><rich:spacer width="5"/>																					
											<h:outputText value="#{jspMsg['label.paymentType']}" styleClass="ms7" />
										</td>
										<td width="25%">
											
											<h:selectOneMenu id="paymentTypeId" value="#{semmel006Bean.payment.paymentType}"   
											disabled="#{semmel006Bean.paymentTypeDisable||semmel006Bean.disableMoreThanOneDetail||semmel006Bean.viewMode}" 
											onchange="changePaymentTypeELPostpaid();" style="width:120px;">
												<f:selectItems value="#{semmel006Bean.ctPaymentTypeList}"/>
											</h:selectOneMenu>	
											<a4j:jsFunction name="changePaymentTypeELPostpaid" reRender="frmError,payment,paymentPostpaidInfo" action="#{semmel006Action.changePaymentTypeELPostpaid03}"/>
										...
										<td width="25%">
											...
											value="#{semmel006Bean.payment.paymentMethod}"  
											disabled="#{semmel006Bean.paymentMethodDisable}" 
											style="width:120px;">
									...
									<tr>
										...
										<td width="25%">
											<rich:calendar id="cldchqPostingDt" showWeeksBar="false" locale="th/TH" enableManualInput="true" datePattern="dd/MM/yyyy" 
				                			 ...
				                			 oninputkeypress="return numberformat.keyPressFormatDateOnly(this, event);"
				                			 oninputblur="validateCalendarFromToWithPaymentType('frmAddPaymentELPostpaid','cldchqPostingDt','cldchqReceivedDt','#{semmel006Bean.payment.paymentMethod}');"
				                			 oncollapse="validateCalendarFromToWithPaymentType('frmAddPaymentELPostpaid','cldchqPostingDt','cldchqReceivedDt','#{semmel006Bean.payment.paymentMethod}');"
				                			 />
									...
									<tr>
										<td align="right" width="25%">
										<c:if test="${semmel006Bean.transferDtMandatory eq true}">
												<h:graphicImage value="images/icon_required.gif"/><rich:spacer width="5"/>
										</c:if>
						...
						<h:panelGrid width="90%" border="0" cellpadding="0" cellspacing="1">
							...
							<table width="100%">
								...
								<tr>
									...
									<td width="25%">
										<h:selectBooleanCheckbox id="crValidateELPostPaid" 
										value="#{semmel006Bean.paymentDetail.validatePaymentDetailFlagBoolean}" 
										onclick="doChangeValidateELPostPaid();"  styleClass="ms7"
										disabled="#{semmel006Bean.disableValidateELPostPaidPaymentDetail}" 
										/>	                		 									
 										<a4j:jsFunction name="doChangeValidateELPostPaid" 
 										reRender="paymentDetail" 
 										action="#{semmel006Action.doChangeValidateELPostPaid}"/>
								...
								<tr>
										...
										<td align="right" width="25%">
											<h:graphicImage value="images/icon_required.gif" 
											rendered="#{semmel006Bean.paymentDetail.validatePaymentDetailFlagBoolean}"/>
										...
										<td width="25%">
											...
											enableManualInput="true" datePattern="dd/MM/yyyy" 
				                			 value="#{semmel006Bean.paymentDetail.pDate}" inputSize="18" 
				                			 oninputkeypress="return numberformat.keyPressFormatDateOnly(this, event);"/>
										</td>	
										<td align="right" width="25%">
											<h:graphicImage value="images/icon_required.gif"
										...
										<td width="25%">
											...
											enableManualInput="true" datePattern="dd/MM/yyyy" 
				                			 value="#{semmel006Bean.paymentDetail.lDate}" inputSize="18" 
				                			 oninputkeypress="return numberformat.keyPressFormatDateOnly(this, event);"/>
										</td>											
								</tr>			
									...
									<tr>
										...
										<td width="25%">
											<h:inputText value="#{semmel006Bean.paymentDetail.pReadStr}"   id ="inputPRead"
											disabled="#{semmel006Bean.viewMode}" 
										...
										<td width="25%">
											<h:inputText  value="#{semmel006Bean.paymentDetail.lReadStr}"  id ="inputLRead"
											disabled="#{semmel006Bean.viewMode}" 
											onkeypress="return numberformat.keyPressDecimalOnly(this, event);"											
											onblur="doCalculateKwhTotal()"
											styleClass="inputRight">
											...
											<a4j:jsFunction name="doCalculateKwhTotal" 
				                			 reRender="inputKwhTotal,inputLRead,inputPRead"
									...
									<tr>
										...
										<td width="25%">
											<h:inputText  value="#{semmel006Bean.paymentDetail.kwhTotalStr}" id ="inputKwhTotal" 
											disabled="#{semmel006Bean.viewMode}" 
											onkeypress="return numberformat.keyPressDecimalOnly(this, event);"											
											styleClass="inputRight" onchange="refreshBtnPercentGrowth()"></h:inputText>
											<a4j:jsFunction name="refreshBtnPercentGrowth" reRender="btnPercentGrowth" ></a4j:jsFunction>										
										</td>
										<td align="right" width="25%">
									...
									<tr>
										...
										<td width="35%">
											...
											disabled="#{semmel006Bean.viewMode || semmel006Bean.disableTermOfPaymentDtMonth}"  
											style="width:80px;">
											<f:selectItems value="#{semmel006Bean.monthList}"/>
											<a4j:support event="onchange" 
											 action="#{semmel006Action.doCheckTermOfPaymentDateTime}" 
											reRender="paymentDtFrom,paymentDtTo,toTermOfPaymentDtMonthId,toTermOfPaymentDtYearId,paymentDetail,termofPayDt"
											/>
											</h:selectOneMenu>
											...
											<h:selectOneMenu id="fromTermOfPaymentDtYearId" 
											 ...
											 disabled="#{semmel006Bean.viewMode || semmel006Bean.disableTermOfPaymentDtYear}"  
											 style="width:80px;">
											...
											/>
				                			 ...
				                			 <rich:calendar  showWeeksBar="false" locale="th/TH" 
											enableManualInput="true" datePattern="dd/MM/yyyy" 
				                			 disabled="#{semmel006Bean.viewMode || semmel006Bean.disableFromTermOfPaymentDt}"
				                			 id="paymentDtFrom"
				                			 ...
				                			 reRender="paymentDtFrom,paymentDtTo,toTermOfPaymentDtMonthId,toTermOfPaymentDtYearId,fromTermOfPaymentDtMonthId,fromTermOfPaymentDtYearId,paymentDetail,btnPercentGrowth,btnPercentGrowth,termofPayDt"
				                			 action="#{semmel006Action.doChangeTermOfPaymentDate}" oncomplete="kkkkk"/>
										...
										<td width="25%">
											...
											disabled="#{semmel006Bean.viewMode || semmel006Bean.disableTermOfPaymentDtMonth}"  style="width:80px;">
												<f:selectItems value="#{semmel006Bean.monthList}"/>
											<a4j:support event="onchange" 
											 action="#{semmel006Action.doCheckTermOfPaymentDateTime}" 
											reRender="paymentDtFrom,paymentDtTo,toTermOfPaymentDtMonthId,toTermOfPaymentDtYearId,paymentDetail,termofPayDt"
									...
									<tr>
										...
										<td width="30%">
											...
											disabled="#{semmel006Bean.viewMode}"
												onkeypress="return numberformat.keyPressDecimalOnly(this, event);"
												onchange="doRecalCulateVATELTempPage63();" 
											...
											<a4j:jsFunction name="doRecalCulateVATELTempPage63" reRender="paymentDetail,btnPercentGrowth" 
											action="#{semmel006Action.doRecalCulateVATELTempPage63}"/>
										</td>
										<td align="right" width="20%">
											<h:graphicImage value="images/icon_required.gif" />
											<rich:spacer width="5"/>
					                	...
					                	<a4j:jsFunction name="doChangeVATTypeELTempPage63" reRender="paymentDetail" action="#{semmel006Action.doChangeVATTypeELTempPage63}"/>  
										</td>
									</tr>
									...
									<tr>
										...
										<td width="25%">											
											...
											<rich:spacer width="5"/>
											<h:outputText value="#{jspMsg['label.baht']}" styleClass="ms7"/></td>
										<td align="right" width="25%">
											<h:graphicImage value="images/icon_required.gif"/><rich:spacer width="5"/>
										...
										<td width="25%">					
											...
											<a4j:jsFunction name="doChangeVatAmtPage63" reRender="frmError,paymentDetail" action="#{semmel006Action.doChangeVatAmtPage63}"/>                     
									...
									<tr>
										...
										<td width="25%">								
											...
											disabled="false"
												size="20" onkeypress="return numberformat.keyPressDecimalOnly(this, event);"
												maxlength="18"
												styleClass="inputRight">
												<f:convertNumber pattern="#,##0.00" maxIntegerDigits="13" maxFractionDigits="2" />
											</h:inputText>	
									...
									<tr>
										...
										<td colspan="3" >
											...
											disabled="#{semmel006Bean.disableAddModelButton||semmel006Bean.viewMode}" rendered="#{!semmel006Bean.comeFromPage8}"
											action="#{navAction.navi}"  reRender="oppContent,paymentPostpaidInfo,frmAddPaymentELPostpaid,pnlPaymentList,dtbPaymentList"   >
											<a4j:actionparam name="navModule" value="el" />
											<a4j:actionparam name="navProgram" value="SEMMEL006-3" />
											<a4j:actionparam name="moduleWithNavi" value="el" />
											<a4j:actionparam name="actionWithNavi" value="SEMMEL006" />
											<a4j:actionparam name="methodWithNavi" value="doAddELPostpaidToModel" />
											</a4j:commandButton>										
											<rich:spacer width="5"/>
											...
											action="#{navAction.navi}"  reRender="oppContent,paymentPostpaidInfo,frmAddPaymentELPostpaid"   >
											<a4j:actionparam name="navModule" value="el" />
											<a4j:actionparam name="navProgram" value="SEMMEL006-3" />
											<a4j:actionparam name="moduleWithNavi" value="el" />
											<a4j:actionparam name="actionWithNavi" value="SEMMEL006" />
											<a4j:actionparam name="methodWithNavi" value="doUPdateELPostpaidToModel" />
											</a4j:commandButton>	
											...
											reRender="oppContent,paymentPostpaidInfo,frmAddPaymentELPostpaid"   >
											<a4j:actionparam name="navModule" value="el" />
											<a4j:actionparam name="navProgram" value="SEMMEL006-3" />
											<a4j:actionparam name="moduleWithNavi" value="el" />
											<a4j:actionparam name="actionWithNavi" value="SEMMEL006" />
						           		...
						           		<a4j:commandButton id="btnElGroup" style=" width : 110px;" value="#{jspMsg['btn.recentlyElGroupMeter']}" 
												...
												<a4j:actionparam name="groupFlagType" value="EL"/>
										</a4j:commandButton>
						           		<rich:spacer width="5"/>
						           		<a4j:commandButton id="btnPercentGrowth" style=" width : 130px;" value="Verify Percent Growth" styleClass="rich-button" 
											...
											disabled="#{semmel006Bean.popupSiteCriteria.contractNo==null?true:false}">									
											<a4j:actionparam name="navModule" value="el" />
											<a4j:actionparam name="navProgram" value="SEMMEL006-3" />
											<a4j:actionparam name="moduleWithNavi" value="el" />
											<a4j:actionparam name="actionWithNavi" value="SEMMEL006" />
											...
											<a4j:actionparam name="percentKwhNew" value="#{semmel006Bean.paymentDetail.kwhTotalStr}"/>
											<a4j:actionparam name="percentUnitNew" value="0"/>
											<a4j:actionparam name="percentAmtNew" value="#{semmel006Bean.paymentDetail.payAmt}"/>
											<a4j:actionparam name="percentType" value="EL"/>
						...
						<h:panelGrid width="90%" border="0" cellpadding="0" cellspacing="1">
							...
							<table width="100%">
									<tr>
										...
										<td width="25%">
											<h:inputText value="#{semmel006Bean.payment.excludeVatAmt}" styleClass="ms7" disabled="true">
											<f:convertNumber pattern="#,##0.00" maxIntegerDigits="13" maxFractionDigits="2" />
											</h:inputText>
											<rich:spacer width="5"/>
											<h:outputText value="#{jspMsg['label.baht']}" styleClass="ms7"/>
									...
									<tr>
										...
										<td width="25%">
											<h:inputText value="#{semmel006Bean.payment.includeVatAmt}" styleClass="ms7" disabled="true">
											<f:convertNumber pattern="#,##0.00" maxIntegerDigits="13" maxFractionDigits="2" />
											</h:inputText>
											<rich:spacer width="5"/>
											<h:outputText value="#{jspMsg['label.baht']}" styleClass="ms7"/>
	...
	<!--  Start Payment Model List  -->
				...
				<h:panelGrid  width="90%">
					<rich:panel id="pnlPaymentList" styleClass="sem_autoScrollbar">
						<f:facet name="header" >
							<h:outputText value="#{jspMsg['header.paymentList']}" style="width: 100%"/>
						</f:facet>
						 <rich:dataTable id="dtbPaymentSrch" cellpadding="1" cellspacing="0" border="0"
							var="paymentDetail" value="#{semmel006Bean.paymentDetailList}" reRender="dtbPaymentList" 
							rowKeyVar="rowIndex"
							...
							<rich:column>
								...
								<div align="center">
	            					<a4j:commandButton oncomplete="#{rich:component('mdpConfirmEditDialog')}.show(); return false" 
										...
										<a4j:actionparam name="moduleWithNavi" value="el"/>
										<a4j:actionparam name="actionWithNavi" value="SEMMEL006" />
										<a4j:actionparam name="methodWithNavi" value="initUPdateELPostpaidFromModel" />
							...
							<rich:column rendered="#{!semmel006Bean.comeFromPage8}">
								...
								<div align="center">								
	            					<a4j:commandButton oncomplete="#{rich:component('mdpConfirmDelDialog')}.show(); return false" 
										...
										<a4j:actionparam name="moduleWithNavi" value="el" />
										<a4j:actionparam name="actionWithNavi" value="SEMMEL006" />
										<a4j:actionparam name="methodWithNavi" value="initDeleteELPostpaidFromModel" />
										<a4j:actionparam name="rowIndex" value="#{rowIndex}" />										
	            					</a4j:commandButton>	            					          							
								</div>									
							</rich:column>							
							...
							<rich:column>
								...
								<div align="center">
									<h:outputText value="#{semmel006Bean.payment.refDocDt}">
									<f:convertDateTime type="date" pattern="dd/MM/yyyy" locale="th" dateStyle="medium" />
									</h:outputText>
								</div>
							</rich:column>																													
							...
							<rich:column>
								...
								<div align="center">
									<h:outputText value="#{paymentDetail.pDateTH}">
									<f:convertDateTime type="date" pattern="dd/MM/yyyy" locale="th" dateStyle="medium" />
									</h:outputText>
								</div>
							</rich:column>
							<rich:column>
								...
								<div align="center">
									<h:outputText value="#{paymentDetail.lDateTH}">
									<f:convertDateTime type="date" pattern="dd/MM/yyyy" locale="th" dateStyle="medium" />
									</h:outputText>
								</div>
							</rich:column>
							<rich:column>
								...
								<div align="center">
									<h:outputText value="#{paymentDetail.pRead}"/>
								</div>
							</rich:column>
							<rich:column>
								<f:facet name="header">
								...
								<div align="center">
									<h:outputText value="#{paymentDetail.lRead}"/>
								</div>
							</rich:column>				
							<rich:column>
								<f:facet name="header">
							...
							<f:facet name="footer">
								<rich:datascroller immediate="true" rendered="true" align="left" for="dtbPaymentSrch" 
									maxPages="10" id="dstRentalPaySrch" selectedStyleClass="selectScroll" 
	...
	<!--  End Payment Model List -->
		...
		<jsp:include page="../../pages/el/semmel006-popupSearchSite.jsp" />		
...
<rich:modalPanel id="mdpConfirmDelDialog" autosized="true">
	<f:facet name="header">
		<h:outputText value="Confirm Message"></h:outputText>
	</f:facet>
			...
			<tr>
				<td><h:panelGrid columns="2" styleClass="contentlabelform">
					<a4j:commandButton value="Yes" styleClass="rich-button"
						...
						<a4j:actionparam name="moduleWithNavi" value="el" />
						<a4j:actionparam name="actionWithNavi" value="SEMMEL006"/>
						<a4j:actionparam name="methodWithNavi" value="doDeleteELPostpaidFromModel" />
		...
		<table width="200px" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td><h:panelGrid columns="2" styleClass="contentlabelform">
					<a4j:commandButton value="Yes" styleClass="rich-button"
						action="#{navAction.navi}" immediate="true"
						reRender="oppContent,paymentPostpaidInfo,frmAddPaymentELPostpaid, pnlPaymentList">
						<a4j:actionparam name="navModule" value="el" />
						<a4j:actionparam name="navProgram" value="SEMMEL006-3" />
						<a4j:actionparam name="moduleWithNavi" value="el" />
						<a4j:actionparam name="actionWithNavi" value="SEMMEL006"/>
						<a4j:actionparam name="methodWithNavi" value="doUPdateELPostpaidFromModel" />
