...
<f:loadBundle basename="resources.el.semmel001-6" var="jspMsg" />
<h:panelGrid width="100%">

	<rich:panel id="pnlBGMeaPea">
									...
									<tr>
										...
										<td width="25%">
											<rich:calendar id="dtStartDt"
												...
												oninputblur="validateRichCalendarFromTo('frmBGMeaPea','dtStartDt','dtEndDt');"
									 			oncollapse="validateRichCalendarFromTo('frmBGMeaPea','dtStartDt','dtEndDt');"
										...
										<td width="30%">
											<rich:calendar id="dtEndDt"
												...
												oninputblur="validateRichCalendarFromTo('frmBGMeaPea','dtEndDt','dtStartDt');"
									 			oncollapse="validateRichCalendarFromTo('frmBGMeaPea','dtEndDt','dtStartDt');"
												showWeeksBar="false" inputSize="18"/>
										</td>
									</tr>
									<tr>
										...
										<td width="25%" colspan="3">
											<h:inputText id="txtCoverageMoney" value="#{semmel001Bean.wrapper.bgMaster.bgAmt}"
												...
												<rich:column>
													...
													<div align="center">
														<a4j:commandLink value="#{jspMsg['label.delete']}" action="#{navAction.navi}" reRender="pnlFileList">
															<a4j:actionparam name="navModule" value="el" />
							            					<a4j:actionparam name="navProgram" value="SEMMEL001-6" />	
															<a4j:actionparam name="moduleWithNavi" value="el" />
															<a4j:actionparam name="actionWithNavi" value="SEMMEL001" />
