		...
		<h:panelGrid columnClasses="gridContent" width="100%">
						...
						<h:panelGrid width="90%" border="0" cellpadding="0" cellspacing="1">
							<h:panelGroup>
								<table width="100%">									
									...
									<tr>
										<td align="right" width="20%">
											<h:outputText value="#{jspMsg['label.uploadtotal']}" styleClass="ms7"/>
										</td><td width="30%">
											<h:inputText id="txtTotalupload" value="" disabled="true"
												style="width:180px;" maxlength="15">
											</h:inputText>
										</td><td align="right" width="20%">
											<h:outputText value="#{jspMsg['label.uploadfailtotal']}" styleClass="ms7" />
											
										</td>
										<td width="30%">
											<h:inputText id="txtTotalUploadfail" value="" disabled="true"
												style="width:180px;" maxlength="15" >
				...
				<h:panelGrid width="90%">
					<rich:panel id="pnlSearchCriteria2">
						<f:facet name="header">
							<h:outputText value="#{jspMsg['header.meterandcontDetail']}" />
						</f:facet>
						<!-- begin content criteria -->
						<h:panelGrid width="90%" border="0" cellpadding="0" cellspacing="1">
							<h:panelGroup>
								<table width="100%">									
									<tr>
										<td align="right" width="20%">
											...
											<h:inputText id="txtcontNo" value="#{semmel005Bean.validateFailNewSP.contractNo}" 
												style="width:180px;" maxlength="15" disabled="true"/>
										</td><td align="right" width="20%">
											<h:outputText value="#{jspMsg['label.ELuseType']}" styleClass="ms7"/>
										</td><td width="30%">
											<h:inputText id="txtuseType" value="#{semmel005Bean.validateFailNewSP.electricUseType}" 
												style="width:180px;" maxlength="15" disabled="true"/>
										</td>
									</tr>
									<tr>
									...
									<tr>
										<td align="right" width="20%">
											...
											<h:inputText id="txtmeterType" value="#{semmel005Bean.validateFailNewSP.meterType}" 
												style="width:180px;" maxlength="15" disabled="true"/>
										</td><td align="right" width="20%">
											<h:outputText value="#{jspMsg['label.areaName']}" styleClass="ms7"/>
										</td><td width="30%">
											<h:inputText id="txtareaName" value="#{semmel005Bean.uploadText.areaName}" 
												style="width:180px;" maxlength="15" disabled="true"/>
										</td>
									</tr>
									<tr>
										...
										<td>
											<h:inputText id="txtregion" value="#{semmel005Bean.uploadText.region.rowId}" 
												style="width:180px;" maxlength="15" disabled="true"/>
										</td>
										<td align="right" width="20%">
									...
									<tr>
										...
										<td>
											<h:inputText id="txtamphur" value="#{semmel005Bean.uploadText.amphur.thaiName}" 
												style="width:180px;" maxlength="15" disabled="true"/>
										</td>
										<td align="right" width="20%"></td>
										<td width="30%"></td>
									...
									<tr>
										...
										<td>
											<h:inputText id="txtstartdt" value="#{semmel005Bean.validateFailNewSP.contractStartDtStr}" 
												style="width:180px;" maxlength="15" disabled="true">
											</h:inputText>
										</td>
										<td align="right" width="20%"><h:outputText value="#{jspMsg['label.endDT']}" styleClass="ms7"/></td>
										<td width="30%">
											<h:inputText id="txtenddt" value="#{semmel005Bean.validateFailNewSP.contractEndDtStr}" 
											style="width:180px;" maxlength="15" disabled="true">
											</h:inputText>
										</td>
									</tr>
									<tr>
										...
										<td>
											<h:inputText value="#{semmel005Bean.dataDetailSP.contractStatus}" 
												style="width:180px;" disabled="true">
											</h:inputText>
										</td>
										<td align="right" width="20%"><h:outputText value="#{jspMsg['label.networkStatus']}" styleClass="ms7"/></td>
										<td width="30%">
											<h:inputText value="#{semmel005Bean.dataDetailSP.networkStatus}" 
											style="width:180px;" disabled="true">
											</h:inputText>
										</td>
									</tr>
									<tr>
										<td align="right" width="20%">
											<h:outputText value="#{jspMsg['label.elperiod']}" styleClass="ms7"/>
										</td>
										<td>
											<h:inputText value="" 
												style="width:180px;" maxlength="15" disabled="true">
										...
										<td align="right" width="20%"><h:outputText value="#{jspMsg['label.lkwhperioid']}" styleClass="ms7"/></td>
										<td width="30%">
											<h:inputText value="" 
											style="width:180px;" maxlength="15" disabled="true">
											</h:inputText>
									...
									<tr>
										<td align="right" width="20%">
											<h:outputText value="#{jspMsg['label.elpayperiod']}" styleClass="ms7"/>
										</td>
										<td>
											<h:inputText value="" 
												style="width:180px;" maxlength="15" disabled="true">
				...
				<h:panelGrid width="90%">
					<rich:panel id="pnlSearchCriteria3">
						<f:facet name="header">
							<h:outputText value="#{jspMsg['header.fileinfoDetail']}" />
						</f:facet>
						<!-- begin file info detail -->
						<h:panelGrid width="90%" border="0" cellpadding="0" cellspacing="1">
							<h:panelGroup>
								<table width="100%">									
									<tr>
										<td align="right" width="20%">
											...
											<h:inputText value="#{semmel005Bean.uploadText.meterId}" 
												style="width:180px;"  disabled="true"/>
										</td><td align="right" width="20%">
											<h:outputText value="#{jspMsg['label.meterType']}" styleClass="ms7"/>
										</td><td width="30%">
											<h:inputText value="#{semmel005Bean.uploadText.meterType}" 
												style="width:180px;" disabled="true"/>
										</td>
									</tr>
									<tr>
										...
										<td>
											<h:inputText value="#{semmel005Bean.uploadText.txtPDtTH}" 
												style="width:180px;" disabled="true">
											</h:inputText>
										</td>
										<td align="right" width="20%"><h:outputText value="#{jspMsg['label.lDt']}" styleClass="ms7"/></td>
										<td width="30%">
											<h:inputText  value="#{semmel005Bean.uploadText.txtLDtTH}" 
											style="width:180px;"disabled="true">
											</h:inputText>
										</td>
									</tr>
									<tr>
										<td align="right" width="20%">
											<h:outputText value="#{jspMsg['label.pkwh']}" styleClass="ms7"/>
										</td>
										<td>
											<h:inputText value="#{semmel005Bean.uploadText.pRead}" 
												style="width:180px;" disabled="true">
											</h:inputText>
										</td>
										<td align="right" width="20%"><h:outputText value="#{jspMsg['label.lkwh']}" styleClass="ms7"/></td>
										<td width="30%">
											<h:inputText value="#{semmel005Bean.uploadText.lRead}" 
											style="width:180px;" disabled="true">
											</h:inputText>
										</td>
									</tr>
									<tr>
										...
										<td>
											<h:inputText value="#{semmel005Bean.uploadText.kwhTotal}" 
												style="width:180px;" disabled="true">
												<f:convertNumber pattern="#,##0.00"/>
											</h:inputText>
										</td>
										<td align="right" width="20%"><h:outputText value="#{jspMsg['label.ct']}" styleClass="ms7"/></td>
										<td width="30%">
											<h:inputText value="#{semmel005Bean.uploadText.ct}" 
											style="width:180px;"  disabled="true">
											</h:inputText>
										</td>
									</tr>
									<tr>
										<td align="right" width="20%">
											<h:outputText value="#{jspMsg['label.elpayment']}" styleClass="ms7"/>
										</td>
										<td>
											<h:inputText value="#{semmel005Bean.uploadText.elAmt}" 
												style="width:180px;" disabled="true">
												<f:convertNumber pattern="#,##0.00"/>
											</h:inputText>
										</td>
										<td align="right" width="20%"><h:outputText value="VAT :" styleClass="ms7"/></td>
										<td width="30%">
											<h:inputText value="#{semmel005Bean.uploadText.invVatAmt}" 
											style="width:180px;" disabled="true">
												<f:convertNumber pattern="#,##0.00"/>
											</h:inputText>
										</td>
									...
									<tr>
										<td align="right" width="20%">
											<h:outputText value="#{jspMsg['label.elpaymentincvat']}" styleClass="ms7"/>
										</td>
										<td>
											<h:inputText value="#{semmel005Bean.uploadText.invAmt}" 
												style="width:180px;"  disabled="true">
												<f:convertNumber pattern="#,##0.00"/>
											</h:inputText>
										</td>
										<td align="right" width="20%"><h:outputText value="#{jspMsg['label.ftamt']}" styleClass="ms7"/></td>
										<td width="30%">
											<h:inputText value="" 
											style="width:180px;" maxlength="15" disabled="true">
											</h:inputText>
									...
									<tr>
										<td align="right" width="20%">
											<h:outputText value="#{jspMsg['label.pfactor']}" styleClass="ms7"/>
										</td>
										<td>
											<h:inputText value="" 
												style="width:180px;" maxlength="15" disabled="true">
										...
										<td align="right" width="20%"><h:outputText value="#{jspMsg['label.onpeak']}" styleClass="ms7"/></td>
										<td width="30%">
											<h:inputText value="#{semmel005Bean.uploadText.kwhOn}" 
											style="width:180px;" disabled="true">
											</h:inputText>
										</td>
									</tr>
									<tr>
										<td align="right" width="20%">
											<h:outputText value="#{jspMsg['label.offpeak']}" styleClass="ms7"/>
										</td>
										<td>
											<h:inputText value="#{semmel005Bean.uploadText.kwhOff}" 
												style="width:180px;"  disabled="true">
											</h:inputText>
										</td>
										<td align="right" width="20%"><h:outputText value="#{jspMsg['label.holidaypeak']}" styleClass="ms7"/></td>
										<td width="30%">
											<h:inputText value="" 
											style="width:180px;" maxlength="15" disabled="true">
											</h:inputText>
									...
									<tr>
										...
										<td colspan="3">
											...
											<h:outputText value="#{jspMsg['label.trues']}" styleClass="ms7" rendered="false"/>
											
											<rich:spacer width="80"></rich:spacer>
											<h:selectBooleanCheckbox rendered="false"></h:selectBooleanCheckbox>
											<h:outputText value="#{jspMsg['label.nopaylist']}" styleClass="ms7" rendered="false"/>
										</td>
										
									</tr>
									<tr>
										<td align="right" width="20%" valign="top">
											<h:outputText value="#{jspMsg['label.feilmsg']}" styleClass="ms7"/>
										</td>
										<td colspan="3">
											<h:inputTextarea rows="5" style="width:80%;" 
											value="#{semmel005Bean.uploadText.errorDesc}">
											</h:inputTextarea>
										</td>
				...
				<h:panelGrid width="90%">
					<rich:panel id="pnlInvalidPeriod">
						<f:facet name="header">
							<h:outputText value="#{jspMsg['label.invalidPeriod']}" />
						</f:facet>
						<!-- begin content criteria -->
						<h:panelGrid width="90%" border="0" cellpadding="0" cellspacing="1">
							<h:panelGroup>
								<table width="100%"  border="0">									
									<tr>
										...
										<td width="30%">
											<h:selectBooleanCheckbox value="#{semmel005Bean.periodFlag}" style="width: 20px">
											</h:selectBooleanCheckbox>
											<h:outputText value="#{jspMsg['label.notChcek']}" styleClass="ms7"/>
										</td>
										<td align="right" width="20%">
							...
							<h:panelGroup>
								<table width="100%"  border="0">									
									...
									<tr>
										...
										<td align="right" >
											<h:outputText value="#{jspMsg['label.ct']}" styleClass="ms7"></h:outputText>
										</td>
										<td>
				...
				<h:panelGrid width="90%">
					<rich:panel id="pnlContractStatusInActive">
						<f:facet name="header">
							<h:outputText value="#{jspMsg['label.contractstatusinactive']}" />
						</f:facet>
						<!-- begin content criteria -->
						<h:panelGrid width="90%" border="0" cellpadding="0" cellspacing="1">
							<h:panelGroup>
								<table width="100%">									
									<tr>
										...
										<td>
										    <h:selectBooleanCheckbox value="#{semmel005Bean.contStatusInactiveFlag}" style="width: 20px">
				...
				<h:panelGrid width="90%">
					<rich:panel id="pnlNetworkStatusInActive">
						<f:facet name="header">
							<h:outputText value="#{jspMsg['label.networkstatusinactive']}" />
						</f:facet>
						<!-- begin content criteria -->
						<h:panelGrid width="90%" border="0" cellpadding="0" cellspacing="1">
							<h:panelGroup>
								<table width="100%">									
									<tr>
										...
										<td>
										    <h:selectBooleanCheckbox value="#{semmel005Bean.networkStatusInactiveFlag}" style="width: 20px">
				...
				<h:panelGrid width="90%">
					<rich:panel id="pnlInvalidGrowth">
						<f:facet name="header">
							<h:outputText value="#{jspMsg['label.growth']}" />
						</f:facet>
						<!-- begin content criteria -->
						<h:panelGrid width="90%" border="0" cellpadding="0" cellspacing="1">
							<h:panelGroup>
								<table width="100%">									
									<tr>
										...
										<td>
										    <h:selectBooleanCheckbox value="#{semmel005Bean.growthFlag}" style="width: 20px">
