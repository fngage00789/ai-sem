		...
		<rich:panel>
				...
				<h:panelGrid  id="grdPopupSearchResult">
					<rich:panel id="pnlPopupSearchPostpaidResult">
						...
						value="#{semmel006Bean.managePopUpSearchResult}" rows="5" 
						rowKeyVar="RegInd" var="manage" 
						...
						<rich:column id="siteCheck" width="50">
							...
							<div align="center">
								<sem:radioButton id="rdBtSel" name="rdCol"	overrideName="true"	value="#{semmel006Bean.selectedRadio}"
			  							itemValue="#{manage.rowId}"/>
							</div>
						</rich:column>							
						<rich:column >
							<f:facet name="header">
								<h:outputText value="#{jspMsg['header.popup.searchSite.contractNo']}" styleClass="contentform" />
							</f:facet>
							<div align="center">
								<h:outputText value="#{manage.contractNo}" styleClass="contentform"  />
							</div>
						</rich:column>											
						<rich:column >
								<f:facet name="header">
									<h:outputText value="#{jspMsg['header.popup.searchSite.siteName']}" styleClass="contentform" />
								</f:facet>
								<div align="left">
									<h:outputText value="#{manage.siteName}" styleClass="contentform"  />
								</div>
						</rich:column>
				...
				<a4j:commandButton  id="btnSiteAddBySelect" styleClass="rich-button" 
									...
									value="Save" 
									reRender="contractInfo,popupFrmSearch,popupFrmError,paymentPostpaidInfo" disabled="#{semmel006Bean.savePopupSiteDisable}">
					<a4j:actionparam name="navModule" value="el" />
