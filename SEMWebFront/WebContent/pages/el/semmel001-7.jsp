...
<f:loadBundle basename="resources.el.semmel001-7" var="jspMsg" />
<h:panelGrid width="100%">

	<rich:panel id="pnlPayment007">
								...
								<table width="100%">
									...
									<tr>
										...
										<td width="30%"><h:selectOneMenu id="detailPaymentMethod"
											...
											<a4j:support event="onchange"
												action="#{semmel001Action.doChangePaymentType07}"
												reRender="pnlDetail" />
										</h:selectOneMenu></td>
									...
									<tr>
										<td align="right" width="20%">
											<h:graphicImage value="images/icon_required.gif" rendered="#{semmel001Bean.fbankNameInputVisible}"/>
											<rich:spacer width="5" rendered="#{semmel001Bean.fbankNameInputVisible}"/>
							...
							<h:panelGroup>
								<table width="100%">
									...
									<tr>
										...
										<td width="30%">
											<h:inputText size="18" maxlength="15" disabled="true" value="#{semmel001Bean.manageWrapper.electricPaymentDetail.excludeVatAmt }" style="width : 160px; text-align:right">
												...
												<tr>
													<td>
														<a4j:commandButton id="btnAdd" value="Add"
															...
															<a4j:actionparam name="moduleWithNavi" value="el" />
															<a4j:actionparam name="actionWithNavi" value="SEMMEL001" />
															<a4j:actionparam name="methodWithNavi" value="doAdd07" />
															<a4j:actionparam name="page" value="07" />
														</a4j:commandButton>
													</td>
													<td>
														<a4j:commandButton id="btnUpdate" value="Update"
															...
															<a4j:actionparam name="moduleWithNavi" value="el" />
															<a4j:actionparam name="actionWithNavi" value="SEMMEL001" />
															<a4j:actionparam name="methodWithNavi" value="doUpdate07" />
															<a4j:actionparam name="page" value="7" />
														</a4j:commandButton>
													</td>
													<td>
														<a4j:commandButton id="btnClear" value="Clear"
															...
															<a4j:actionparam name="moduleWithNavi" value="el" />
															<a4j:actionparam name="actionWithNavi" value="SEMMEL001" />
															<a4j:actionparam name="methodWithNavi" value="doClear07" />
														</a4j:commandButton>
													</td>
												</tr>
											</table>
							...
							<rich:dataTable id="dtbElecMeterCash" width="100%"
								...
								<rich:column width="5%">
									...
									<div align="center"><a4j:commandButton
										...
										action="#{navAction.navi}" reRender="mdpConfirmEditDialog"
										title="edit">
										<a4j:actionparam name="navModule" value="el" />
										<a4j:actionparam name="navProgram" value="SEMMEL001-7" />
										<a4j:actionparam name="moduleWithNavi" value="el" />
										<a4j:actionparam name="actionWithNavi" value="SEMMEL001" />
										<a4j:actionparam name="methodWithNavi" value="doInitEdit07" />
								...
								<rich:column width="5%">
									...
									<div align="center"><a4j:commandButton
										...
										<a4j:actionparam name="moduleWithNavi" value="el" />
										<a4j:actionparam name="actionWithNavi" value="SEMMEL001" />
										<a4j:actionparam name="methodWithNavi" value="initDelete07" />
										<a4j:actionparam name="rowIndex" value="#{rowIndex}" />
										<a4j:actionparam name="page" value="07" />
									</a4j:commandButton></div>
								</rich:column>
							...
							<h:panelGroup>
								<table width="100%">
									...
									<tr>
										...
										<td width="30%"><h:outputText styleClass="ms7" value="#{semmel001Bean.manageWrapper.updateDt }" style="width : 160px">
			...
			<tr>
				<td><h:panelGrid columns="2" styleClass="contentlabelform">
					<a4j:commandButton value="Yes" styleClass="rich-button"
						...
						<a4j:actionparam name="moduleWithNavi" value="el" />
						<a4j:actionparam name="actionWithNavi" value="SEMMEL001" />
						<a4j:actionparam name="methodWithNavi" value="doDelete07" />
						<a4j:actionparam name="page" value="07" />
			...
			<tr>
				<td><h:panelGrid columns="2" styleClass="contentlabelform">
					<a4j:commandButton value="Yes" styleClass="rich-button"
						...
						<a4j:actionparam name="moduleWithNavi" value="el" />
						<a4j:actionparam name="actionWithNavi" value="SEMMEL001" />
						<a4j:actionparam name="methodWithNavi" value="doEdit07" />
						<a4j:actionparam name="page" value="07" />
