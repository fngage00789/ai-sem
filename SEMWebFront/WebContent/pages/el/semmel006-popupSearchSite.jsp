	...
	<h:form id="popupFrmSearch"> 
		...
		<rich:panel>
				            ...
				            <tr>
				                	...
				                	<td align="right"   colspan="1">
										<h:outputText value="#{jspMsg['header.popup.searchSite.meterId']}" styleClass="ms7"/>
		                			</td>
		                			<td   colspan="3">
		                				<h:inputText  value="#{semmel006Bean.popupSiteCriteria.meterId}"/>
				                	</td>
				            ...
				            <tr>
				                	...
				                	<td align="right"   colspan="1">
										<h:outputText value="#{jspMsg['header.popup.searchSite.meterStatus']}" styleClass="ms7"/>
		                			</td>
		                			<td   colspan="3">
			    		                <h:selectOneMenu id="outstandingFlagId"  value="#{semmel006Bean.popupSiteCriteria.outstandingFlag}"  style="width:120px;">
											<f:selectItems value="#{semmel006Bean.recordStatusList}"/>
										</h:selectOneMenu>
				                	</td>
			                </tr>		
			                	 <tr>
								...
								<h:panelGroup>
									...
									action="#{navAction.navi}" reRender="popupFrmSearch,btnSiteAddBySelect,dtbPopupSite,pnlPopupSearchPostpaidResult,pnlPopupSearchCriteria,popupFrmError" >
									...
									<a4j:actionparam name="methodWithNavi" value="doSearchSiteELPostpaid" />
									</a4j:commandButton>
									...
									<a4j:actionparam name="moduleWithNavi" value="el" />
									<a4j:actionparam name="actionWithNavi" value="SEMMEL006" />
									<a4j:actionparam name="methodWithNavi" value="doClearSearchSiteELPostpaid" />
					           		</a4j:commandButton>
								</h:panelGroup>
			                	 </td>
			                	 </tr>
				...
				<h:panelGrid  id="grdPopupSearchResult">
					<rich:panel id="pnlPopupSearchPostpaidResult">
						...
						<rich:column >
								<f:facet name="header">
									<h:outputText value="#{jspMsg['column.header.meterStatus']}" styleClass="contentform" />
								</f:facet>
								<div align="left">
									<h:outputText value="#{popupSite.meterStatus}" styleClass="contentform"  />
								</div>
						</rich:column>
				...
				<h:panelGrid columns="2">
					<a4j:commandButton  id="btnSiteAddBySelect" styleClass="rich-button" 
										...
										value="Save" 
										reRender="oppContent,contractInfo,popupFrmSearch,popupFrmError,paymentPostpaidInfo,pnlBtnPercentGroup,btnElGroup,btnPercentGrowth" disabled="#{semmel006Bean.savePopupSiteDisable}">
						<a4j:actionparam name="navModule" value="el" />
            			<a4j:actionparam name="navProgram" value="SEMMEL006-3" />	
						<a4j:actionparam name="moduleWithNavi" value="el" />
						<a4j:actionparam name="actionWithNavi" value="SEMMEL006" />
						<a4j:actionparam name="methodWithNavi" value="doAddSiteELPostpaid" />	
