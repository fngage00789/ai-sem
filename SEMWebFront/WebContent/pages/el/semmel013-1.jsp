...
<f:loadBundle basename="resources.el.semmel013-1" var="jspMsg" />
		...
		<h:panelGrid columns="4" id="grdSearchCommand2" width="98%">
			...
			<div align="right">
						<a4j:commandButton id="btnImport"  value="#{jspMsg['btn.back']}" action="#{navAction.navi}" 
							...
							rendered="#{semmel003Bean.renderer['btnImport']}">
							...
							<h:panelGroup>
								<table width="100%">
									<tr>
										...
										<td  valign="bottom">
											<h:selectOneMenu id="ddlCompany" value="#{semmel013Bean.companyPage2}" onchange="GetCompanyJS();" style="width:180px;">
												<f:selectItems value="#{semmel013Bean.companyListPage2}" />
											</h:selectOneMenu>
											<a4j:jsFunction name="GetCompanyJS" reRender="companyDisplay" /><rich:spacer width="10"></rich:spacer> 
											<h:outputText id="companyDisplay" value="#{semmel013Bean.companyPage2}" styleClass="ms28" />
										</td>
										...
										<td width="20%">
											<h:selectOneMenu id="searchRegion" value="#{semmel013Bean.regionPage2}" style="width : 180px">
		                						<f:selectItems value="#{semmel013Bean.regionListPage2}" />
		                					</h:selectOneMenu>
										</td>
									</tr>
									<tr>
										...
										<td width="30%">
											<h:selectOneMenu id="ddlTypeUseElectric" value="#{semmel013Bean.typeUseElectricPage2}"  style="width:180px;">
												<f:selectItems value="#{semmel013Bean.typeUseElectricListPage2}" />
												<a4j:support event="onchange" action="#{semmel013Action.doChangeElectricUseTypePage2}" reRender="searchReqType, searchProcessStatus" />
											</h:selectOneMenu>
										</td>
										<td align="right" width="20%">
										...
										<td>
											<a4j:region>
											<h:selectOneMenu id="searchReqType" value="#{semmel013Bean.reqTypePage2}" style="width : 200px">
			                					<f:selectItems value="#{semmel013Bean.reqTypeListPage2}" />
			                					<a4j:support event="onchange" action="#{semmel013Action.doChangeElActionPage2}" reRender="searchProcessStatus" />
			                				</h:selectOneMenu>
			                				<rich:spacer width="5"/>
			                				</a4j:region>
										</td>
									...
									<td>	
									<h:selectOneMenu id="searchProcessStatus" value="#{semmel013Bean.processStatusCodePage2}" 
											style="width : 200px">
		                						<f:selectItems value="#{semmel013Bean.processStatusNameListPage2}" />
		                					</h:selectOneMenu>
		                					</td>
		                			</tr>
									<tr>
										...
										<td align="left" width="20%"><rich:calendar id="cldDtFrom" locale="th/TH" enableManualInput="true"
															datePattern="dd/MM/yyyy" value="#{semmel013Bean.uploadFileDtFromPage2}"
															showWeeksBar="false" 
					                                       inputSize="13" 
											...
											<rich:calendar id="cldDtTo" locale="th/TH" enableManualInput="true"
															datePattern="dd/MM/yyyy" value="#{semmel013Bean.uploadFileDtToPage2}"
															showWeeksBar="false" 
					                                       inputSize="13" 
					                                       oninputkeypress="return numberformat.keyPressFormatDateOnly(this, event);"
					                                       cellWidth="20px" cellHeight="20px"
										...
										<td width="40%">
											<h:inputText id="txtFileName" value="#{semmel013Bean.fileNamePage2}" style="width:300px;" maxlength="150" />
										</td>
									</tr>
								</table>
							</h:panelGroup>
			...
			<a4j:form id="frmResult">
				...
				<h:panelGrid width="100%">
					<rich:panel id="pnlSearchResult" styleClass="sem_autoScrollbar">
						...
						<div align="center">
                            <h:outputLabel style="color:red;size:20px" value="#{semmel013Bean.msgDataNotFoundSecondPage}" rendered="#{semmel013Bean.renderedMsgDataNotFoundSecondPage}" />
                        </div>
						<!-- begin dataTable -->
						<rich:dataTable id="dtbSiteApprove" width="100%" cellpadding="1"
							cellspacing="0" border="0" var="warrantDetail" value="#{semmel013Bean.uploadFileList}"
							...
							<rich:column sortBy="#{warrantDetail.fileName}" >
								<f:facet name="header">
									<h:outputText value="#{jspMsg['column.fileName']}" style="width ::200px;;"/>
								</f:facet>
								<div align="left" style="width :200px;">
								<h:outputText value="#{warrantDetail.fileName}" />
								</div>
							</rich:column>
								...
								<rich:columnGroup>
                                    <rich:column colspan="4">
                                        <h:outputFormat value="#{msg['message.totalRecords']}">
                                            <f:param value="#{fn:length(semmel013Bean.uploadFileList)}"></f:param>
                                        </h:outputFormat>
                                    </rich:column>
