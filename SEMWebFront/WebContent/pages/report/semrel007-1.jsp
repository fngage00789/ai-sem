...
<f:loadBundle basename="resources.report.semrel007" var="jspMsg"/>
					...
					<rich:panel id="pnlSearchCriteria">
								...
								<table id="dtbSearchCriteria" border="0" 
									...
									<tr>
					             		...
					             		<td align="left" width="5%" valign="bottom">
											...
											<h:selectOneMenu id="ddlCompany" value="#{semrel007Bean.company}" 
											styleClass="ms7" style="width:180px;">
												<f:selectItems value="#{semrel007Bean.companyList}"/>
											</h:selectOneMenu>
					               		</td>
					             		...
					             		<td align="left" valign="bottom">
					             			<rich:spacer width="5px"></rich:spacer>
											<h:selectOneMenu id="ddlElectricUseType" value="#{semrel007Bean.electricUseType}" 
											styleClass="ms7" style="width:180px;">
												<f:selectItems value="#{semrel007Bean.electricUseTypeList}"/>
											</h:selectOneMenu>
					               		</td>
									</tr>
									<tr>
					             		...
					             		<td align="left" width="5%" valign="bottom">
					             			<rich:spacer width="5px"></rich:spacer>
											<h:selectOneMenu id="ddlRegion" value="#{semrel007Bean.region}" 
											styleClass="ms7" style="width:180px;">
												<f:selectItems value="#{semrel007Bean.regionList}"/>
											</h:selectOneMenu>
					               		</td>
					             		...
					             		<td align="left" width="5%" valign="bottom">
					             			<rich:spacer width="5px"></rich:spacer>
											<h:selectOneMenu id="ddlYear" value="#{semrel007Bean.year}" 
											styleClass="ms7" style="width:180px;">
												<f:selectItems value="#{semrel007Bean.yearList}"/>
											</h:selectOneMenu>
					               		</td>
									...
									<tr>
					             		...
					             		<td align="left" width="5%" valign="bottom">
											...
											value="#{semrel007Bean.siteStatus}" 
											styleClass="ms7" style="width:180px;">
												<f:selectItems value="#{semrel007Bean.siteStatusList}"/>
											</h:selectOneMenu>
					               		</td>
					               		
						               	<td align="right" width="25%" valign="bottom">
											
											<h:outputText value="#{jspMsg['label.groupByLocation']}" styleClass="ms7"></h:outputText>
		                				</td>
					             		
					             		<td align="left" width="5%" valign="bottom">
					             			<h:selectBooleanCheckbox value="#{semrel007Bean.groupBylocation}" />
					               		</td>
						...
						<h:panelGrid columns="2" id="pnlGridCommand">
							<a4j:commandButton id="btnRun" style="width:90px" styleClass="rich-button"
								...
								<a4j:actionparam name="navProgram" value="SEMREL007-1" />
								<a4j:actionparam name="moduleWithNavi" value="report" />
								<a4j:actionparam name="actionWithNavi" value="SEMREL007" />
								<a4j:actionparam name="methodWithNavi" value="doRunReport" />
								
								<a4j:support event="oncomplete" 
								reRender="frmError, frmSearch, pnlShowReport" 
								rendered="#{semrel007Bean.displayShowReport}"/>
							</a4j:commandButton>
						...
						<h:panelGrid id="pnlShowReport" style="height:0px;width:0px;" width="0px" columns="0" >
							<h:panelGroup id="pnlInShowReport" rendered="#{semrel007Bean.displayShowReport}" style="height:0px;width:0px;" >
								<h:commandButton value="Report" id="bthShowReport" style="height:0px;width:0px;display:none;" 
								action="#{semrel007Action.showReport}"  />								
