...
<f:loadBundle basename="resources.report.semrrt001" var="jspMsg"/>
					...
					<rich:panel id="pnlSearchCriteria">
								...
								<table id="dtbSearchCriteria" border="0" 
									...
									<tr>
					             		...
					             		<td align="left" width="25%">
											...
											<h:selectOneMenu id="ddlCompany" value="#{semrrt001Bean.company}" >
												<f:selectItems value="#{semrrt001Bean.companyList}"/>
											</h:selectOneMenu>
					               		</td>
					               		<td width="25%"></td>
					               		<td width="25%"></td>
									...
									<tr>
					             		...
					             		<td align="left" width="25%">
					             			<rich:spacer width="5px"></rich:spacer>
											<h:inputText value="#{semrrt001Bean.year}"  maxlength="4" size="4"></h:inputText>
					               		</td>
					               		<td/>
					               		<td/>
									</tr>
									<tr>
					             		...
					             		<td align="left" width="25%">
					             			<rich:spacer width="5px"></rich:spacer>
											<h:selectOneMenu id="ddlRegion" value="#{semrrt001Bean.region}" >
												<f:selectItems value="#{semrrt001Bean.regionList}"/>
											</h:selectOneMenu>
					               		</td>
					               		<td/>
					               		<td/>
									...
									<tr>
					             		...
					             		<td align="left" width="25%">
					             			<rich:spacer width="5px"></rich:spacer>
											<h:selectOneMenu id="ddlStationType" value="#{semrrt001Bean.stationType}" >
												<f:selectItems value="#{semrrt001Bean.stationTypeList}"/>
											</h:selectOneMenu>
					               		</td>
					               		<td>
					               			
					               			<h:selectBooleanCheckbox value="#{semrrt001Bean.pico}"></h:selectBooleanCheckbox>
					             			<rich:spacer width="5"></rich:spacer>
						...
						<h:panelGrid columns="2" id="pnlGridCommand">
							<a4j:commandButton id="btnRun" style="width:90px" styleClass="rich-button"
								...
								<a4j:actionparam name="navProgram" value="SEMRRT001-1" />
								<a4j:actionparam name="moduleWithNavi" value="report" />
								<a4j:actionparam name="actionWithNavi" value="SEMRRT001" />
								<a4j:actionparam name="methodWithNavi" value="doRunReport" />
								
								<a4j:support event="oncomplete" reRender="frmError, frmSearch, pnlShowReport" rendered="#{semrrt001Bean.displayShowReport}"/>
							</a4j:commandButton>
						...
						<h:panelGrid id="pnlShowReport" style="height:0px;width:0px;" width="0px" columns="0" >
							<h:panelGroup id="pnlInShowReport" rendered="#{semrrt001Bean.displayShowReport}" style="height:0px;width:0px;" >
								<h:commandButton value="Report" id="bthShowReport" style="height:0px;width:0px;display:none;" action="#{semrrt001Action.showReport}"  />								
