...
<f:loadBundle basename="resources.rental.semrsi013" var="jspMsg"/>
								...
								<table id="dtbSearchCriteria" border="0" 
									...
									<tr>
					             		...
					             		<td align="left" width="25%">
											...
											<h:selectOneMenu id="ddlCompany" value="#{semrsi013Bean.company}" >
												<f:selectItems value="#{semrsi013Bean.companyList}"/>
											</h:selectOneMenu>
					               		...
					               		<td width="40%">
						               		<rich:spacer width="5px"></rich:spacer>
						               		<h:inputText id="txtYear"  value="#{semrsi013Bean.year}"   maxlength="4" size="4"/>		
					               		</td>
									</tr>
									...
									<tr>
					             		...
					             		<td align="left" width="25%">
					             			<rich:spacer width="5px"></rich:spacer>
											<h:selectOneMenu id="ddlRegion" value="#{semrsi013Bean.region}"  >
												<f:selectItems value="#{semrsi013Bean.regionList}"/>
											</h:selectOneMenu>
					               		...
					               		<td width="40%">
						               		<rich:spacer width="5px"></rich:spacer>
											<h:selectOneMenu id="ddlMonth" value="#{semrsi013Bean.month}"  >
												<f:selectItems value="#{semrsi013Bean.monthList}"/>
											</h:selectOneMenu>		
					               		</td>
									...
									<tr>
										...
										<td>
					             			<rich:spacer width="5px"></rich:spacer>
											<h:selectOneMenu id="ddlSiteType" value="#{semrsi013Bean.siteType}"  >
												<f:selectItems value="#{semrsi013Bean.siteTypeList}"/>
											</h:selectOneMenu>
										</td>
										<td>
										</td>
									...
									<tr>
					             		...
					             		<td align="left" width="25%" colspan="3">
											...
											<h:selectOneRadio value="#{semrsi013Bean.reportSummaryFlag}" styleClass="ms7" >
...
<!--					               		</td>-->
						...
						<h:panelGrid columns="2" id="pnlGridCommand">
							<a4j:commandButton id="btnRun" style="width:90px" styleClass="rich-button"
								...
								<a4j:actionparam name="navProgram" value="SEMRSI013-1" />
								<a4j:actionparam name="moduleWithNavi" value="report" />
								<a4j:actionparam name="actionWithNavi" value="SEMRSI013" />
								<a4j:actionparam name="methodWithNavi" value="doRunReport" />
								
								<a4j:support event="oncomplete" reRender="frmError, frmSearch, pnlShowReport" rendered="#{semrsi013Bean.displayShowReport}"/>
							</a4j:commandButton>
						...
						<h:panelGrid id="pnlShowReport" style="height:0px;width:0px;" width="0px" columns="0" >
							<h:panelGroup id="pnlInShowReport" rendered="#{semrsi013Bean.displayShowReport}" style="height:0px;width:0px;" >
								<h:commandButton value="Report" id="bthShowReport" style="height:0px;width:0px;display:none;" action="#{semrsi013Action.showReport}"  />								
