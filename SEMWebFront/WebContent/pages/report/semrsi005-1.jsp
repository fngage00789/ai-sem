...
<f:loadBundle basename="resources.rental.semrsi005" var="jspMsg"/>
					...
					<rich:panel id="pnlSearchCriteria">
								...
								<table id="dtbSearchCriteria" border="0" 
									...
									<tr>
					             		...
					             		<td align="left" width="25%">
											...
											<h:selectOneMenu id="ddlCompany" value="#{semrsi005Bean.company}">
												<f:selectItems value="#{semrsi005Bean.companyList}"/>
											</h:selectOneMenu>
					               		</td>
					               		<td width="25%"></td>
					               		<td width="25%"></td>
									...
									<tr>
					             		...
					             		<td align="left" width="25%">
					             			<rich:spacer width="5px"></rich:spacer>
											<h:inputText value="#{semrsi005Bean.year}"  maxlength="4" size="4"></h:inputText>
					               		</td>
					               		<td/>
					               		<td/>
									</tr>
									...
									<tr>
					             		...
					             		<td align="left" width="25%">
					             			<rich:spacer width="5px"></rich:spacer>
											<h:selectOneMenu id="ddlMonthFrom" value="#{semrsi005Bean.fromMonth}" >
												<f:selectItems value="#{semrsi005Bean.monthList}"/>
											</h:selectOneMenu>
											<rich:spacer width="5px"></rich:spacer>
											<h:outputText value="-" styleClass="ms7"/>
											<rich:spacer width="5px"></rich:spacer>
											<h:selectOneMenu id="ddlMonthTo" value="#{semrsi005Bean.toMonth}" >
												<f:selectItems value="#{semrsi005Bean.monthList}"/>
											</h:selectOneMenu>
					               		</td>
					               		<td/>
						...
						<h:panelGrid columns="2" id="pnlGridCommand">
							<a4j:commandButton id="btnRun" style="width:90px" styleClass="rich-button"
								...
								<a4j:actionparam name="navProgram" value="SEMRSI005-1" />
								<a4j:actionparam name="moduleWithNavi" value="report" />
								<a4j:actionparam name="actionWithNavi" value="SEMRSI005" />
								...
								rendered="#{semrsi005Bean.displayShowReport}"/>
							</a4j:commandButton>
						...
						<h:panelGrid id="pnlShowReport" style="height:0px;width:0px;" width="0px" columns="0" >
							<h:panelGroup id="pnlInShowReport" rendered="#{semrsi005Bean.displayShowReport}" style="height:0px;width:0px;" >
								<h:commandButton value="Report" id="bthShowReport" style="height:0px;width:0px;display:none;" action="#{semrsi005Action.showReport}"  />								
