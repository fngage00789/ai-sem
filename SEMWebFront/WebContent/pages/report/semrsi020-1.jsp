...
<f:loadBundle basename="resources.rental.semrsi020" var="jspMsg"/>
					...
					<rich:panel id="pnlSearchCriteria">
								...
								<table id="dtbSearchCriteria" border="0" 
									...
									<tr>
					             		...
					             		<td align="left" width="25%">
											...
											<h:selectOneMenu id="ddlCompany" value="#{semrsi020Bean.company}" >
												<f:selectItems value="#{semrsi020Bean.companyList}"/>
											</h:selectOneMenu>
					               		...
					               		<td width="40%">
						               		<rich:spacer width="5px"></rich:spacer>
						               		<h:inputText id="ddlYear"  value="#{semrsi020Bean.year}"  size="4" maxlength="4"/>		
					               		</td>
									</tr>
									...
									<tr>
					             		...
					             		<td align="left" width="25%">
					             			<rich:spacer width="5px"></rich:spacer>
											<h:selectOneMenu id="ddlRegion" value="#{semrsi020Bean.region}" >
												<f:selectItems value="#{semrsi020Bean.regionList}"/>
											</h:selectOneMenu>
					               		...
					               		<td width="40%">
						               		<rich:spacer width="5px"></rich:spacer>
											<h:selectOneMenu id="ddlMonth" value="#{semrsi020Bean.month}" >
												<f:selectItems value="#{semrsi020Bean.monthList}"/>
											</h:selectOneMenu>		
					               		</td>
									</tr>			
						...
						<h:panelGrid columns="2" id="pnlGridCommand">
							<a4j:commandButton id="btnRun" style="width:90px" styleClass="rich-button"
								...
								<a4j:actionparam name="navProgram" value="SEMRSI020-1" />
								<a4j:actionparam name="moduleWithNavi" value="report" />
								<a4j:actionparam name="actionWithNavi" value="SEMRSI020" />
								<a4j:actionparam name="methodWithNavi" value="doRunReport" />
								
								<a4j:support event="oncomplete" reRender="frmError, frmSearch, pnlShowReport" rendered="#{semrsi020Bean.displayShowReport}"/>
							</a4j:commandButton>
						...
						<h:panelGrid id="pnlShowReport" style="height:0px;width:0px;" width="0px" columns="0" >
							<h:panelGroup id="pnlInShowReport" rendered="#{semrsi020Bean.displayShowReport}" style="height:0px;width:0px;" >
								<h:commandButton value="Report" id="bthShowReport" style="height:0px;width:0px;display:none;" action="#{semrsi020Action.showReport}"  />								
