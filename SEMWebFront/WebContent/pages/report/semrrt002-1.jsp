...
<f:loadBundle basename="resources.report.semrrt002" var="jspMsg"/>
					...
					<rich:panel id="pnlSearchCriteria">
								...
								<table id="dtbSearchCriteria" border="0" 
									...
									<tr>
					             		...
					             		<td align="left" width="25%">
											...
											<h:selectOneMenu id="ddlCompany" value="#{semrrt002Bean.company}" >
												<f:selectItems value="#{semrrt002Bean.companyList}"/>
											</h:selectOneMenu>
					               		</td>
					               		<td width="25%"></td>
					               		<td width="25%"></td>
									...
									<tr>
					             		...
					             		<td align="left" width="25%">
					             			<rich:spacer width="5px"></rich:spacer>
											<h:selectOneMenu id="ddlRegion" value="#{semrrt002Bean.region}" >
												<f:selectItems value="#{semrrt002Bean.regionList}"/>
											</h:selectOneMenu>
					               		</td>
					               		<td/>
					               		<td/>
									...
									<tr>
					             		...
					             		<td align="left" width="25%">
					             			<rich:spacer width="5px"></rich:spacer>
											<h:inputText value="#{semrrt002Bean.monthYear}" onkeypress="return numberformat.keyPressFormatDateOnly(this,event)"
									...
									<tr>
					             		...
					             		<td align="left" width="25%">
					             			<rich:spacer width="5px"></rich:spacer>
											<h:selectOneMenu id="ddlStationType" value="#{semrrt002Bean.stationType}" >
												<f:selectItems value="#{semrrt002Bean.stationTypeList}"/>
											</h:selectOneMenu>
					               		</td>
					               		<td>
					               			<h:selectBooleanCheckbox value="#{semrrt002Bean.pico}"></h:selectBooleanCheckbox>
					               			<rich:spacer width="5px"></rich:spacer>
					               			<h:outputText value="#{jspMsg['label.pico']}" styleClass="ms7"></h:outputText>
					               		</td>
					               		<td/>
									</tr>
								</table>
						...
						<h:panelGrid columns="2" id="pnlGridCommand">
							<a4j:commandButton id="btnRun" style="width:90px" styleClass="rich-button"
								...
								<a4j:actionparam name="navProgram" value="SEMRRT002-1" />
								<a4j:actionparam name="moduleWithNavi" value="report" />
								<a4j:actionparam name="actionWithNavi" value="SEMRRT002" />
								<a4j:actionparam name="methodWithNavi" value="doRunReport" />
								
								<a4j:support event="oncomplete" reRender="frmError, frmSearch, pnlShowReport" rendered="#{semrrt002Bean.displayShowReport}"/>
							</a4j:commandButton>
						...
						<h:panelGrid id="pnlShowReport" style="height:0px;width:0px;" width="0px" columns="0" >
							<h:panelGroup id="pnlInShowReport" rendered="#{semrrt002Bean.displayShowReport}" style="height:0px;width:0px;" >
								<h:commandButton value="Report" id="bthShowReport" style="height:0px;width:0px;display:none;" action="#{semrrt002Action.showReport}"  />								
