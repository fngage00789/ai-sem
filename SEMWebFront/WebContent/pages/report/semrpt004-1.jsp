...
<f:loadBundle basename="resources.report.semrpt004" var="jspMsg"/>
					...
					<rich:panel id="pnlSearchCriteria">
								...
								<table id="dtbSearchCriteria" border="0" 
									...
									<tr>
					             		...
					             		<td align="left" width="25%">
											...
											<h:selectOneMenu id="ddlCompany" value="#{semrpt004Bean.company}" >
												<f:selectItems value="#{semrpt004Bean.companyList}"/>
											</h:selectOneMenu>
					               		</td>
					               		<td width="25%"></td>
					               		<td width="25%"></td>
									...
									<tr>
					             		...
					             		<td align="left" width="25%">
					             			<rich:spacer width="5px"></rich:spacer>
											<h:inputText maxlength="4" size="4" value="#{semrpt004Bean.yearTax}"></h:inputText>
					               		</td>
					               		<td/>
					               		<td/>
									</tr>
									...
									<tr>
					             		...
					             		<td align="left" width="25%">
					               			<rich:spacer width="5px"></rich:spacer>
					               			<h:selectBooleanCheckbox value="#{semrpt004Bean.pico}"/> <h:outputText value="#{jspMsg['label.pico']}" styleClass="ms7"></h:outputText>
					               		</td>
					               		<td>
						...
						<h:panelGrid columns="2" id="pnlGridCommand">
							<a4j:commandButton id="btnRun" style="width:90px" styleClass="rich-button"
								...
								<a4j:actionparam name="navProgram" value="SEMRPT004-1" />
								<a4j:actionparam name="moduleWithNavi" value="report" />
								<a4j:actionparam name="actionWithNavi" value="SEMRPT004" />
								<a4j:actionparam name="methodWithNavi" value="doRunReport" />
								<a4j:support event="oncomplete" reRender="frmError, frmSearch, pnlShowReport" rendered="#{semrpt004Bean.displayShowReport}"/>
							</a4j:commandButton>
						...
						<h:panelGrid id="pnlShowReport" style="height:0px;width:0px;" width="0px" columns="0" >
							<h:panelGroup id="pnlInShowReport" rendered="#{semrpt002Bean.displayShowReport}" style="height:0px;width:0px;" >
								<h:commandButton value="Report" id="bthShowReport" style="height:0px;width:0px;display:none;" action="#{semrpt004Action.showReport}"  />								
