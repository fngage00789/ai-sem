...
<f:loadBundle basename="resources.rental.semrsi004" var="jspMsg"/>
					...
					<rich:panel id="pnlSearchCriteria">
								...
								<table id="dtbSearchCriteria" border="0" 
									...
									<tr>
					             		...
					             		<td align="left" width="25%">
											...
											<h:selectOneMenu id="ddlCompany" value="#{semrsi004Bean.company}">
												<f:selectItems value="#{semrsi004Bean.companyList}"/>
											</h:selectOneMenu>
					               		</td>
					               		<td width="25%"></td>
					               		<td width="25%"></td>
									...
									<tr>
					             		...
					             		<td align="left" width="25%">
					             			<rich:spacer width="5px"></rich:spacer>
											<h:inputText value="#{semrsi004Bean.year}"  maxlength="4" size="4"></h:inputText>
					               		</td>
					               		<td/>
					               		<td/>
									</tr>
									...
									<tr>
					             		...
					             		<td align="left" width="25%">
					             			<rich:spacer width="5px"></rich:spacer>
											<h:selectOneMenu id="ddlMonthFrom" value="#{semrsi004Bean.monthFrom}" >
												<f:selectItems value="#{semrsi004Bean.monthList}"/>
											</h:selectOneMenu>
											<rich:spacer width="5px"></rich:spacer>
											<h:outputText value="-" styleClass="ms7"/>
											<rich:spacer width="5px"></rich:spacer>
											<h:selectOneMenu id="ddlMonthTo" value="#{semrsi004Bean.monthTo}" >
												<f:selectItems value="#{semrsi004Bean.monthList}"/>
											</h:selectOneMenu>
					               		</td>
					               		<td/>
						...
						<h:panelGrid columns="2" id="pnlGridCommand">
							<a4j:commandButton id="btnRun" style="width:90px" styleClass="rich-button"
								...
								<a4j:actionparam name="navProgram" value="SEMRSI004-1" />
								<a4j:actionparam name="moduleWithNavi" value="report" />
								<a4j:actionparam name="actionWithNavi" value="SEMRSI004" />
								<a4j:actionparam name="methodWithNavi" value="doRunReport" />
								
								<a4j:support event="oncomplete" reRender="frmError, frmSearch, pnlShowReport" rendered="#{semrsi004Bean.displayShowReport}"/>
							</a4j:commandButton>
						...
						<h:panelGrid id="pnlShowReport" style="height:0px;width:0px;" width="0px" columns="0" >
							<h:panelGroup id="pnlInShowReport" rendered="#{semrsi004Bean.displayShowReport}" style="height:0px;width:0px;" >
								<h:commandButton value="Report" id="bthShowReport" style="height:0px;width:0px;display:none;" action="#{semrsi004Action.showReport}"  />								
