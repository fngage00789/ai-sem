...
<f:loadBundle basename="resources.report.semrco002" var="jspMsg"/>
				...
				<a4j:form id="frmSearch">
					<rich:panel id="pnlSearchCriteria">
						...
						<h:panelGrid id="pnlGridSearchCriteria" border="0" 
							...
							<h:panelGroup>
								...
								<tr>
									<td align="right" width="25%" valign="baseline">
		                				...
		                				<td align="left" width="25%">
											...
											<h:selectOneMenu id="ddlCompany" value="#{semrco002Bean.company}" >
												<f:selectItems value="#{semrco002Bean.companyList}"/>
											</h:selectOneMenu>
					               		</td>
					             		...
					             		<td align="left" width="40%">
					             			<rich:spacer width="5px"></rich:spacer>
											<h:inputText value="#{semrco002Bean.year}"  maxlength="4" size="4"></h:inputText>
					               		</td>
								</tr>
								...
								<tr>
									...
									<td align="left">
										<rich:spacer width="5px"></rich:spacer>
										<h:selectOneMenu value="#{semrco002Bean.region}" >
											<f:selectItems value="#{semrco002Bean.regionList}"/>
										</h:selectOneMenu>
									</td>
									<td align="right"  valign="baseline">
					             		...
					             		<td align="left" width="25%">
					             			<h:selectBooleanCheckbox value="#{semrco002Bean.pico}"></h:selectBooleanCheckbox>
					             			<rich:spacer width="5"></rich:spacer>
							...
							<a4j:commandButton id="btnRun" style="width:90px" styleClass="rich-button"
								...
								<a4j:actionparam name="navProgram" value="SEMRCO002-1" />
								<a4j:actionparam name="moduleWithNavi" value="report" />
								<a4j:actionparam name="actionWithNavi" value="SEMRCO002" />
								<a4j:actionparam name="methodWithNavi" value="doRunReport" />
								
								<a4j:support event="oncomplete" reRender="frmError, frmSearch, pnlShowReport" rendered="#{semrco002Bean.displayShowReport}"/>
							</a4j:commandButton>
						...
						<h:panelGrid id="pnlShowReport" style="height:0px;width:0px;" width="0px" columns="0" >
							<h:panelGroup id="pnlInShowReport" rendered="#{semrco002Bean.displayShowReport}" style="height:0px;width:0px;" >
								<h:commandButton value="Report" id="bthShowReport" style="height:0px;width:0px;display:none;" action="#{semrco002Action.showReport}"  />								
