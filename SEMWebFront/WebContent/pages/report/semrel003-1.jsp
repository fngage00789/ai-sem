...
<f:loadBundle basename="resources.report.semrel003" var="jspMsg"/>
					...
					<rich:panel id="pnlSearchCriteria">
								...
								<table id="dtbSearchCriteria" border="0" 
									...
									<tr>
					             		...
					             		<td align="left" width="5%" valign="bottom">
											...
											<h:selectOneMenu id="ddlCompany" value="#{semrel003Bean.company}" styleClass="ms7" style="width:180px;">
												<f:selectItems value="#{semrel003Bean.companyList}"/>
											</h:selectOneMenu>
					               		</td>
									...
									<tr>
					             		...
					             		<td align="left" valign="bottom">
					             			<rich:spacer width="5px"></rich:spacer>
											<h:selectOneMenu id="ddlElectricUseType" value="#{semrel003Bean.electricUseType}" styleClass="ms7" style="width:180px;">
												<f:selectItems value="#{semrel003Bean.electricUseTypeList}"/>
											</h:selectOneMenu>
					               		</td>
					               		<td align="right" valign="baseline">&nbsp;</td>					             		
					             		<td align="left">&nbsp;</td>
									...
									<tr>
										<td align="right" valign="bottom">
						               		<h:graphicImage value="images/icon_required.gif"/>
											<rich:spacer width="5" style=" width : 5px; height : 1px;"></rich:spacer>
											<h:outputText value="#{jspMsg['label.year']} :" styleClass="ms7"/>
		                				</td>
					             		
					             		<td align="left" valign="bottom">
					             			<rich:spacer width="5px"></rich:spacer>
											<h:selectOneMenu id="ddlMonth" value="#{semrel003Bean.year}" styleClass="ms7" style="width:180px;">
												<f:selectItems value="#{semrel003Bean.yearList}"/>
											</h:selectOneMenu>
					               		</td>		
										<td align="right" valign="baseline">&nbsp;</td>					             		
					             		<td align="left">&nbsp;</td>						               	
						...
						<h:panelGrid columns="2" id="pnlGridCommand">
							<a4j:commandButton id="btnRun" style="width:90px" styleClass="rich-button"
								...
								<a4j:actionparam name="navProgram" value="SEMREL003-1" />
								<a4j:actionparam name="moduleWithNavi" value="report" />
								<a4j:actionparam name="actionWithNavi" value="SEMREL003" />
								<a4j:actionparam name="methodWithNavi" value="doRunReport" />
								
								<a4j:support event="oncomplete" reRender="frmError, frmSearch, pnlShowReport" rendered="#{semrel003Bean.displayShowReport}"/>
							</a4j:commandButton>
						...
						<h:panelGrid id="pnlShowReport" style="height:0px;width:0px;" width="0px" columns="0" >
							<h:panelGroup id="pnlInShowReport" rendered="#{semrel003Bean.displayShowReport}" style="height:0px;width:0px;" >
								<h:commandButton value="Report" id="bthShowReport" style="height:0px;width:0px;display:none;" action="#{semrel003Action.showReport}"  />								
