...
<f:loadBundle basename="resources.report.semrpt003" var="jspMsg"/>
					...
					<rich:panel id="pnlSearchCriteria">
								...
								<table id="dtbSearchCriteria" border="0" 
									...
									<tr>
					             		...
					             		<td align="left" width="25%">
											...
											<h:selectOneMenu id="ddlCompany" value="#{semrpt003Bean.company}" >
												<f:selectItems value="#{semrpt003Bean.companyList}"/>
											</h:selectOneMenu>
					               		</td>
					               		<td width="25%"></td>
					               		<td width="25%"></td>
									...
									<tr>
					             		...
					             		<td align="left" width="25%">
					             			<rich:spacer width="5px"></rich:spacer>
											<h:inputText maxlength="4" size="4" value="#{semrpt003Bean.yearTax}"></h:inputText>
					               		</td>
					               		<td/>
					               		<td/>
									</tr>
									...
									<tr>
					             		...
					             		<td align="left" width="25%">
					               			<rich:spacer width="5px"></rich:spacer>
					               			<h:selectBooleanCheckbox value="#{semrpt003Bean.pico}"/> <h:outputText value="#{jspMsg['label.pico']}" styleClass="ms7"></h:outputText>
					               		</td>
					               		<td>
						...
						<h:panelGrid columns="2" id="pnlGridCommand">
							<a4j:commandButton id="btnRun" style="width:90px" styleClass="rich-button"
								...
								<a4j:actionparam name="navProgram" value="SEMRPT003-1" />
								<a4j:actionparam name="moduleWithNavi" value="report" />
								<a4j:actionparam name="actionWithNavi" value="SEMRPT003" />
								<a4j:actionparam name="methodWithNavi" value="doRunReport" />
								
								<a4j:support event="oncomplete" reRender="frmError, frmSearch, pnlShowReport" rendered="#{semrpt003Bean.displayShowReport}"/>
						...
						<h:panelGrid id="pnlShowReport" style="height:0px;width:0px;" width="0px" columns="0" >
							<h:panelGroup id="pnlInShowReport" rendered="#{semrpt003Bean.displayShowReport}" style="height:0px;width:0px;" >
								<h:commandButton value="Report" id="bthShowReport" style="height:0px;width:0px;display:none;" action="#{semrpt003Action.showReport}"  />								
