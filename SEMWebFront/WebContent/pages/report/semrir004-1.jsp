...
<f:loadBundle basename="resources.report.semrir004" var="jspMsg"/>
					...
					<rich:panel id="pnlSearchCriteria">
								...
								<table id="dtbSearchCriteria" border="0" 
									...
									<tr>
					             		...
					             		<td align="left" width="25%">
											...
											<h:selectOneMenu id="ddlCompany" value="#{semrir004Bean.company}" >
												<f:selectItems value="#{semrir004Bean.companyList}"/>
											</h:selectOneMenu>
					               		</td>
					               		...
					               		<td width="25%" align="left">
					               			<rich:spacer width="5px"></rich:spacer>
					               			<h:inputText value="#{semrir004Bean.insuranceYear}" size="4" maxlength="4"></h:inputText>
					               		</td>
									</tr>
									...
									<tr>
					             		...
					             		<td align="left" width="25%">
					             			<rich:spacer width="5px"></rich:spacer>
											<h:selectOneMenu id="ddlNetworkType" value="#{semrir004Bean.networkType}" >
												<f:selectItems value="#{semrir004Bean.networkTypeList}"/>
											</h:selectOneMenu>
					               		</td>
					               		<td align="right" width="25%" valign="baseline">
					             		...
					             		<td align="left" width="25%">
					             			<rich:spacer width="5px"></rich:spacer>
											<h:selectOneMenu id="ddlTransferType" value="#{semrir004Bean.transferType}" >
												<f:selectItems value="#{semrir004Bean.transferTypeList}"/>
											</h:selectOneMenu>
					               		</td>
									</tr>
									...
									<tr>
					             		...
					             		<td align="left" width="25%">
					             			<rich:spacer width="5px"></rich:spacer>
											<h:selectOneMenu id="ddlInsuranceType" value="#{semrir004Bean.insuranceType}" >
												<f:selectItems value="#{semrir004Bean.insuranceTypeList}"/>
											</h:selectOneMenu>
					               		</td>
					               		<td></td>
					               		<td></td>
						...
						<h:panelGrid columns="2" id="pnlGridCommand">
							<a4j:commandButton id="btnRun" style="width:90px" styleClass="rich-button"
								...
								<a4j:actionparam name="navProgram" value="SEMRIR004-1" />
								<a4j:actionparam name="moduleWithNavi" value="report" />
								<a4j:actionparam name="actionWithNavi" value="SEMRIR004" />
								<a4j:actionparam name="methodWithNavi" value="doRunReport" />
								
								<a4j:support event="oncomplete" reRender="frmError, frmSearch, pnlShowReport" rendered="#{semrir004Bean.displayShowReport}"/>
						...
						<h:panelGrid id="pnlShowReport" style="height:0px;width:0px;" width="0px" columns="0" >
							<h:panelGroup id="pnlInShowReport" rendered="#{semrir004Bean.displayShowReport}" style="height:0px;width:0px;" >
								<h:commandButton value="Report" id="bthShowReport" style="height:0px;width:0px;display:none;" action="#{semrir004Action.showReport}"  />								
