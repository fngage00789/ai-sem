...
public class SEMMIR008Bean extends AbstractBean{
	...
	private boolean onRenderImport = false;
	...
	public boolean isOnRenderImport() {
		return onRenderImport;
	}

	public void setOnRenderImport(boolean onRenderImport) {
		this.onRenderImport = onRenderImport;
	}
