...
public class SEMMCT011Bean extends AbstractBean {
	//for search criteria
	...
	private boolean renderedRejectBtn = false;
	...
	public boolean isRenderedRejectBtn() {
		return renderedRejectBtn;
	}
	public void setRenderedRejectBtn(boolean renderedRejectBtn) {
		this.renderedRejectBtn = renderedRejectBtn;
	}
