...
public class SEMMSA005Bean extends AbstractBean{

	/**
	 * 
	 */
	private static final long serialVersionUID = 1363650807409178455L;
	...
	private List<SiteAcqSrchFile> srchFileSPList;
	
	private String newBorrowReq;
...
//
	...
	public String getNewBorrowReq() {
		return newBorrowReq;
	}

	public void setNewBorrowReq(String newBorrowReq) {
		this.newBorrowReq = newBorrowReq;
	}

	public List<SiteAcqSrchFile> getSrchFileSPList() {
		return srchFileSPList;
	}

	public void setSrchFileSPList(List<SiteAcqSrchFile> srchFileSPList) {
		this.srchFileSPList = srchFileSPList;
	}
	...
	public boolean isCannotBorrowFlagBoolean() {
		if(this.borrowContract != null && "true".equalsIgnoreCase(this.borrowContract.getCannotBorrowFlag())) {
			 this.cannotBorrowFlagBoolean =true;
		} else {
			 this.cannotBorrowFlagBoolean =false;
		}
		 return cannotBorrowFlagBoolean;
	}
	public boolean isReturnNotAllFlagBoolean() {
		if(this.returnContract != null && "true".equalsIgnoreCase(this.returnContract.getReturnNotAllFlag())) {
			 this.returnNotAllFlagBoolean =true;
		} else {
			this.returnNotAllFlagBoolean =false;
		}
