...
public class SEMMCO002Bean extends AbstractBean {
	...
	private List<WrapperBeanObject<Mco002SrchContractStatusSP>> contractStatusSPList;
	private Mco002SrchContractStatusSP criteria;
	private boolean disabledBtnAdd;
	private boolean disabledBtnExport;
	private boolean disabledBtnExportDuty;
	private List<String> contractIds;
	private List<WrapperBeanObject<Mco002SrchContractStatusSP>> selectedList;
	private ContractStatus contractStatus;
	private boolean disabledBtnAddContractStatusHistory;
	private boolean disabledBtnUpdateContractStatusHistory;
	private String contractId;
	private List<Mco001SrchStatusSP> contractStatusHistoryList;
	...
	public List<Mco001SrchStatusSP> getContractStatusHistoryList() {
		return contractStatusHistoryList;
	}
	public void setContractStatusHistoryList(
			List<Mco001SrchStatusSP> contractStatusHistoryList) {
	...
	public Mco002SrchContractStatusSP getCriteria() {
		return criteria;
	}
	public void setCriteria(Mco002SrchContractStatusSP criteria) {
	...
	public List<WrapperBeanObject<Mco002SrchContractStatusSP>> getContractStatusSPList() {
		return contractStatusSPList;
	}
	public void setContractStatusSPList(
			List<WrapperBeanObject<Mco002SrchContractStatusSP>> contractStatusSPList) {
		this.contractStatusSPList = contractStatusSPList;
	}
	public List<WrapperBeanObject<Mco002SrchContractStatusSP>> getSelectedList() {
		return selectedList;
	}
	public void setSelectedList(
			List<WrapperBeanObject<Mco002SrchContractStatusSP>> selectedList) {
