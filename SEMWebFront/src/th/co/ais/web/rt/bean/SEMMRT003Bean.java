...
public class SEMMRT003Bean extends AbstractBean{
	...
	private boolean disabledBtnExportExcel=true;
	...
	public String getTmpParamStr() {
		return tmpParamStr;
	}
	public void setTmpParamStr(String tmpParamStr) {
		this.tmpParamStr = tmpParamStr;
	}
	...
	public boolean isDisabledBtnExportExcel() {
		return disabledBtnExportExcel;
	}
	public void setDisabledBtnExportExcel(boolean disabledBtnExportExcel) {
		this.disabledBtnExportExcel = disabledBtnExportExcel;
	}
