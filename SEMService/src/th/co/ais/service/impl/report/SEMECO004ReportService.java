...
public class SEMECO004ReportService extends ReportService<SEMECO001Domain> {

private static Logger log =Logger.getLogger(SEMECO004ReportService.class);
	...
	public String getReportName(){
		...
		reportName = "SEMECO004" + "_" + new SimpleDateFormat("yyyyMMddHHmmss").format(new Date()) + "_" + new Random().nextInt(10000);
		return reportName;
	}
