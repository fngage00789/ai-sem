...
public class SEMRSI003ReportService extends ReportService {
	private static Logger log = Logger.getLogger(SEMRSI003ReportService.class);
	...
	public JasperPrint execute(ReportParameter param)
		...
		try {
			...
			jasperPrint = JasperFillManager.fillReport(jasperReport,
					((SEMRSI003ReportParameter) param).getReportParameter(),
					conn);
		} catch (Exception e) {
			log.error(e);
			e.printStackTrace();
	...
	public JasperPrint execute(String paramXML) throws ReportServiceException {
		...
		try {
			if (paramXML != null) {
				...
				param = (SEMRSI003ReportParameter) jibxUnMarshaller
						.unmarshal(ss);
				if (param != null) {
