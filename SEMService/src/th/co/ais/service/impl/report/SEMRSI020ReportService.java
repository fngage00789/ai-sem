...
public class SEMRSI020ReportService extends ReportService {
	...
	public JasperPrint execute(ReportParameter param)
		...
		try {
			...
			jasperPrint = JasperFillManager.fillReport(jasperReport,
					((SEMRSI020ReportParameter) param).getReportParameter(),
					conn);
		} catch (Exception e) {
			log.error(e);
			e.printStackTrace();
	...
	public JasperPrint execute(String paramXML) throws ReportServiceException {
		...
		try {
			if (paramXML != null) {
				...
				param = (SEMRSI020ReportParameter) jibxUnMarshaller
						.unmarshal(ss);
				if (param != null) {
