...
public class SEMRSI010ReportService extends ReportService {
	private static Logger log = Logger.getLogger(SEMRSI010ReportService.class);
	...
	public JasperPrint execute(ReportParameter param)
		...
		try {
			...
			jasperPrint = JasperFillManager.fillReport(jasperReport,
					((SEMRSI010ReportParameter) param).getReportParameter(),
					conn);
		} catch (Exception e) {
			log.error(e);
			e.printStackTrace();
	...
	public JasperPrint execute(String paramXML) throws ReportServiceException {
		...
		try {
			if (paramXML != null) {
				...
				param = (SEMRSI010ReportParameter) jibxUnMarshaller
						.unmarshal(ss);
				if (param != null) {
