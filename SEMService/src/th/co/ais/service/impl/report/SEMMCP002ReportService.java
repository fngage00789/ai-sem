...
import th.co.ais.dao.rpt.jdbc.SEMMCP002ReportDao;
...
public class SEMMCP002ReportService extends ReportService<SEMMCP002Domain>{
	
private static Logger log =Logger.getLogger(SEMMCP002ReportService.class);
	
	private SEMMCP002ReportDao semmcp002ReportDao; 
	
	public void setSemmcp002ReportDao(SEMMCP002ReportDao semmcp002ReportDao) {
		this.semmcp002ReportDao = semmcp002ReportDao;
	}
	...
	public String export(String paramXML, TemplateIdentifier templateIdentifier, String reportName) throws Exception {
		...
		SEMMCP002Domain domain = null;
		
		try {
			param = (SEMMCP002ReportParameter)genReportParameter(paramXML);
			if (param!=null) {
				domain = (SEMMCP002Domain) semmcp002ReportDao.execute(param.getReportParameter());
	...
	public ReportParameter genReportParameter(String paramXML)throws ReportServiceException {
		...
		try {
			if(paramXML!=null){
				...
				param = (SEMMCP002ReportParameter)jibxUnMarshaller.unmarshal(ss);
			}			
		} catch (Exception e) {
