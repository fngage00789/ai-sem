...
public class SEMMPT003ReportService extends ReportService {
	private static Logger log =Logger.getLogger(SEMMPT003ReportService.class);
//	private String[] sheetName;
	...
	public JasperPrint execute(ReportParameter param) throws ReportServiceException {
		...
		try {
			...
			jasperPrint = JasperFillManager.fillReport(jasperReport, ((SEMMPT003ReportParameter)param).getReportParameter(), conn);
//			sheetName = (String[])((SEMRRT020ReportParameter)param).getReportParameter().get(JRXlsAbstractExporterParameter.SHEET_NAMES);
	...
	public JasperPrint execute(String paramXML) throws ReportServiceException {
		...
		SEMMPT003ReportParameter param = null;
		try {
			if(paramXML!=null){
				sr = new StringReader(paramXML);
				ss = new StreamSource(sr);
				param = (SEMMPT003ReportParameter)jibxUnMarshaller.unmarshal(ss);
				if(param!=null){
...
//				xlsExporter.setParameter(JRXlsExporterParameter.IS_ONE_PAGE_PER_SHEET, Boolean.TRUE);
				...
				xlsExporter.setParameter(JRXlsExporterParameter.OFFSET_Y, 0);
				xlsExporter.exportReport();
