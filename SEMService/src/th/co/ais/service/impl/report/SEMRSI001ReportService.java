...
public class SEMRSI001ReportService extends ReportService {
	private static Logger log = Logger.getLogger(SEMRSI001ReportService.class);
	...
	public JasperPrint execute(ReportParameter param)
		...
		try {
			...
			jasperPrint = JasperFillManager.fillReport(jasperReport,
					((SEMRSI001ReportParameter) param).getReportParameter(),
					conn);
		} catch (Exception e) {
			log.error(e);
			e.printStackTrace();
	...
	public JasperPrint execute(String paramXML) throws ReportServiceException {
		...
		try {
			if (paramXML != null) {
				...
				param = (SEMRSI001ReportParameter) jibxUnMarshaller
						.unmarshal(ss);
				if (param != null) {
