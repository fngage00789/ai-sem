...
public class SEMRSI004ReportService extends ReportService {
	private static Logger log = Logger.getLogger(SEMRSI004ReportService.class);
	...
	public JasperPrint execute(ReportParameter param)
		...
		try {
			...
			jasperPrint = JasperFillManager.fillReport(jasperReport,
					((SEMRSI004ReportParameter) param).getReportParameter(),
					conn);
		} catch (Exception e) {
			log.error(e);
			e.printStackTrace();
	...
	public JasperPrint execute(String paramXML) throws ReportServiceException {
		...
		try {
			if (paramXML != null) {
				...
				param = (SEMRSI004ReportParameter) jibxUnMarshaller
						.unmarshal(ss);
				if (param != null) {
