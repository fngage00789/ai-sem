...
public class SEMRSI002ReportService extends ReportService {
	private static Logger log = Logger.getLogger(SEMRSI002ReportService.class);
	...
	public JasperPrint execute(ReportParameter param)
		...
		try {
			...
			jasperPrint = JasperFillManager.fillReport(jasperReport,
					((SEMRSI002ReportParameter) param).getReportParameter(),
					conn);
		} catch (Exception e) {
			log.error(e);
			e.printStackTrace();
	...
	public JasperPrint execute(String paramXML) throws ReportServiceException {
		...
		try {
			if (paramXML != null) {
				...
				param = (SEMRSI002ReportParameter) jibxUnMarshaller
						.unmarshal(ss);
				if (param != null) {
