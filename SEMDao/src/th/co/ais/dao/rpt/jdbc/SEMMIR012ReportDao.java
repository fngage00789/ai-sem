...
//
//public class SEMMIR012ReportDao extends AbstractHibernateDAO<IrClaim>{
//	
...
//	}	
//
//	public List<SEMMIR012Domain> executeList(Map<String, Object> criteria) throws Exception {
//		ResultSet rs = this.executeRS(criteria);
//		SEMMIR012Domain vo = null;
//		List<SEMMIR012Domain> voList = new ArrayList<SEMMIR012Domain>();		
//		try{
//			if (rs != null) {
//				while (rs.next()) {
//					vo = new SEMMIR012Domain();	
