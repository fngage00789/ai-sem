...
public class SEMMEL009ReportDao extends AbstractHibernateDAO<SEMMEL009Domain>{
	...
	public List<SEMMEL009Domain> executeList(Map<String, Object> criteria) throws Exception {
		ResultSet rs = this.executeRS(criteria);
		SEMMEL009Domain vo = null;
		List<SEMMEL009Domain> voList = new ArrayList<SEMMEL009Domain>();		
		try{
			if (rs != null) {
				while (rs.next()) {
					vo = new SEMMEL009Domain();	
