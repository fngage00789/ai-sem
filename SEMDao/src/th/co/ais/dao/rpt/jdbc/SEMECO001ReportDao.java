...
public class SEMECO001ReportDao extends AbstractHibernateDAO<SEMECO001Domain>{
	...
	public SEMECO001Domain execute(Map<String, Object> criteria) throws Exception {
