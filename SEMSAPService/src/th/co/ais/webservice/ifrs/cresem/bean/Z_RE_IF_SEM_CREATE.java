...
public class Z_RE_IF_SEM_CREATE  implements java.io.Serializable {
    ...
    private th.co.ais.webservice.ifrs.cresem.bean.ZREIF_S_CONTRACTTEMPLATE_INTER[] CONTRACT_DETAILS1;

    public Z_RE_IF_SEM_CREATE() {
    }

    public Z_RE_IF_SEM_CREATE(
           th.co.ais.webservice.ifrs.cresem.bean.ZREIF_S_CONTRACTTEMPLATE_INTER[] CONTRACT_DETAILS1) {
     ...
     */
    public th.co.ais.webservice.ifrs.cresem.bean.ZREIF_S_CONTRACTTEMPLATE_INTER[] getCONTRACT_DETAILS1() {
     ...
     */
    public void setCONTRACT_DETAILS1(th.co.ais.webservice.ifrs.cresem.bean.ZREIF_S_CONTRACTTEMPLATE_INTER[] CONTRACT_DETAILS1) {
        this.CONTRACT_DETAILS1 = CONTRACT_DETAILS1;
    }
