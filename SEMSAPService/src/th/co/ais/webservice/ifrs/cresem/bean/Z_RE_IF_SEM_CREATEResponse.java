...
public class Z_RE_IF_SEM_CREATEResponse  implements java.io.Serializable {
    ...
    private th.co.ais.webservice.ifrs.cresem.bean.ZREIF_S_CONTRACTRESPONSE[] CONTRACTRESPONSE;

    public Z_RE_IF_SEM_CREATEResponse() {
    }

    public Z_RE_IF_SEM_CREATEResponse(
           th.co.ais.webservice.ifrs.cresem.bean.ZREIF_S_CONTRACTRESPONSE[] CONTRACTRESPONSE) {
     ...
     */
    public th.co.ais.webservice.ifrs.cresem.bean.ZREIF_S_CONTRACTRESPONSE[] getCONTRACTRESPONSE() {
     ...
     */
    public void setCONTRACTRESPONSE(th.co.ais.webservice.ifrs.cresem.bean.ZREIF_S_CONTRACTRESPONSE[] CONTRACTRESPONSE) {
        this.CONTRACTRESPONSE = CONTRACTRESPONSE;
    }
